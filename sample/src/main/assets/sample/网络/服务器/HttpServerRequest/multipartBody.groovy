...
/*
功能:
+ 将请求体内容读取为 List<HttpMultipartItem> .

定义:
+ List<HttpMultipartItem> multipartBody()

参数:
+ 无

返回值:
+ List<HttpMultipartItem> - 返回对象本身方便链式调用

示例代码:
+ 在8080端口开启一个服务器,通过 HttpServerRequest.multipartBody() 读取请求体为 List<HttpMultipartItem> .
 */
