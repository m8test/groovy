...
/*
功能:
+ 设置请求 applicationRoute 中的路径时要提供的文件或资源的默认名称

定义:
+ HttpServerSPAConfig defaultPage(String page)

参数:
+ String page - 文件或者资源默认名称

返回值:
+ HttpServerSPAConfig - 返回对象本身方便链式调用

示例代码:
+ 通过 HttpServerSPAConfig.defaultPage() 设置请求 applicationRoute 中的路径时要提供的文件或资源的默认名称.
 */
