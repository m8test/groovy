package sample.网络.服务器.HttpServerConfig
...
定义:
+ HttpServerConfig routing(Closure configuration)
...
返回值:
+ HttpServerConfig - 返回对象本身方便链式调用

示例代码:
+ 在8080端口开启一个服务器并使用 HttpServerConfig.routing() 配置路由,通过 HttpClient.request() 方法访问该服务器.
 */
