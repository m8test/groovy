...
返回值:
+ HttpContentType - 当前part的内容类型,当"Content-Type"请求头不存在时返回null.

示例代码:
+ 在8080端口开启一个服务器,通过 HttpMultipartItem.contentType() 获取当前part内容类型.
 */
...
def server = $httpServerManager.newServer(8080) {
    ...
    routing {
        ...
        post("/contentType") {
            ...
            // HttpMultipartItem.contentType() 用于获取当前part内容类型
