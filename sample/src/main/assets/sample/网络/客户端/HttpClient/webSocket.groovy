...
/*
功能:
+ 新建 WebSocket 连接,此方法为同步方法,会阻塞当前线程直到 WebSocket 连接关闭,如果需要异步,则可以通过 Threads.startThread() 方法启动新线程再调用此方法.

定义:
+ HttpClient webSocket(String url, Closure requestConfig = null, Closure webSocketConfig = null)
