...
定义:
+ HttpClientMultipart file(String name, ScriptFile scriptFile, String filename = null, String contentType = null, Map<String, String> headers = null)
...
示例代码:
+ 在8080端口开启一个服务器,通过 HttpClientMultipart.file() 添加文本类型的 part 后再通过 HttpClient.postMultipart() 方法访问该服务器.
 */
