...
定义:
+ HttpClientRequest queryParameter(String name, String value)
...
示例代码:
+ 在8080端口开启一个服务器,通过 HttpClientRequest.queryParameter() 添加查询参数后再通过 HttpClient.request() 方法访问该服务器.
 */
...
def server = $httpServerManager.newServer(8080) {
    ...
    routing {
        ...
        get("/queryParameter") {
            ...
            def request = request()
            // HttpServerRequest.path() 可获得访问路径,此处为 "/queryParameter"
