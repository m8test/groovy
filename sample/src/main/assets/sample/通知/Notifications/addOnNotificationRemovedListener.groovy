...
+ Closure closure - 设置监听器的闭包,此闭包会在脚本主线程调用
    + 参数
        ...
        + int reason - 通知被移除的原因,https://developer.android.google.cn/reference/android/service/notification/NotificationListenerService#REASON_LISTENER_CANCEL
    + delegate - 无
...
示例代码:
+ 通过 Notifications.addOnNotificationRemovedListener() 添加通知移除监听器
 */
