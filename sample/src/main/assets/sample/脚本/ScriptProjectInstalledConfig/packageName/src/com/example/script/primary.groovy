...
定义:
+ ScriptProjectInstalledConfig packageName(String packageName)

参数:
+ String packageName - 待启动的脚本工程包名

返回值:
+ ScriptProjectInstalledConfig - 返回对象本身方便链式调用

示例代码:
+ 通过 ScriptProjectInstalledConfig.packageName() 方法设置需要启动的脚本工程包名
 */
