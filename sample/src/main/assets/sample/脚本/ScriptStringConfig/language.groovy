package sample.脚本.ScriptStringConfig
...
定义:
+ ScriptStringConfig language(String language)

参数:
+ String language - 字符串脚本所属语言

返回值:
+ ScriptStringConfig - 返回对象本身方便链式调用

示例代码:
+ 通过 ScriptStringConfig.language() 方法设置字符串脚本所属语言
 */
