package sample.悬浮窗.FloatyWindowConfig

/*
功能1:
+ 设置悬浮窗布局参数(LayoutParams)

定义1:
+ FloatyWindowConfig params(Closure config)
...
返回值1:
+ FloatyWindowConfig - 返回对象本身方便链式调用

功能2:
+ 获取悬浮窗布局参数(LayoutParams)
...
返回值2:
+ LayoutParams - 当前悬浮窗布局参数对象

示例代码:
+ 显示一个悬浮窗口并通过 FloatyWindowConfig.params() 方法设置/获取悬浮窗布局参数(LayoutParams)
 */
