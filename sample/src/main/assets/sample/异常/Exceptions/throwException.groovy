...
定义:
+ Exceptions throwException(String|Throwable exception)

参数:
+ String|Throwable exception - 异常的message(String)或者异常对象(Throwable)

返回值:
+ Exceptions - 返回对象本身方便链式调用

示例代码:
+ 通过 Exceptions.throwException() 抛出异常.
 */
