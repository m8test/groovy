...
定义:
+ TesseractOcrConfig addTrainedData(String lang, ScriptFile trainedDataPath)

参数:
+ String lang - 需要添加的语言
+ ScriptFile trainedDataPath - 语言训练数据路径

返回值:
+ TesseractOcrConfig - 返回对象本身方便链式调用

示例代码:
+ 通过 TesseractOcrConfig.addTrainedData() 添加语言训练数据.
 */
