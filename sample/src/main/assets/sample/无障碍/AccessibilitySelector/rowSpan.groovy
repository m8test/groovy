...
定义:
+ AccessibilitySelector rowSpan(Closure closure)

参数:
+ Closure closure - 设置过滤器的闭包
    + 参数
        + int rowSpan - 节点 rowSpan 值
    + delegate - 无
    + 返回值
...
示例代码:
+ 启动一个Activity, 并通过 AccessibilitySelector.rowSpan() 方法设置节点 rowSpan 过滤器
 */
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilitySelector.rowSpan() 用于设置节点 rowSpan 过滤器
                            accessibilitySelector.rowSpan { it == -1 }
