...
定义:
+ AccessibilitySelector rowCount(Closure closure)

参数:
+ Closure closure - 设置过滤器的闭包
    + 参数
        + int rowCount - 节点 rowCount 值
    + delegate - 无
    + 返回值
...
示例代码:
+ 启动一个Activity, 并通过 AccessibilitySelector.rowCount() 方法设置节点 rowCount 过滤器
 */
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilitySelector.rowCount() 用于设置节点 rowCount 过滤器
                            accessibilitySelector.rowCount { it == -1 }
