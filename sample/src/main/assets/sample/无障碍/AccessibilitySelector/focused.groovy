...
定义:
+ AccessibilitySelector focused(Closure closure)

参数:
+ Closure closure - 设置过滤器的闭包
    + 参数
        + boolean focused - 节点 focused 值
    + delegate - 无
    + 返回值
...
示例代码:
+ 启动一个Activity, 并通过 AccessibilitySelector.focused() 方法设置节点 focused 过滤器
 */
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilitySelector.focused() 用于设置节点 focused 过滤器
                            accessibilitySelector.focused { it }
