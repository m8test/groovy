...
定义:
+ AccessibilitySelector checked(Closure closure)

参数:
+ Closure closure - 设置过滤器的闭包
    + 参数
        + boolean checked - 节点 checked 值
    + delegate - 无
    + 返回值
...
示例代码:
+ 启动一个Activity, 并通过 AccessibilitySelector.checked() 方法设置节点 checked 过滤器
 */
...
$composeActivity.createView {
    ...
    Scaffold {
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilitySelector.checked() 用于设置节点 checked 过滤器
                            accessibilitySelector.checked { it }
        ...
        content {
            ...
            def checkboxState = mutableStateOf(false)
