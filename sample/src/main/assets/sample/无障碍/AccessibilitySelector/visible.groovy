...
定义:
+ AccessibilitySelector visible(Closure closure)

参数:
+ Closure closure - 设置过滤器的闭包
    + 参数
        + boolean visible - 节点 visible 值
    + delegate - 无
    + 返回值
...
示例代码:
+ 启动一个Activity, 并通过 AccessibilitySelector.visible() 方法设置节点 visible 过滤器
 */
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilitySelector.visible() 用于设置节点 visible 过滤器
                            accessibilitySelector.visible { it }
