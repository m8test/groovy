...
定义:
+ AccessibilitySelector enabled(Closure closure)

参数:
+ Closure closure - 设置过滤器的闭包
    + 参数
        + boolean enabled - 节点 enabled 值
    + delegate - 无
    + 返回值
...
示例代码:
+ 启动一个Activity, 并通过 AccessibilitySelector.enabled() 方法设置节点 enabled 过滤器
 */
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilitySelector.editable() 用于设置节点 editable 过滤器
                            accessibilitySelector.editable { it }
                            // AccessibilitySelector.enabled() 用于设置节点 enabled 过滤器
                            accessibilitySelector.enabled { it }
