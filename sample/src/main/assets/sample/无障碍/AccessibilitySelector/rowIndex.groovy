...
定义:
+ AccessibilitySelector rowIndex(Closure closure)

参数:
+ Closure closure - 设置过滤器的闭包
    + 参数
        + int rowIndex - 节点 rowIndex 值
    + delegate - 无
    + 返回值
...
示例代码:
+ 启动一个Activity, 并通过 AccessibilitySelector.rowIndex() 方法设置节点 rowIndex 过滤器
 */
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilitySelector.rowIndex() 用于设置节点 rowIndex 过滤器
                            accessibilitySelector.rowIndex { it == -1 }
