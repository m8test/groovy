package sample.无障碍.AccessibilitySelector
...
定义:
+ AccessibilitySelector accessibilityFocused(Closure closure)
...
返回值:
+ AccessibilitySelector - 返回对象本身方便链式调用

示例代码:
+ 启动一个Activity, 并通过 AccessibilitySelector.accessibilityFocused() 方法设置节点 accessibilityFocused 过滤器
 */
