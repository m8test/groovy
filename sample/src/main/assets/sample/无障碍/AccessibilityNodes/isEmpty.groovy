...
返回值:
+ boolean - true表示不存在任何节点,false表示至少存在一个节点

示例代码:
+ 启动一个Activity, 并通过 AccessibilityNodes.isEmpty() 方法判断是否不存在任何节点
 */
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilityNodes.isEmpty() 用于判断是否不存在任何节点
                            def isEmpty = nodes.isEmpty()
                            // SnackBarHostState.showSnackBar() 用于显示 SnackBar
                            snackBarHostState.showSnackBar("isEmpty:$isEmpty", null, "Short")
                        }
                    }
                }
            }
