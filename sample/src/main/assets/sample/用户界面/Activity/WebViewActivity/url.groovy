package sample.用户界面.Activity.WebViewActivity
...
定义:
+ WebViewActivity url(String url)

参数:
+ String url - 需要设置为界面的网页url地址

返回值:
+ WebViewActivity - 返回对象本身方便链式调用

示例代码:
+ 启动一个Activity, 通过 WebViewActivity.url() 方法设置 WebView 显示(脚本界面)的 url 地址
 */
