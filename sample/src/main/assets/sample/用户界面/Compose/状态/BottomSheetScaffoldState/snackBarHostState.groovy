...
定义1:
+ BottomSheetScaffoldState snackBarHostState(SnackBarHostState snackBarHostState)

参数1:
+ SnackBarHostState snackBarHostState - 需要设置的 SnackBarHostState
...
示例代码:
+ 启动一个Activity, 并通过 BottomSheetScaffoldState.snackBarHostState() 方法设置/获取 SnackBarHostState
 */
