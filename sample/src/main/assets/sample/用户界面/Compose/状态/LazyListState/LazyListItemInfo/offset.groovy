...
示例代码:
+ 启动一个Activity, 并通过 LazyListLayoutInfo.offset() 方法获取列表中项目的偏移量
 */
            ...
            Button {
                ...
                content {
                    ...
                    Text {
                        ...
                        text("visibleItemsInfo offset:" + mutableState.value())
                    }
                }
                ...
                onClick {
                    ...
                    info.each { lazyListItemInfo ->
                        // LazyListItemInfo.offset() 用于获取列表中项目的偏移量。
                        infoString += lazyListItemInfo.offset() + ","
                    }
