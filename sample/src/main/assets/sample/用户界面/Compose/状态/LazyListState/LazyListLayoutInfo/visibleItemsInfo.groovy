...
/*
功能:
+ 获取所有当前可见项的 LazyListItemInfo 列表。
...
返回值:
+ List<LazyListItemInfo> - 所有可见的 LazyListItemInfo 集合

示例代码:
+ 启动一个Activity, 并通过 LazyListLayoutInfo.visibleItemsInfo() 方法获取所有当前可见项的 LazyListItemInfo 列表
 */
