package sample.用户界面.Compose.状态.BottomSheetScaffoldState
...
定义1:
+ BottomSheetScaffoldState bottomSheetState(BottomSheetState bottomSheetState)

参数1:
+ BottomSheetState bottomSheetState - 需要设置的 BottomSheetState

返回值1:
+ BottomSheetScaffoldState - 返回对象本身方便链式调用
...
返回值2:
+ BottomSheetState - BottomSheetState 对象

示例代码:
+ 启动一个Activity, 并通过 BottomSheetScaffoldState.bottomSheetState() 方法设置/获取 BottomSheetState
 */
