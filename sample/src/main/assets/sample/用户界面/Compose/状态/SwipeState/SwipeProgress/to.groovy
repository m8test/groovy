package sample.用户界面.Compose.状态.SwipeState.SwipeProgress
...
返回值:
+ String - 对应于我们正在走向的锚点的状态。

示例代码:
+ 启动一个Activity, 并通过 SwipeProgress.to() 方法获取对应于我们正在走向的锚点的状态。
 */
        ...
        content {
            ...
            Text {
                ...
                style {
                    ...
                    // SwipeProgress.to() 用于获取对应于我们正在走向的锚点的状态。
                    if (currentDrawerValue.to() == "Closed") {
