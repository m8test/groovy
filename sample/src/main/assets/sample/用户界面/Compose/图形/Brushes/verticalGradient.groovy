...
定义:
+ Brush verticalGradient(List<Closure> colors, Number startY, Number endY, String tileMode)
...
示例代码:
+ 启动一个Activity, 并通过 Brushes.verticalGradient() 方法创建一个用给定的颜色均匀分布在渐变中的垂直渐变刷子.
 */
