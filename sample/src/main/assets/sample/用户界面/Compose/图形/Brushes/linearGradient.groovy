...
定义:
+ Brush linearGradient(List<Closure> colors, Closure start, Closure end, String tileMode)
...
示例代码:
+ 启动一个Activity, 并通过 Brushes.linearGradient() 方法创建沿给定的开始和结束坐标使用提供的颜色创建线性渐变的刷子
 */
