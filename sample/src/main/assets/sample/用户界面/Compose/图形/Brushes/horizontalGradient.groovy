...
定义:
+ Brush horizontalGradient(List<Closure> colors, Number startX, Number endX, String tileMode)
...
示例代码:
+ 启动一个Activity, 并通过 Brushes.horizontalGradient() 方法创建一个用给定的颜色均匀分布在渐变中的水平渐变刷子.
 */
