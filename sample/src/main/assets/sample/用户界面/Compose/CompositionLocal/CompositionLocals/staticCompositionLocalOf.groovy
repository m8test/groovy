package sample.用户界面.Compose.CompositionLocal.CompositionLocals

/*
功能:
+ 创建 StaticProvidableCompositionLocal 对象

定义:
+ StaticProvidableCompositionLocal staticCompositionLocalOf(Closure closure)
...
返回值:
+ StaticProvidableCompositionLocal - 新创建的 StaticProvidableCompositionLocal 对象

示例代码:
+ 启动一个Activity, 并通过 ProvidableCompositionLocal.staticCompositionLocalOf() 方法将 CompositionLocal 键与值相关联
 */
