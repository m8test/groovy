...
/*
功能:
+ 创建 DynamicProvidableCompositionLocal 对象

定义:
+ DynamicProvidableCompositionLocal compositionLocalOf(Closure closure)
...
返回值:
+ DynamicProvidableCompositionLocal - 新创建的 DynamicProvidableCompositionLocal 对象

示例代码:
+ 启动一个Activity, 并通过 ProvidableCompositionLocal.compositionLocalOf() 方法将 CompositionLocal 键与值相关联
 */
