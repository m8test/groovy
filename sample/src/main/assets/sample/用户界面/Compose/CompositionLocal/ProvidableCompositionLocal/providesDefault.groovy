package sample.用户界面.Compose.CompositionLocal.ProvidableCompositionLocal

/*
功能:
+ 将 CompositionLocal 键与值相关联,如果之前该 CompositionLocal 已经关联到其他值,则此方法无效

定义:
+ ProvidedValue providesDefault(Object value)

参数:
+ Object value - 需要与 CompositionLocal 关联的值

返回值:
+ ProvidedValue - 保存 CompositionLocal 关联关系的对象

示例代码:
+ 启动一个Activity, 并通过 ProvidableCompositionLocal.providesDefault() 方法将 CompositionLocal 键与值相关联
 */
