...
/*
功能:
+ 创建一个配置有给定持续时间、延迟和缓动曲线的 TweenSpec。

定义:
+ TweenSpec tween(int durationMillis, int delayMillis, Closure easing)
...
返回值:
+ TweenSpec - 新创建的 TweenSpec 对象

示例代码:
+ 启动一个Activity, 并通过 Animations.tween() 方法创建一个配置有给定持续时间、延迟和缓动曲线的 TweenSpec。
 */
