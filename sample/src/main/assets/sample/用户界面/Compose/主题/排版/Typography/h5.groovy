...
示例代码:
+ 启动一个Activity, 并通过 Typography.h5() 方法设置/获取主题 h5 文字样式
 */
            ...
            Button {
                ...
                content {
                    ...
                    Text {
                        ...
                        // Typography.h5() 用于获取主题 h5 文字样式
                        def h5TextStyle = currentTypography.h5()
                        // Text.style() 用于设置文字样式
                        style {
                            // delegate -> TextStyle
