...
示例代码:
+ 启动一个Activity, 并通过 Typography.h4() 方法设置/获取主题 h4 文字样式
 */
            ...
            Button {
                ...
                content {
                    ...
                    Text {
                        ...
                        // Typography.h4() 用于获取主题 h4 文字样式
                        def h4TextStyle = currentTypography.h4()
                        // Text.style() 用于设置文字样式
                        style {
                            // delegate -> TextStyle
