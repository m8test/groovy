...
/*
功能:
+ 设置 Slider 禁用时非活动轨道上刻度线的颜色,如果指定了步骤，则用于在非活动轨道上绘制刻度线的颜色

定义:
+ SliderColors disabledInactiveTickColor(Closure closure)
...
示例代码:
+ 启动一个Activity, 并通过 SliderColors.disabledInactiveTickColor() 方法设置 Slider 禁用时非活动轨道上刻度线的颜色
 */
