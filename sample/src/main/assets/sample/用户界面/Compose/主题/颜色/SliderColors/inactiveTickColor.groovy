...
/*
功能:
+ 设置 Slider 非活动轨道上刻度线的颜色,如果指定了步骤，则用于在非活动轨道上绘制刻度线的颜色

定义:
+ SliderColors inactiveTickColor(Closure closure)
...
示例代码:
+ 启动一个Activity, 并通过 SliderColors.inactiveTickColor() 方法设置 Slider 非活动轨道上刻度线的颜色
 */
