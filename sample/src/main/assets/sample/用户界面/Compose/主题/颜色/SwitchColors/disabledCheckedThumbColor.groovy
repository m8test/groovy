...
/*
功能:
+ 设置 Switch 禁用并且选中时拇指的颜色.

定义:
+ SwitchColors disabledCheckedThumbColor(Closure closure)
...
示例代码:
+ 启动一个Activity, 并通过 SwitchColors.disabledCheckedThumbColor() 方法设置 Switch 禁用并且选中时拇指的颜色.
 */
