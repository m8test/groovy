...
示例代码:
+ 启动一个Activity, 并通过 Typography.h1() 方法设置/获取主题 h1 文字样式
 */
            ...
            Button {
                ...
                content {
                    ...
                    Text {
                        ...
                        // Typography.h1() 用于获取主题 h1 文字样式
                        def h1TextStyle = currentTypography.h1()
                        // Text.style() 用于设置文字样式
                        style {
                            // delegate -> TextStyle
