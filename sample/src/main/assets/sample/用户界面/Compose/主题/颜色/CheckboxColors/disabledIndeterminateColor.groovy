...
/*
功能:
+ 设置 TriStateCheckbox 未启用并且不确定时颜色.

定义:
+ CheckboxColors disabledIndeterminateColor(Closure closure)
...
示例代码:
+ 启动一个Activity, 并通过 CheckboxColors.disabledIndeterminateColor() 方法设置 TriStateCheckbox 未启用并且不确定时颜色.
 */
