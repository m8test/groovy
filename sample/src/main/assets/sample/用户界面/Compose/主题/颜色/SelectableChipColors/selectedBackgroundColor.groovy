...
/*
功能:
+ 设置 FilterChip 被选中时的背景颜色.

定义:
+ SelectableChipColors selectedBackgroundColor(Closure closure)
...
示例代码:
+ 启动一个Activity, 并通过 SelectableChipColors.selectedBackgroundColor() 方法设置 FilterChip 被选中时的背景颜色.
 */
