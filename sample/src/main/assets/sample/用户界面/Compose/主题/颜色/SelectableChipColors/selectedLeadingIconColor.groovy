...
/*
功能:
+ 设置 FilterChip 被选中时的头部图标颜色.

定义:
+ SelectableChipColors selectedLeadingIconColor(Closure closure)
...
示例代码:
+ 启动一个Activity, 并通过 SelectableChipColors.selectedLeadingIconColor() 方法设置 FilterChip 被选中时的头部图标颜色.
 */
