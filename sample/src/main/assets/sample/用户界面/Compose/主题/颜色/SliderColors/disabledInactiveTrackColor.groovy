...
/*
功能:
+ 设置 Slider 禁用时非活动部分中轨道的颜色，即拇指右边的颜色

定义:
+ SliderColors disabledInactiveTrackColor(Closure closure)
...
示例代码:
+ 启动一个Activity, 并通过 SliderColors.disabledInactiveTrackColor() 方法设置 Slider 禁用时非活动部分中轨道的颜色
 */
