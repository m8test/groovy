...
/*
功能:
+ 设置 Switch 禁用并且未选中时轨道的颜色.

定义:
+ SwitchColors disabledUncheckedTrackColor(Closure closure)
...
示例代码:
+ 启动一个Activity, 并通过 SwitchColors.disabledUncheckedTrackColor() 方法设置 Switch 禁用并且未选中时轨道的颜色.
 */
