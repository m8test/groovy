...
/*
功能:
+ 设置 Slider 活动轨道上刻度线的颜色,如果指定了步骤，则用于在活动轨道上绘制刻度线的颜色

定义:
+ SliderColors activeTickColor(Closure closure)
...
示例代码:
+ 启动一个Activity, 并通过 SliderColors.activeTickColor() 方法设置 Slider 活动轨道上刻度线的颜色
 */
