...
/*
功能:
+ 设置 Slider 禁用时活动部分中轨道的颜色，即拇指左边的颜色

定义:
+ SliderColors disabledActiveTrackColor(Closure closure)
...
示例代码:
+ 启动一个Activity, 并通过 SliderColors.disabledActiveTrackColor() 方法设置 Slider 禁用时活动部分中轨道的颜色
 */
