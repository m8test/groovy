...
/*
功能:
+ 创建 ExposedDropdownMenuBox 可组合项

定义:
+ Slot ExposedDropdownMenuBox(Closure closure)

参数:
+ Closure closure - 设置 ExposedDropdownMenuBox 的闭包
    + 参数 - 无
...
示例代码:
+ 启动一个Activity, 并通过 Slot.ExposedDropdownMenuBox() 方法创建 ExposedDropdownMenuBox 可组合项
 */
