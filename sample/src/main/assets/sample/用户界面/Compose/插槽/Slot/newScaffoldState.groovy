...
定义:
+ ScaffoldState newScaffoldState(Closure closure)

参数:
+ Closure closure - 设置 ScaffoldState 的闭包
    + 参数 - 无
    + delegate - ScaffoldState

返回值:
+ ScaffoldState - 新创建的 ScaffoldState

示例代码:
+ 启动一个Activity, 并通过 Slot.newScaffoldState() 方法新建 ScaffoldState
 */
