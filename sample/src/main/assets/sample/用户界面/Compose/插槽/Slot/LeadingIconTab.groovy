...
/*
功能:
+ 创建 LeadingIconTab 可组合项

定义:
+ Slot LeadingIconTab(Closure closure)

参数:
+ Closure closure - 设置 LeadingIconTab 的闭包
    + 参数 - 无
...
示例代码:
+ 启动一个Activity, 并通过 Slot.LeadingIconTab() 方法创建 LeadingIconTab 可组合项
 */
