...
/*
功能:
+ 创建 MaterialTheme 可组合项

定义:
+ Slot MaterialTheme(Closure closure)

参数:
+ Closure closure - 设置 MaterialTheme 的闭包
    + 参数 - 无
...
示例代码:
+ 启动一个Activity, 并通过 Slot.MaterialTheme() 方法创建 MaterialTheme 可组合项
 */
