...
/*
功能:
+ 创建 IconToggleButton 可组合项

定义:
+ Slot IconToggleButton(Closure closure)

参数:
+ Closure closure - 设置 IconToggleButton 的闭包
    + 参数 - 无
...
示例代码:
+ 启动一个Activity, 并通过 Slot.IconToggleButton() 方法创建 IconToggleButton 可组合项
 */
