...
/*
功能:
+ 创建 BottomDrawerState

定义:
+ BottomDrawerState newBottomDrawerState(Closure closure)

参数:
+ Closure closure - 设置 BottomDrawerState 的闭包
    + 参数 - 无
    + delegate - BottomDrawerState

返回值:
+ BottomDrawerState - 新创建的 BottomDrawerState

示例代码:
+ 启动一个Activity, 并通过 Slot.newBottomDrawerState() 方法创建 BottomDrawerState
 */
