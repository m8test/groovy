...
定义:
+ SnackBarHostState newSnackBarHostState(Closure closure)

参数:
+ Closure closure - 设置 SnackBarHostState 的闭包
    + 参数 - 无
    + delegate - SnackBarHostState

返回值:
+ SnackBarHostState - 新创建的 SnackBarHostState

示例代码:
+ 启动一个Activity, 并通过 Slot.newSnackBarHostState() 方法创建 SnackBarHostState
 */
