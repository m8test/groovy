...
定义:
+ MutableStateList mutableStateListOf(List<Object> initialValues)

参数:
+ List<Object> initialValue - 初始化的数据,可以为null

返回值:
+ MutableStateList - 新创建的 MutableStateList 对象

示例代码:
+ 启动一个Activity, 并通过 Slot.mutableStateListOf() 方法创建 MutableStateList
 */
