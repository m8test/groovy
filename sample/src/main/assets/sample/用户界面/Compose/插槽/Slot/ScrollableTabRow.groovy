...
/*
功能:
+ 创建 ScrollableTabRow 可组合项

定义:
+ Slot ScrollableTabRow(Closure closure)

参数:
+ Closure closure - 设置 ScrollableTabRow 的闭包
    + 参数 - 无
...
示例代码:
+ 启动一个Activity, 并通过 Slot.ScrollableTabRow() 方法创建 ScrollableTabRow 可组合项
 */
