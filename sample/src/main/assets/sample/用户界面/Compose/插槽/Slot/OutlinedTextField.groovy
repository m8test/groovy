...
/*
功能:
+ 创建 OutlinedTextField 可组合项

定义:
+ Slot OutlinedTextField(Closure closure)

参数:
+ Closure closure - 设置 OutlinedTextField 的闭包
    + 参数 - 无
...
示例代码:
+ 启动一个Activity, 并通过 Slot.OutlinedTextField() 方法创建 OutlinedTextField 可组合项
 */
