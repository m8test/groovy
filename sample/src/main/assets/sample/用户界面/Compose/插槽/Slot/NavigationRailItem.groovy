...
/*
功能:
+ 创建 NavigationRailItem 可组合项

定义:
+ Slot NavigationRailItem(Closure closure)

参数:
+ Closure closure - 设置 NavigationRailItem 的闭包
    + 参数 - 无
...
示例代码:
+ 启动一个Activity, 并通过 Slot.NavigationRailItem() 方法创建 NavigationRailItem 可组合项
 */
