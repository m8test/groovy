...
/*
功能:
+ 新建 BottomSheetScaffoldState

定义:
+ BottomSheetScaffoldState newBottomSheetScaffoldState(Closure closure)

参数:
+ Closure closure - 设置 BottomSheetScaffoldState 的闭包
    + 参数 - 无
    + delegate - BottomSheetScaffoldState

返回值:
+ BottomSheetScaffoldState - 新创建的 BottomSheetScaffoldState

示例代码:
+ 启动一个Activity, 并通过 Slot.newBottomSheetScaffoldState() 方法新建 BottomSheetScaffoldState
 */
