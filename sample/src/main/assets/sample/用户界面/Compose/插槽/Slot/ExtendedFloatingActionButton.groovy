...
/*
功能:
+ 创建 ExtendedFloatingActionButton 可组合项

定义:
+ Slot ExtendedFloatingActionButton(Closure closure)

参数:
+ Closure closure - 设置 ExtendedFloatingActionButton 的闭包
    + 参数 - 无
...
示例代码:
+ 启动一个Activity, 并通过 Slot.ExtendedFloatingActionButton() 方法创建 ExtendedFloatingActionButton 可组合项
 */
