...
定义:
+ BottomSheetState newBottomSheetState(Closure closure)

参数:
+ Closure closure - 设置 BottomSheetState 的闭包
    + 参数 - 无
    + delegate - BottomSheetState

返回值:
+ BottomSheetState - 新创建的 BottomSheetState

示例代码:
+ 启动一个Activity, 并通过 Slot.newBottomSheetState() 方法创建 BottomSheetState
 */
