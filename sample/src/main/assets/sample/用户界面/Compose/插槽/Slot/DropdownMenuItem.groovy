...
/*
功能:
+ 创建 DropdownMenuItem 可组合项

定义:
+ Slot DropdownMenuItem(Closure closure)

参数:
+ Closure closure - 设置 DropdownMenuItem 的闭包
    + 参数 - 无
...
示例代码:
+ 启动一个Activity, 并通过 Slot.DropdownMenuItem() 方法创建 DropdownMenuItem 可组合项
 */
