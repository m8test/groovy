...
/*
功能:
+ 创建 BackdropScaffoldState

定义:
+ BackdropScaffoldState newBackdropScaffoldState(Closure closure)

参数:
+ Closure closure - 设置 BackdropScaffoldState 的闭包
    + 参数 - 无
    + delegate - BackdropScaffoldState

返回值:
+ BackdropScaffoldState - 新创建的 BackdropScaffoldState

示例代码:
+ 启动一个Activity, 并通过 Slot.newBackdropScaffoldState() 方法创建 BackdropScaffoldState
 */
