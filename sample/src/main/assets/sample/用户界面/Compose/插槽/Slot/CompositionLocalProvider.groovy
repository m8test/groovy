...
/*
功能:
+ 创建 CompositionLocalProvider 可组合项

定义:
+ Slot CompositionLocalProvider(Closure closure)

参数:
+ Closure closure - 设置 CompositionLocalProvider 的闭包
    + 参数 - 无
...
示例代码:
+ 启动一个Activity, 并通过 Slot.CompositionLocalProvider() 方法创建 CompositionLocalProvider 可组合项
 */
