...
/*
功能:
+ 创建 ModalBottomSheetLayout 可组合项

定义:
+ Slot ModalBottomSheetLayout(Closure closure)

参数:
+ Closure closure - 设置 ModalBottomSheetLayout 的闭包
    + 参数 - 无
...
示例代码:
+ 启动一个Activity, 并通过 Slot.ModalBottomSheetLayout() 方法创建 ModalBottomSheetLayout 可组合项
 */
