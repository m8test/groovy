...
/*
功能:
+ 创建 BottomNavigation 可组合项

定义:
+ Slot BottomNavigation(Closure closure)

参数:
+ Closure closure - 设置 BottomNavigation 的闭包
    + 参数 - 无
...
示例代码:
+ 启动一个Activity, 并通过 Slot.BottomNavigation() 方法创建 BottomNavigation 可组合项
 */
