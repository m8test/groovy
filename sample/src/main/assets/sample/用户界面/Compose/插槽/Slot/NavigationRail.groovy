...
/*
功能:
+ 创建 NavigationRail 可组合项

定义:
+ Slot NavigationRail(Closure closure)

参数:
+ Closure closure - 设置 NavigationRail 的闭包
    + 参数 - 无
...
示例代码:
+ 启动一个Activity, 并通过 Slot.NavigationRail() 方法创建 NavigationRail 可组合项
 */
