package sample.用户界面.Compose.导航.NavDeepLink
/*
功能:
+ 设置深层链接的 MimeType

定义:
+ NavDeepLink mimeType(String mimeType)

参数:
+ String mimeType - 需要设置的 MimeType

返回值:
+ NavDeepLink - 返回对象本身方便链式调用

示例代码:
+ 启动一个Activity, 并通过 NavDeepLink.mimeType() 方法设置深层链接的 MimeType
 */
def allMimeType = "*/*"
