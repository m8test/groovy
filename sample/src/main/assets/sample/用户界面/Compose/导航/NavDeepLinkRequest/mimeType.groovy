package sample.用户界面.Compose.导航.NavDeepLinkRequest
/*
功能:
+ 深层链接请求 MimeType

定义:
+ NavDeepLinkRequest mimeType(String mimeType)

参数:
+ String mimeType - 需要设置的 MimeType

返回值:
+ NavDeepLinkRequest - 返回对象本身方便链式调用

示例代码:
+ 启动一个Activity, 并通过 NavDeepLinkRequest.mimeType() 方法深层链接请求 MimeType
 */
def allMimeType = "*/*"
