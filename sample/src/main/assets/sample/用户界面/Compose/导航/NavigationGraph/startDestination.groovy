package sample.用户界面.Compose.导航.NavigationGraph
...
定义:
+ NavigationGraph startDestination(String destination)

参数:
+ String destination - 起始目的地的路线

返回值:
+ NavigationGraph - 返回对象本身方便链式调用

示例代码:
+ 启动一个Activity, 并通过 NavigationGraph.startDestination() 方法设置起始目的地的路线
 */
