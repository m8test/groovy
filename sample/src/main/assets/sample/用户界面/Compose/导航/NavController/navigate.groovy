package sample.用户界面.Compose.导航.NavController
...
定义1:
+ NavController navigate(String route, Closure closure)
...
返回值1:
+ NavController - 返回对象本身方便链式调用

定义2:
+ NavController navigate(Closure navDeepLinkRequest, Closure navOptions)
...
示例代码:
+ 启动一个Activity, 并通过 NavController.navigate() 方法导航到指定的路线
 */
