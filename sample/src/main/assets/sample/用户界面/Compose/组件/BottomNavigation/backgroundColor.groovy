package sample.用户界面.Compose.组件.BottomNavigation

/*
功能:
+ 设置 BottomNavigation 背景颜色

定义:
+ BottomNavigation backgroundColor(Closure closure)

参数:
+ Closure closure - 设置 BottomNavigation 背景颜色的闭包
    + 参数 - 无
    + delegate - Color

返回值:
+ BottomNavigation - 返回对象本身方便链式调用

示例代码:
+ 启动一个Activity, 并通过 BottomNavigation.backgroundColor() 方法设置 BottomNavigation 背景颜色
 */
