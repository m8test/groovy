...
/*
功能:
+ 设置 NavigationRailItem 是否一直显示标签.

定义:
+ NavigationRailItem alwaysShowLabel(boolean value)
...
示例代码:
+ 启动一个Activity, 并通过 NavigationRailItem.alwaysShowLabel() 方法设置 NavigationRailItem 是否一直显示标签.
 */
