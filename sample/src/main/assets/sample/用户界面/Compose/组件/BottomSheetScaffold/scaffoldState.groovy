...
/*
功能:
+ 设置 BottomSheetScaffoldState

定义:
+ BottomSheetScaffold scaffoldState(BottomSheetScaffoldState scaffoldState)

参数:
+ BottomSheetScaffoldState scaffoldState - 需要设置的 BottomSheetScaffoldState

返回值:
+ BottomSheetScaffold - 返回对象本身方便链式调用

示例代码:
+ 启动一个Activity, 并通过 BottomSheetScaffold.scaffoldState() 方法设置 BottomSheetScaffoldState
 */
