...
/*
功能:
+ 设置 BottomDrawerState

定义:
+ BottomDrawer drawerState(BottomDrawerState bottomDrawerState)

参数:
+ BottomDrawerState bottomDrawerState - 需要设置的 BottomDrawerState

返回值:
+ BottomDrawer - 返回对象本身方便链式调用

示例代码:
+ 启动一个Activity, 并通过 BottomDrawer.drawerState() 方法设置 BottomDrawerState
 */
