package sample.用户界面.Compose.组件.Switch

/*
功能:
+ 设置 Switch 选中/取消选中监听器.

定义:
+ Switch onCheckedChange(Closure closure)
...
示例代码:
+ 启动一个Activity, 并通过 Switch.onCheckedChange() 方法设置 Switch 选中/取消选中监听器.
 */
