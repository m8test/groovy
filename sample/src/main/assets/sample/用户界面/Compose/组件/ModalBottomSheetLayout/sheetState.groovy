...
/*
功能:
+ 设置 ModalBottomSheetState

定义:
+ ModalBottomSheetLayout sheetState(ModalBottomSheetState state)

参数:
+ ModalBottomSheetState state - 需要设置的 ModalBottomSheetState 对象

返回值:
+ ModalBottomSheetLayout - 返回对象本身方便链式调用

示例代码:
+ 启动一个Activity, 并通过 ModalBottomSheetLayout.sheetState() 方法设置 ModalBottomSheetState
 */
