package sample.用户界面.Compose.组件.TabRow.TabPosition

/*
功能:
+ 获取从 TabRow 开始的右边缘的 x 位置
...
返回值:
+ int - 从 TabRow 开始的右边缘的 x 位置

示例代码:
+ 启动一个Activity, 并通过 TabPosition.right() 方法获取从 TabRow 开始的右边缘的 x 位置
 */
