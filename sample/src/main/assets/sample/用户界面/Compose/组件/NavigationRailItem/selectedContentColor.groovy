...
/*
功能:
+ 设置  NavigationRailItem 被选中时的颜色.

定义:
+ NavigationRailItem selectedContentColor(Closure closure)
...
示例代码:
+ 启动一个Activity, 并通过 NavigationRailItem.selectedContentColor() 方法设置  NavigationRailItem 被选中时的颜色.
 */
