...
/*
功能:
+ 设置 BottomSheetScaffold 内容颜色

定义:
+ BottomSheetScaffold contentColor(Closure closure)

参数:
+ Closure closure - 设置 BottomSheetScaffold 内容颜色的闭包
    + 参数 - 无
    + delegate - Color
...
示例代码:
+ 启动一个Activity, 并通过 BottomSheetScaffold.contentColor() 方法设置 BottomSheetScaffold 内容颜色
 */
