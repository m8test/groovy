...
定义:
+ BottomSheetScaffold sheetContentColor(Closure closure)

参数:
+ Closure closure - 设置底页内容颜色的闭包
    + 参数 - 无
    + delegate - Color
...
示例代码:
+ 启动一个Activity, 并通过 BottomSheetScaffold.sheetContentColor() 方法设置底页内容颜色
 */
...
$composeActivity.createView {
    ...
    BottomSheetScaffold {
        ...
        // BottomSheetScaffold.sheetContentColor() 用于设置底页内容颜色
        sheetContentColor {
            // delegate -> Color
            // Color.red() 用于配置红色通道
            red(255)
