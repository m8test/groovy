...
定义:
+ ModalDrawer drawerState(DrawerState bottomDrawerState)

参数:
+ DrawerState bottomDrawerState - 需要设置的 DrawerState

返回值:
+ ModalDrawer - 返回对象本身方便链式调用

示例代码:
+ 启动一个Activity, 并通过 ModalDrawer.drawerState() 方法设置 DrawerState
 */
