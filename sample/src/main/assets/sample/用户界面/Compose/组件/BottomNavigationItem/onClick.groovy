...
/*
功能:
+ 设置 BottomNavigationItem 点击事件

定义:
+ BottomNavigationItem onClick(Closure closure)

参数:
+ Closure closure - 设置 BottomNavigationItem 点击事件的闭包
    + 参数 - 无
    + delegate - 无
...
示例代码:
+ 启动一个Activity, 并通过 BottomNavigationItem.onClick() 方法设置 BottomNavigationItem 点击事件
 */
