...
/*
功能:
+ 设置 BottomNavigationItem 被选中时的颜色

定义:
+ BottomNavigationItem selectedContentColor(Closure closure)
...
示例代码:
+ 启动一个Activity, 并通过 BottomNavigationItem.selectedContentColor() 方法设置 BottomNavigationItem 被选中时的颜色
 */
