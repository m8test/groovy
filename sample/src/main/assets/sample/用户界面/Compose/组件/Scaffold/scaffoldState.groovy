...
定义:
+ Scaffold scaffoldState(ScaffoldState scaffoldState)

参数:
+ ScaffoldState scaffoldState - 需要设置的 ScaffoldState

返回值:
+ Scaffold - 返回对象本身方便链式调用

示例代码:
+ 启动一个Activity, 并通过 Scaffold.scaffoldState() 方法设置 ScaffoldState
 */
