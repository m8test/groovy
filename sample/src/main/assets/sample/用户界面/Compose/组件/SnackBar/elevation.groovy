...
/*
功能:
+ 设置 SnackBar 的海拔(z坐标)。这将控制 SnackBar 下方阴影的大小

定义:
+ SnackBar elevation(Number value)

参数:
+ Number value - SnackBar 海拔高度,单位dp

返回值:
+ SnackBar - 返回对象本身方便链式调用

示例代码:
+ 启动一个Activity, 并通过 SnackBar.elevation() 方法设置 SnackBar 的海拔
 */
