...
/*
功能:
+ 设置 BottomNavigationItem 是否被选中

定义:
+ BottomNavigationItem selected(Closure closure)
...
示例代码:
+ 启动一个Activity, 并通过 BottomNavigationItem.selected() 方法设置 BottomNavigationItem 是否被选中
 */
