package sample.用户界面.Compose.组件.NavigationRail

/*
功能:
+ 设置 NavigationRail 内容颜色

定义:
+ NavigationRail contentColor(Closure closure)
...
返回值:
+ NavigationRail - 返回对象本身方便链式调用

示例代码:
+ 启动一个Activity, 并通过 NavigationRail.contentColor() 方法设置 NavigationRail 内容颜色
 */
