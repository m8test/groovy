...
定义1:
+ Composable modifier(Closure modifier)

参数1:
+ Closure modifier - 配置 Modifier 的闭包
    + 参数 - 无
    + delegate - Modifier
...
参数2:
+ Modifier modifier - 需要设置的 Modifier 对象

返回值:
+ Composable - 返回对象本身方便链式调用

示例代码:
+ 启动一个Activity, 并通过 Composable.modifier() 方法设置 Text 可组合项的 Modifier .
 */
