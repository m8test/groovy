...
/*
功能:
+ 设置 BottomDrawer 抽屉内容颜色

定义:
+ BottomDrawer drawerContentColor(Closure closure)

参数:
+ Closure closure - 设置 BottomDrawer 抽屉内容颜色的闭包
    + 参数 - 无
    + delegate - Color
...
示例代码:
+ 启动一个Activity, 并通过 BottomDrawer.drawerContentColor() 方法设置 BottomDrawer 抽屉内容颜色
 */
