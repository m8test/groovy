...
/*
功能:
+ 设置 LeadingIconTab 被选择时的内容颜色

定义:
+ LeadingIconTab selectedContentColor(Closure closure)
...
示例代码:
+ 启动一个Activity, 并通过 LeadingIconTab.selectedContentColor() 方法设置 LeadingIconTab 被选择时的内容颜色
 */
