...
定义:
+ PopupProperties excludeFromSystemGesture(boolean value)
...
示例代码:
+ 启动一个Activity显示对话框, 并通过 PopupProperties.excludeFromSystemGesture() 方法检查是否设置 systemGestureExclusionRects 的标志
 */
