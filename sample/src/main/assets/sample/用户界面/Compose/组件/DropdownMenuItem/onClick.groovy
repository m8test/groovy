package sample.用户界面.Compose.组件.DropdownMenuItem
...
定义:
+ DropdownMenuItem onClick(Closure closure)
...
返回值:
+ DropdownMenuItem - 返回对象本身方便链式调用

示例代码:
+ 启动一个Activity, 并通过 DropdownMenuItem.onClick() 方法设置下拉菜单项点击事件.
 */
