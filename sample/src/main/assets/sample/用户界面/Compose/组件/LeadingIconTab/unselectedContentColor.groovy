package sample.用户界面.Compose.组件.LeadingIconTab

/*
功能:
+ 设置 LeadingIconTab 未被选择时的内容颜色

定义:
+ LeadingIconTab unselectedContentColor(Closure closure)
...
返回值:
+ LeadingIconTab - 返回对象本身方便链式调用

示例代码:
+ 启动一个Activity, 并通过 LeadingIconTab.unselectedContentColor() 方法设置 LeadingIconTab 未被选择时的内容颜色
 */
