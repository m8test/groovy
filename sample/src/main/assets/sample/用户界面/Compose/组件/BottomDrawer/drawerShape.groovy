...
/*
功能:
+ 设置 BottomDrawer 抽屉形状

定义:
+ BottomDrawer drawerShape(Closure closure)

参数:
+ Closure closure - 设置 BottomDrawer 抽屉形状的闭包
    + 参数 - 无
    + delegate - Shape
...
示例代码:
+ 启动一个Activity, 并通过 BottomDrawer.drawerShape() 方法设置 BottomDrawer 抽屉形状
 */
