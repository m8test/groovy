...
/*
功能:
+ 设置 SnackBarData , 可配合 actionColor() 使用

定义:
+ SnackBar snackBarData(SnackBarData snackBarData)

参数:
+ SnackBarData snackBarData - 需要设置的 SnackBarData 对象

返回值:
+ SnackBar - 返回对象本身方便链式调用

示例代码:
+ 启动一个Activity, 并通过 SnackBar.snackBarData() 方法设置 SnackBarData
 */
