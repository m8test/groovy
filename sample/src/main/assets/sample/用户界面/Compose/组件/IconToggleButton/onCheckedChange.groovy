package sample.用户界面.Compose.组件.IconToggleButton
...
定义:
+ IconToggleButton onCheckedChange(Closure closure)
...
返回值:
+ IconToggleButton - 返回对象本身方便链式调用

示例代码:
+ 启动一个Activity, 并通过 IconToggleButton.onCheckedChange() 方法设置图标切换按钮选择改变事件
 */
