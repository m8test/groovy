...
/*
功能:
+ 设置 BottomNavigation 内容

定义:
+ BottomNavigation content(Closure closure)

参数:
+ Closure closure - 设置 BottomNavigation 内容的闭包
    + 参数 - 无
...
示例代码:
+ 启动一个Activity, 并通过 BottomNavigation.content() 方法设置 BottomNavigation 内容
 */
