package sample.用户界面.Compose.组件.BadgedBox
...
定义:
+ BadgedBox badge(Closure closure)

参数:
+ Closure closure - 设置 Badge 的闭包
    + 参数 - 无
    + delegate - Slot(BoxScopeModifier)

返回值:
+ BadgedBox - 返回对象本身方便链式调用

示例代码:
+ 启动一个Activity, 并通过 BadgedBox.badge() 方法设置 Badge .
 */
