...
/*
功能:
+ 设置 BottomNavigationItem 图标

定义:
+ BottomNavigationItem icon(Closure closure)

参数:
+ Closure closure - 设置 BottomNavigationItem 图标的闭包
    + 参数 - 无
...
示例代码:
+ 启动一个Activity, 并通过 BottomNavigationItem.icon() 方法设置 BottomNavigationItem 图标
 */
