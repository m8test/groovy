...
/*
功能:
+ 设置 ModalBottomSheetLayout 内容

定义:
+ ModalBottomSheetLayout content(Closure closure)

参数:
+ Closure closure - 设置 ModalBottomSheetLayout 内容的闭包
    + 参数 - 无
...
示例代码:
+ 启动一个Activity, 并通过 ModalBottomSheetLayout.content() 方法设置 ModalBottomSheetLayout 内容
 */
