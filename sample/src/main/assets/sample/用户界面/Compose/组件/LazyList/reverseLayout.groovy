...
/*
功能:
+ 设置是否反转滚动和布局方向,如果为true,项目以相反的顺序排列并且 LazyListState.firstVisibleItemIndex() == 0 表示滚动到底部

定义:
+ LazyList reverseLayout(boolean value)
...
示例代码:
+ 启动一个Activity, 并通过 LazyList.reverseLayout() 方法设置是否反转滚动和布局方向
 */
