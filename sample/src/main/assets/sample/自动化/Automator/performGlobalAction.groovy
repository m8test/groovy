...
参数:
+ int action - 需要执行的全局操作,参考 https://developer.android.google.cn/reference/kotlin/android/accessibilityservice/AccessibilityService?hl=en#GLOBAL_ACTION_ACCESSIBILITY_ALL_APPS:kotlin.Int

返回值:
+ boolean - true表示操作成功,false表示操作失败

示例代码:
+ 启动一个Activity, 并通过 Automator.performGlobalAction() 方法执行全局操作
 */
