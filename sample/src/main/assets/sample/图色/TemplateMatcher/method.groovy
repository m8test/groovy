...
定义:
+ TemplateMatcher method(String method)

参数:
+ String method - 匹配方法,可选值有 TM_SQDIFF, TM_SQDIFF_NORMED, TM_CCORR, TM_CCORR_NORMED, TM_CCOEFF, TM_CCOEFF_NORMED

返回值:
+ TemplateMatcher - 返回对象本身方便链式调用

示例代码:
+ 启动一个Activity, 并通过 TemplateMatcher.method() 方法设置匹配方法
 */
