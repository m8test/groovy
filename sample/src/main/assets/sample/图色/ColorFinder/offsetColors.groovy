package sample.图色.ColorFinder

/*
功能:
+ 设置相对于 primaryColor 的偏移颜色

定义:
+ ColorFinder offsetColors(List<Closure> closures)
...
返回值:
+ ColorFinder - 返回对象本身方便链式调用

示例代码:
+ 启动一个Activity, 并通过 ColorFinder.offsetColors() 方法设置相对于 primaryColor 的偏移颜色
 */
