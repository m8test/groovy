...
定义:
+ ShellCommand newShellCommand(ScriptFile file)

参数:
+ ScriptFile file - 命令所在路径

返回值:
+ ShellCommand - 根据文件创建的 Shell 命令,如果创建失败会抛异常

示例代码:
+ 通过 Shells.newShellCommand() 创建 Shell 命令,实现 frp 内网穿透
 */
