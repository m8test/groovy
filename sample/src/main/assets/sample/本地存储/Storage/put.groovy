...
/*
功能:
+ 向 Storage 本地存储对象中添加键值对.

定义:
+ boolean put(String key, String value)

参数:
+ String key - 需要添加到 Storage 本地存储对象中的键
+ String value - 需要添加到 Storage 本地存储对象中的键对应的值

返回值:
+ boolean - 成功将键值对添加到 Storage 本地存储对象中返回true,否则返回false

示例代码:
+ 通过 Storages.get() 获取本地存储对象 Storage ,并通过 Storage.put() 向其添加内容.
 */
