...
+ 关闭由当前 [Floaty](/API/Floaty/Floaty/README.md) 创建的所有悬浮窗口.

定义:

+ [Floaty](/API/Floaty/Floaty/README.md) closeAll()
...
+ [Floaty](/API/Floaty/Floaty/README.md) - 返回对象本身方便链式调用

示例代码:

+ 显示两个悬浮窗口后通过 [Floaty.closeAll()](/API/Floaty/Floaty/README.md?id=closeAll)
  方法关闭由该 [Floaty](/API/Floaty/Floaty/README.md) 对象创建的所有窗口.
