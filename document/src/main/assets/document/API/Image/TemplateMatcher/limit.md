...
+ 设置匹配结果最大数量,如果没有设置默认最大数量为5

定义:

+ [TemplateMatcher](/API/Image/TemplateMatcher/README.md) limit(int limit)
...
+ 启动一个Activity, 并通过 [TemplateMatcher.limit()](/API/Image/TemplateMatcher/README.md?id=limit)
  方法设置匹配结果最大数量
                        ...
                        onClick {
                            ...
                            coroutineScope.launch({
                                ...
                                def matchingResults = $images.matchTemplate {
                                    ...
                                    // TemplateMatcher.limit() 用于设置匹配结果最大数量
                                    limit(1)
                                }
