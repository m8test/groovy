...
+ [TemplateMatcher](/API/Image/TemplateMatcher/README.md) maxPyramidLevel(int maxPyramidLevel)

参数:

+ int maxPyramidLevel - 金字塔最大层级,-1表示自动设置
...
+ 启动一个Activity,
  并通过 [TemplateMatcher.maxPyramidLevel()](/API/Image/TemplateMatcher/README.md?id=maxPyramidLevel)
  方法设置金字塔最大层级
                        ...
                        onClick {
                            ...
                            coroutineScope.launch({
                                ...
                                def matchingResults = $images.matchTemplate {
                                    ...
                                    // TemplateMatcher.maxPyramidLevel() 用于设置金字塔最大层级
                                    maxPyramidLevel(-1)
                                }
