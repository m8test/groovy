...
+ [TemplateMatcher](/API/Image/TemplateMatcher/README.md) region(Closure closure)

参数:

+ Closure closure - 设置匹配范围的闭包
    + 参数 - 无
    + delegate - [Rect](/API/UI/Graphics/Rect/README.md)

返回值:

+ [TemplateMatcher](/API/Image/TemplateMatcher/README.md) - 返回对象本身方便链式调用

示例代码:

+ 启动一个Activity, 并通过 [TemplateMatcher.region()](/API/Image/TemplateMatcher/README.md?id=region)
  方法设置匹配范围
                        ...
                        onClick {
                            ...
                            coroutineScope.launch({
                                ...
                                def matchingResults = $images.matchTemplate {
                                    ...
                                    // TemplateMatcher.region() 用于设置匹配范围
                                    region {
                                        // delegate -> Rect
                                        // ScriptImage.width() 用于获取图片宽度
                                        def imageWidth = originImage.width()
                                        // ScriptImage.height() 用于获取图片高度
                                        def imageHeight = originImage.height()
