...
+ [TemplateMatcher](/API/Image/TemplateMatcher/README.md) threshold(float threshold)

参数:

+ float threshold - 最低匹配度,取值范围[0-1.0]
...
+ 启动一个Activity, 并通过 [TemplateMatcher.threshold()](/API/Image/TemplateMatcher/README.md?id=threshold)
  方法设置最低匹配度
                        ...
                        onClick {
                            ...
                            coroutineScope.launch({
                                ...
                                def matchingResults = $images.matchTemplate {
                                    ...
                                    // TemplateMatcher.threshold() 用于设置最低匹配度
                                    threshold(0.85)
                                }
