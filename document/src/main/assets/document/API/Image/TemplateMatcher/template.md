...
+ [TemplateMatcher](/API/Image/TemplateMatcher/README.md)
  template([ScriptImage](/API/Image/ScriptImage/README.md) template)

参数:

+ [ScriptImage](/API/Image/ScriptImage/README.md) template - 需要设置的图片对象
...
+ 启动一个Activity, 并通过 [TemplateMatcher.template()](/API/Image/TemplateMatcher/README.md?id=template)
  方法设置模板图(小图)
