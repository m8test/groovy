...
+ [TemplateMatcher](/API/Image/TemplateMatcher/README.md) method(String method)

参数:

+ String method - 匹配方法,可选值有 TM_SQDIFF, TM_SQDIFF_NORMED, TM_CCORR, TM_CCORR_NORMED, TM_CCOEFF,
  TM_CCOEFF_NORMED
...
+ 启动一个Activity, 并通过 [TemplateMatcher.method()](/API/Image/TemplateMatcher/README.md?id=method)
  方法设置匹配方法
                        ...
                        onClick {
                            ...
                            coroutineScope.launch({
                                ...
                                def matchingResults = $images.matchTemplate {
                                    ...
                                    // TemplateMatcher.method() 用于设置匹配方法
