...
+ [Point](/API/UI/Graphics/Point/README.md) findColor(Closure closure)

参数:

+ Closure closure - 设置颜色查找器的闭包
    + 参数 - 无
    + delegate - [ColorFinder](/API/Image/ColorFinder/README.md)

返回值:

+ [Point](/API/UI/Graphics/Point/README.md) - 查找结果的坐标,如果找不到则返回null

示例代码:

+ 启动一个Activity, 并通过 [Images.findColor()](/API/Image/Images/README.md?id=findColor) 方法在图片中查找颜色
