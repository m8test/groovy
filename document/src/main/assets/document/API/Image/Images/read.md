...
+ [ScriptImage](/API/Image/ScriptImage/README.md) read(Closure closure)

参数:

+ Closure closure - 设置图片读取器的闭包
    + 参数 - 无
    + delegate - [ImageReader](/API/Image/ImageReader/README.md)

返回值:

+ [ScriptImage](/API/Image/ScriptImage/README.md) - 读取到的图片,如果读取图片失败则返回null

示例代码:

+ 启动一个Activity, 并通过 [Images.read()](/API/Image/Images/README.md?id=read) 方法读取图片
