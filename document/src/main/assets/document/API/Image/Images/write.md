...
+ [Images](/API/Image/Images/README.md) write(Closure closure)

参数:

+ Closure closure - 设置图片写入器的闭包
    + 参数 - 无
    + delegate - [ImageWriter](/API/Image/ImageWriter/README.md)

返回值:

+ [Images](/API/Image/Images/README.md) - 返回对象本身方便链式调用

示例代码:

+ 启动一个Activity, 并通过 [Images.write()](/API/Image/Images/README.md?id=write) 方法保存图片
