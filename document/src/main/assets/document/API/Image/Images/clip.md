...
+ [ScriptImage](/API/Image/ScriptImage/README.md)
  clip([ScriptImage](/API/Image/ScriptImage/README.md) scriptImage, Closure closure)

参数:

+ [ScriptImage](/API/Image/ScriptImage/README.md) scriptImage - 需要裁剪的图片
+ Closure closure - 设置裁剪区域的闭包
    + 参数 - 无
    + delegate - [Rect](/API/UI/Graphics/Rect/README.md)

返回值:

+ [ScriptImage](/API/Image/ScriptImage/README.md) - 裁剪后的图片

示例代码:

+ 启动一个Activity, 并通过 [Images.clip()](/API/Image/Images/README.md?id=clip) 方法裁剪图片
