...
+ [MatchingResults](/API/Image/MatchingResults/README.md) matchTemplate(Closure closure)

参数:

+ Closure closure - 设置模板匹配的闭包
    + 参数 - 无
    + delegate - [TemplateMatcher](/API/Image/TemplateMatcher/README.md)

返回值:

+ [MatchingResults](/API/Image/MatchingResults/README.md) - 模板匹配结果

示例代码:

+ 启动一个Activity, 并通过 [Images.matchTemplate()](/API/Image/Images/README.md?id=matchTemplate) 方法匹配模板
