...
+ [ImageWriter](/API/Image/ImageWriter/README.md)
  image([ScriptImage](/API/Image/ScriptImage/README.md) scriptImage)

参数:

+ [ScriptImage](/API/Image/ScriptImage/README.md) scriptImage - 需要被保存的图片

返回值:

+ [ImageWriter](/API/Image/ImageWriter/README.md) - 返回对象本身方便链式调用

示例代码:

+ 启动一个Activity, 并通过 [ImageWriter.image()](/API/Image/ImageWriter/README.md?id=image) 方法设置需要被保存的图片
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            coroutineScope.launch({
                                ...
                                // Images.write() 用于保存图片
                                $images.write {
                                    // delegate -> ImageWriter
                                    // ImageWriter.image() 用于设置需要被保存的图片
                                    image(originImage)
                                    // ImageWriter.path() 用于设置图片保存的路径
                                    path("/sdcard/save_by_image_writer.png")
                                }
                                ...
                                snackBarHostState.showSnackBar("保存图片成功", null, "Short")
                            }
                        }
                    }
                }
