...
+ [ImageWriter](/API/Image/ImageWriter/README.md) quality(int quality)

参数:

+ int quality - 图片保存的质量,取值范围 [0,100] , 根据 format 的不同，该值的解释也不同
...
+ 启动一个Activity, 并通过 [ImageWriter.quality()](/API/Image/ImageWriter/README.md?id=quality) 方法设置图片保存的质量
                        ...
                        onClick {
                            ...
                            coroutineScope.launch({
                                ...
                                $images.write {
                                    ...
                                    path("/sdcard/save_by_image_writer.jpg")
                                    // ImageWriter.quality() 用于设置图片保存的质量
                                    quality(50)
                                }
