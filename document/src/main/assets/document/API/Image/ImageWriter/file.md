...
+ [ImageWriter](/API/Image/ImageWriter/README.md) file([ScriptFile](/API/File/ScriptFile/README.md) scriptFile)

参数:

+ [ScriptFile](/API/File/ScriptFile/README.md) scriptFile - 图片文件
...
+ 启动一个Activity, 并通过 [ImageWriter.file()](/API/Image/ImageWriter/README.md?id=file) 方法设置图片保存的文件
