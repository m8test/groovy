...
+ [ImageWriter](/API/Image/ImageWriter/README.md) format(String format)

参数:

+ String format - 图片保存的格式,如 png, jpg, jpeg, webp 等
...
+ 启动一个Activity, 并通过 [ImageWriter.format()](/API/Image/ImageWriter/README.md?id=format) 方法设置图片保存的格式
                        ...
                        onClick {
                            ...
                            coroutineScope.launch({
                                ...
                                $images.write {
                                    ...
                                    // ImageWriter.format() 用于设置图片保存的格式
                                    format("jpg")
                                }
