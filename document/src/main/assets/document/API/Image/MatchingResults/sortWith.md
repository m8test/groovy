...
+ [MatchingResults](/API/Image/MatchingResults/README.md) sortWith(Closure closure)
...
+ 启动一个Activity, 并通过 [MatchingResults.sortWith()](/API/Image/MatchingResults/README.md?id=sortWith)
  方法将所有匹配结果排序
