...
+ [MatchingResults](/API/Image/MatchingResults/README.md) forEach(Closure closure)

参数:

+ Closure closure - 用于遍历的闭包
    + 参数
        + [MatchingResult](/API/Image/MatchingResult/README.md) result - 当前正在遍历的对象
    + delegate - 无

返回值:

+ [MatchingResults](/API/Image/MatchingResults/README.md) - 返回对象本身方便链式调用

示例代码:

+ 启动一个Activity, 并通过 [MatchingResults.forEach()](/API/Image/MatchingResults/README.md?id=forEach)
  方法遍历所有匹配结果
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            coroutineScope.launch({
                                ...
                                // MatchingResults.forEach() 用于遍历所有匹配结果
