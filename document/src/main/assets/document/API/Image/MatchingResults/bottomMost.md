...
+ [MatchingResult](/API/Image/MatchingResult/README.md) bottomMost()
...
+ [MatchingResult](/API/Image/MatchingResult/README.md) - 最底部的结果

示例代码:

+ 启动一个Activity,
  并通过 [MatchingResults.bottomMost()](/API/Image/MatchingResults/README.md?id=bottomMost) 方法获取最底部的结果
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            coroutineScope.launch({
                                ...
                                // MatchingResults.bottomMost() 用于获取最底部的结果
                                def bottomMostResult = matchingResults.bottomMost()
                                ...
                                snackBarHostState.showSnackBar(bottomMostResult.toString(), null, "Short")
                            }
                        }
                    }
                }
