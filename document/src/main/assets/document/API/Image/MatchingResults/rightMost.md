...
+ [MatchingResult](/API/Image/MatchingResult/README.md) rightMost()
...
+ [MatchingResult](/API/Image/MatchingResult/README.md) - 最右边的结果

示例代码:

+ 启动一个Activity, 并通过 [MatchingResults.rightMost()](/API/Image/MatchingResults/README.md?id=rightMost)
  方法获取最右边的结果
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            coroutineScope.launch({
                                ...
                                // MatchingResults.rightMost() 用于获取最右边的结果
                                def rightMostResult = matchingResults.rightMost()
                                ...
                                snackBarHostState.showSnackBar(rightMostResult.toString(), null, "Short")
                            }
                        }
                    }
                }
