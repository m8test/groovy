...
+ [MatchingResult](/API/Image/MatchingResult/README.md) best()
...
+ [MatchingResult](/API/Image/MatchingResult/README.md) - 匹配度最高的结果

示例代码:

+ 启动一个Activity, 并通过 [MatchingResults.best()](/API/Image/MatchingResults/README.md?id=best)
  方法获取匹配度最高的结果
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            coroutineScope.launch({
                                ...
                                snackBarHostState.showSnackBar(bestResult.toString(), null, "Short")
                            }
                        }
                    }
                }
