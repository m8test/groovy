...
+ 将所有匹配结果排序并返回一个新的匹配结果集合

定义:

+ [MatchingResults](/API/Image/MatchingResults/README.md) sortedWith(Closure closure)

参数:

+ Closure closure - 用于排序的闭包
    + 参数
        + [MatchingResult](/API/Image/MatchingResult/README.md) p1 - 用于比较的对象
        + [MatchingResult](/API/Image/MatchingResult/README.md) p2 - 用于比较的对象
    + delegate - 无
    + 返回值 - int

返回值:

+ [MatchingResults](/API/Image/MatchingResults/README.md) - 排序后的新的匹配结果集合

示例代码:

+ 启动一个Activity,
  并通过 [MatchingResults.sortedWith()](/API/Image/MatchingResults/README.md?id=sortedWith)
  方法将所有匹配结果排序并返回一个新的匹配结果集合
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            coroutineScope.launch({
                                ...
                                // MatchingResults.sortedWith() 用于将所有匹配结果排序并返回一个新的匹配结果集合
                                def newMatchingResults = matchingResults.sortedWith { p1, p2 ->
                                ...
                                $assert.assertTrue(matchingResults != newMatchingResults, "匹配结果集合与原来的集合不一样")
