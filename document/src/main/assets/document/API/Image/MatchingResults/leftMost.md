...
+ [MatchingResult](/API/Image/MatchingResult/README.md) leftMost()
...
+ [MatchingResult](/API/Image/MatchingResult/README.md) - 最左边的结果

示例代码:

+ 启动一个Activity, 并通过 [MatchingResults.leftMost()](/API/Image/MatchingResults/README.md?id=leftMost)
  方法获取最左边的结果
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            coroutineScope.launch({
                                ...
                                // MatchingResults.leftMost() 用于获取最左边的结果
                                def leftMostResult = matchingResults.leftMost()
                                ...
                                snackBarHostState.showSnackBar(leftMostResult.toString(), null, "Short")
                            }
                        }
                    }
                }
