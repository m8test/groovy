...
+ [MatchingResult](/API/Image/MatchingResult/README.md) worst()
...
+ [MatchingResult](/API/Image/MatchingResult/README.md) - 匹配度最低的结果

示例代码:

+ 启动一个Activity, 并通过 [MatchingResults.worst()](/API/Image/MatchingResults/README.md?id=worst)
  方法获取匹配度最低的结果
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            coroutineScope.launch({
                                ...
                                // MatchingResults.worst() 用于获取匹配度最低的结果
                                def worstResult = matchingResults.worst()
                                ...
                                snackBarHostState.showSnackBar(worstResult.toString(), null, "Short")
                            }
                        }
                    }
                }
