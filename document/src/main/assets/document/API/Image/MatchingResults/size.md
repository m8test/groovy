...
+ 启动一个Activity, 并通过 [MatchingResults.size()](/API/Image/MatchingResults/README.md?id=size)
  方法获取匹配结果数量
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            coroutineScope.launch({
                                ...
                                // MatchingResults.size() 用于获取匹配结果数量
                                def matchingResultSize = matchingResults.size()
                                ...
                                snackBarHostState.showSnackBar(matchingResultSize.toString(), null, "Short")
                            }
                        }
                    }
                }
