...
+ [MatchingResult](/API/Image/MatchingResult/README.md) topMost()
...
+ [MatchingResult](/API/Image/MatchingResult/README.md) - 最顶部的结果

示例代码:

+ 启动一个Activity, 并通过 [MatchingResults.topMost()](/API/Image/MatchingResults/README.md?id=topMost)
  方法获取最顶部的结果
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            coroutineScope.launch({
                                ...
                                // MatchingResults.topMost() 用于获取最顶部的结果
                                def topMostResult = matchingResults.topMost()
                                ...
                                snackBarHostState.showSnackBar(topMostResult.toString(), null, "Short")
                            }
                        }
                    }
                }
