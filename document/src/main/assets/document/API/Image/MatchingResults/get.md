...
+ [MatchingResult](/API/Image/MatchingResult/README.md) get(int index)
...
+ [MatchingResult](/API/Image/MatchingResult/README.md) - 指定索引的匹配结果

示例代码:

+ 启动一个Activity, 并通过 [MatchingResults.get()](/API/Image/MatchingResults/README.md?id=get)
  方法获取指定索引的匹配结果
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            coroutineScope.launch({
                                ...
                                def matchingResult = matchingResults.get(0)
