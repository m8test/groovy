...
+ 启动一个Activity, 并通过 [MatchingResult.similarity()](/API/Image/MatchingResult/README.md?id=similarity)
  方法获取匹配结果的相似度
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            coroutineScope.launch({
                                ...
                                // MatchingResult.similarity() 用于获取匹配结果的相似度
                                def bestResultSimilarity = bestResult.similarity()
                                ...
                                snackBarHostState.showSnackBar(bestResultSimilarity.toString(), null, "Short")
                            }
                        }
                    }
                }
