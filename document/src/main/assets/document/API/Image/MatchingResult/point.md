...
+ [Point](/API/UI/Graphics/Point/README.md) point()
...
+ [Point](/API/UI/Graphics/Point/README.md) - 匹配结果的坐标

示例代码:

+ 启动一个Activity, 并通过 [MatchingResult.point()](/API/Image/MatchingResult/README.md?id=point)
  方法获取匹配结果的坐标
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            coroutineScope.launch({
                                ...
                                // MatchingResults.best() 用于获取匹配度最高的结果
                                def bestResult = matchingResults.best()
                                // MatchingResult.point() 用于获取匹配结果的坐标
                                def bestResultPoint = bestResult.point()
                                ...
                                snackBarHostState.showSnackBar(bestResultPoint.toString(), null, "Short")
                            }
                        }
                    }
                }
