...
+ 设置相对于 [ColorFinder.primaryColor()](/API/Image/ColorFinder/README.md?id=primaryColor) 的偏移颜色

定义:

+ [ColorFinder](/API/Image/ColorFinder/README.md) offsetColors(List<Closure> closures)

参数:

+ List<Closure> closures - 设置偏移颜色的闭包
    + 参数 - 无
    + delegate - [OffsetColor](/API/Image/ColorFinder/OffsetColor/README.md)

返回值:

+ [ColorFinder](/API/Image/ColorFinder/README.md) - 返回对象本身方便链式调用

示例代码:

+ 启动一个Activity, 并通过 [ColorFinder.offsetColors()](/API/Image/ColorFinder/README.md?id=offsetColors)
  方法设置相对于 [ColorFinder.primaryColor()](/API/Image/ColorFinder/README.md?id=primaryColor) 的偏移颜色
