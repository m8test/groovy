...
+ [ColorFinder](/API/Image/ColorFinder/README.md) region(Closure closure)

参数:

+ Closure closure - 设置查找范围的闭包
    + 参数 - 无
...
+ 启动一个Activity, 并通过 [ColorFinder.region()](/API/Image/ColorFinder/README.md?id=region) 方法设置查找范围
                            ...
                            coroutineScope.launch({
                                ...
                                def point = $images.findColor {
                                    ...
                                    primaryColor {
                                        ...
                                        parse(originImage.pixel(0, 0))
                                    }
                                    // ColorFinder.region() 用于查找范围
                                    region {
                                        // delegate -> Rect
