...
+ [OffsetColor](/API/Image/ColorFinder/OffsetColor/README.md) offset(Closure closure)

参数:

+ Closure closure - 设置偏移量的闭包
    + 参数 - 无
    + delegate - [Offset](/API/UI/Graphics/Offset/README.md)
...
+ 启动一个Activity, 并通过 [OffsetColor.offset()](/API/Image/ColorFinder/OffsetColor/README.md?id=offset)
  方法设置偏移量
