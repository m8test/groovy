...
+ [ColorFinder](/API/Image/ColorFinder/README.md) primaryColor(Closure closure)
...
+ 启动一个Activity, 并通过 [ColorFinder.primaryColor()](/API/Image/ColorFinder/README.md?id=primaryColor)
  方法设置需要查找的颜色
