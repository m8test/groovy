...
+ [ColorFinder](/API/Image/ColorFinder/README.md)
  image([ScriptImage](/API/Image/ScriptImage/README.md) image)

参数:

+ [ScriptImage](/API/Image/ScriptImage/README.md) image - 需要查找颜色的图片
...
+ 启动一个Activity, 并通过 [ColorFinder.image()](/API/Image/ColorFinder/README.md?id=image) 方法设置需要查找颜色的图片
