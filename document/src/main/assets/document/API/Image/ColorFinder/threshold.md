...
+ [ColorFinder](/API/Image/ColorFinder/README.md) threshold(float threshold)

参数:

+ float threshold - 颜色最低匹配度,取值范围[0.0-1.0]
...
+ 启动一个Activity, 并通过 [ColorFinder.threshold()](/API/Image/ColorFinder/README.md?id=threshold)
  方法设置颜色最低匹配度
                        ...
                        onClick {
                            ...
                            coroutineScope.launch({
                                ...
                                def point = $images.findColor {
                                    ...
                                    // ColorFinder.threshold() 用于设置颜色最低匹配度
                                    threshold(0.9f)
                                }
