...
+ [ScriptImage](/API/Image/ScriptImage/README.md) captureScreen()
...
+ [ScriptImage](/API/Image/ScriptImage/README.md) - 截取屏幕的图片,如果截取失败返回null

示例代码:

+ 启动一个Activity,
  并通过 [ScreenCapture.captureScreen()](/API/Image/ScreenCapture/README.md?id=captureScreen) 方法截取屏幕
