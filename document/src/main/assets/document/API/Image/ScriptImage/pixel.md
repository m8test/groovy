...
+ 启动一个Activity, 并通过 [ScriptImage.pixel()](/API/Image/ScriptImage/README.md?id=pixel) 方法获取指定坐标的像素
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            coroutineScope.launch({
                                ...
                                // ScriptImage.pixel() 用于获取指定坐标的像素
                                def imagePixel = originImage.pixel(100, 200)
                                ...
                                snackBarHostState.showSnackBar("pixel:${imagePixel}", null, "Short")
                            }
                        }
                    }
                }
