...
+ String toBytes(String format, int quality)
...
+ 启动一个Activity, 并通过 [ScriptImage.toBytes()](/API/Image/ScriptImage/README.md?id=toBytes) 方法将图片转成字节数组
                        ...
                        onClick {
                            ...
                            coroutineScope.launch({
                                ...
                                def originImage = $images.read {
                                    ...
                                    // ScriptImage.toBytes() 用于将图片转成字节数组
                                    def imgBytes = img.toBytes("png", 100)
