...
+ [ImageReader](/API/Image/ImageReader/README.md) base64(String base64)

参数:

+ String base64 - 图片对应的base64字符串
...
+ 启动一个Activity, 并通过 [ImageReader.base64()](/API/Image/ImageReader/README.md?id=base64)
  方法从base64字符串中读取图片
                        ...
                        onClick {
                            ...
                            coroutineScope.launch({
                                ...
                                def originImage = $images.read {
                                    ...
                                    base64($images.read { url("https://s1.ax1x.com/2023/02/17/pSbOeMj.jpg") }.toBase64("png", 100))
                                }
                                // Images.read() 用于读取图片
                                def templateImage = $images.read {
                                    // delegate -> ImageReader
                                    // ImageReader.base64() 用于从base64字符串中读取图片
                                    base64($images.read { url("https://s1.ax1x.com/2023/02/17/pSbOOwq.png") }.toBase64("png", 100))
                                }
