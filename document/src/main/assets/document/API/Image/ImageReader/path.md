...
+ [ImageReader](/API/Image/ImageReader/README.md) path(String path)
...
+ 启动一个Activity, 并通过 [ImageReader.path()](/API/Image/ImageReader/README.md?id=path) 方法从本地路径中读取图片
