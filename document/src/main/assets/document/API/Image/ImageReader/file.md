...
+ [ImageReader](/API/Image/ImageReader/README.md) file([ScriptFile](/API/File/ScriptFile/README.md)
  scriptFile)
...
+ [ImageReader](/API/Image/ImageReader/README.md) - 返回对象本身方便链式调用

示例代码:

+ 启动一个Activity, 并通过 [ImageReader.file()](/API/Image/ImageReader/README.md?id=file) 方法从指定的文件中读取图片

```groovy
def client = $httpClientManager.newClient()
// HttpClient.request() 会返回一个 HttpClientResponse 对象,封装了Http响应信息
def response = client.request("https://s1.ax1x.com/2023/02/17/pSbOeMj.jpg") {
                        ...
                        onClick {
                            ...
                            coroutineScope.launch({
                                ...
                                def originImage = $images.read {
                                    ...
                                    // ImageReader.file() 用于从指定的文件中读取图片
                                    file(scriptFile)
                                }
                                // Images.read() 用于读取图片
