...
+ [HttpServerRequest](/API/Network/HttpServer/HttpServerRequest/README.md) request()
...
+ [HttpServerRequest](/API/Network/HttpServer/HttpServerRequest/README.md) - 返回对象本身方便链式调用
