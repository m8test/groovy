...
+ 获取请求体(application/x-www-from-urlencoded)参数.

定义:

+ [JSONObject](/API/Json/JSONObject/README.md) urlencodedBody()
...
+ [JSONObject](/API/Json/JSONObject/README.md) - 包含请求体参数的对象.
...
def server = $httpServerManager.newServer(8080) {
    ...
    routing {
        ...
        post("/urlencodedBody") {
            ...
            def urlencodedBody = request.urlencodedBody()
            // 断言urlencoded请求体内容
            $assert.assertTrue(urlencodedBody.get("formParameter1") == "formParameterValue1", "formParameter1")
            $assert.assertTrue(urlencodedBody.get("formParameter2") == "formParameterValue2", "formParameter2")
...
def response = client.request("http://localhost:8080/urlencodedBody") {
    ...
    urlencodedBody(formParameter1: "formParameterValue1", formParameter2: "formParameterValue2")
}
