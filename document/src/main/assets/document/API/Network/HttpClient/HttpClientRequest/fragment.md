...
+ [HttpClientRequest](/API/Network/HttpClient/HttpClientRequest/README.md) fragment(String fragment)
...
+ 在8080端口开启一个服务器,通过  
  ...
  设置锚点后再通过 [HttpClient.request()](/API/Network/HttpClient/HttpClient/README.md?id=request) 方法访问该服务器.
