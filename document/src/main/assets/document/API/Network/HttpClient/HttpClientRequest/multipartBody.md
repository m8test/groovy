...
+ [HttpClientRequest](/API/Network/HttpClient/HttpClientRequest/README.md) multipartBody(Closure
  body)
...
+ Closure body - 配置multipart的闭包
    + 参数 - 无
    + delegate - [HttpClientMultipart](/API/Network/HttpClient/HttpClientMultipart/README.md)
