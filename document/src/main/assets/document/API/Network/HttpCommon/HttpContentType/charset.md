...
+ [HttpCharset](/API/Network/HttpCommon/HttpCharset/README.md) - 字符编码.

示例代码:

+ 在8080端口开启一个服务器,通过
  [HttpContentType.charset()](/API/Network/HttpCommon/HttpContentType/README.md?id=charset) 获取字符编码.
...
// HttpContentType.charset() 用于获取字符编码
def charset = contentType.charset()
// 断言字符编码
$assert.assertTrue(charset.name() == "UTF-8", "charset")
