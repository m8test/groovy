...
+ 在8080端口开启一个服务器,通过 [HttpCookie.value()](/API/Network/HttpCommon/HttpCookie/README.md?id=value)
  获取cookie值.
...
// HttpCookie.value() 用于获取Cookie值
def value = cookie.value()
// 断言value
$assert.assertTrue(value == "cookieValue", "value")
