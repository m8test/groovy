...
+ [JSONObject](/API/Json/JSONObject/README.md) - 包含此part请求头的对象.

示例代码:

+ 在8080端口开启一个服务器,通过
  [HttpMultipartItem.headers()](/API/Network/HttpCommon/HttpMultipartItem/README.md?id=headers)
  获取此part中的请求头对象.
...
def server = $httpServerManager.newServer(8080) {
    ...
    routing {
        ...
        post("/headers") {
            ...
            // HttpMultipartItem.headers() 用于获取此part中的请求头
