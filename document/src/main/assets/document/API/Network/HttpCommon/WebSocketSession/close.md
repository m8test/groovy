...
+ [WebSocketSession](/API/Network/HttpCommon/WebSocketSession/README.md) close(int code = 1000,
  String message = "")
...
+ 在8080端口开启一个 WebSocket
  服务器,通过 [WebSocketSession.close()](/API/Network/HttpCommon/WebSocketSession/README.md?id=close) 关闭
  WebSocket 连接.
