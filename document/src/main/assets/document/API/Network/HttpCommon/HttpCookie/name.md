...
+ 在8080端口开启一个服务器,通过 [HttpCookie.name()](/API/Network/HttpCommon/HttpCookie/README.md?id=name)
  获取cookie名.
...
def server = $httpServerManager.newServer(8080) {
    ...
    routing {
        ...
        get("/name") {
            ...
            response.cookie(name: "cookie", value: "cookieValue")
...
// HttpCookie.name() 用于获取Cookie名
def name = cookie.name()
// 断言name
$assert.assertTrue(name == "cookie", "name")
