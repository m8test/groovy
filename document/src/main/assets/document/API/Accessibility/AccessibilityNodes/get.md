...
+ [AccessibilityNode](/API/Accessibility/AccessibilityNode/README.md) get(int index)
...
+ [AccessibilityNode](/API/Accessibility/AccessibilityNode/README.md) -
  索引值对应的 [AccessibilityNode](/API/Accessibility/AccessibilityNode/README.md)

示例代码:

+ 启动一个Activity,
  并通过 [AccessibilityNodes.get()](/API/Accessibility/AccessibilityNodes/README.md?id=get)
  方法获取指定索引的节点
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilityNodes.get() 用于获取指定索引的节点
                            def node = nodes.get(0)
