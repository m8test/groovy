...
+ [AccessibilityNodes](/API/Accessibility/AccessibilityNodes/README.md) forEach(Closure closure)

参数:

+ Closure closure - 用于遍历操作的闭包
    + 参数
        + [AccessibilityNode](/API/Accessibility/AccessibilityNode/README.md) node - 当前遍历的节点
    + delegate - 无

返回值:

+ [AccessibilityNodes](/API/Accessibility/AccessibilityNodes/README.md) - 返回对象本身方便链式调用

示例代码:

+ 启动一个Activity,
  并通过 [AccessibilityNodes.forEach()](/API/Accessibility/AccessibilityNodes/README.md?id=forEach)
  方法遍历所有节点
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilityNodes.forEach() 用于遍历所有节点
                            nodes.forEach {
                                // it -> AccessibilityNode
                                // SnackBarHostState.showSnackBar() 用于显示 SnackBar
                                snackBarHostState.showSnackBar(it.toString(), null, "Short")
                            }
                        }
                    }
                }
