...
+ 启动一个Activity,
  并通过 [AccessibilityNode.longClick()](/API/Accessibility/AccessibilityNode/README.md?id=longClick)
  方法长按节点
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilityNode.longClick() 用于长按节点
                            $console.log(node.longClick())
                        }
                    }
                }
            }
            ...
            Text {
                ...
                modifier {
                    ...
                    combinedClickable(true, null, null, null, {
                        ...
                        snackBarHostState.showSnackBar("Text被长按", null, "Short")
                    }, {
                        // SnackBarHostState.showSnackBar() 用于显示 SnackBar
                        snackBarHostState.showSnackBar("Text被双击", null, "Short")
                    }, {
                        // SnackBarHostState.showSnackBar() 用于显示 SnackBar
