...
+ 启动一个Activity,
  并通过 [AccessibilityNode.rowSpan()](/API/Accessibility/AccessibilityNode/README.md?id=rowSpan)
  方法获取节点的 rowSpan 值
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilityNode.rowSpan() 用于获取节点的 rowSpan 值
                            def message = node.rowSpan()
                            // SnackBarHostState.showSnackBar() 用于显示 SnackBar
                            snackBarHostState.showSnackBar("rowSpan:$message", null, "Short")
                        }
                    }
                }
            }
