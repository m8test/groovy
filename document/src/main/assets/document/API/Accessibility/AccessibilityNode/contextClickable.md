...
+ boolean - 节点的 contextClickable 值

示例代码:

+ 启动一个Activity,
  并通过 [AccessibilityNode.contextClickable()](/API/Accessibility/AccessibilityNode/README.md?id=contextClickable)
  方法获取节点的 contextClickable 值
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilityNode.contextClickable() 用于获取节点的 contextClickable 值
                            def message = node.contextClickable()
                            // SnackBarHostState.showSnackBar() 用于显示 SnackBar
                            snackBarHostState.showSnackBar("contextClickable:$message", null, "Short")
                        }
                    }
                }
            }
