...
+ boolean - 节点的 enabled 值

示例代码:

+ 启动一个Activity,
  并通过 [AccessibilityNode.enabled()](/API/Accessibility/AccessibilityNode/README.md?id=enabled)
  方法获取节点的 enabled 值
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilityNode.enabled() 用于获取节点的 enabled 值
                            def message = node.enabled()
                            // SnackBarHostState.showSnackBar() 用于显示 SnackBar
                            snackBarHostState.showSnackBar("enabled:$message", null, "Short")
                        }
                    }
                }
            }
