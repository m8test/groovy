...
+ boolean - 节点的 scrollable 值

示例代码:

+ 启动一个Activity,
  并通过 [AccessibilityNode.scrollable()](/API/Accessibility/AccessibilityNode/README.md?id=scrollable)
  方法获取节点的 scrollable 值
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilityNode.scrollable() 用于获取节点的 scrollable 值
                            def message = node.scrollable()
                            // SnackBarHostState.showSnackBar() 用于显示 SnackBar
                            snackBarHostState.showSnackBar("scrollable:$message", null, "Short")
                        }
                    }
                }
            }
