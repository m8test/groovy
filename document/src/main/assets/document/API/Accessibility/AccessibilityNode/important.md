...
+ boolean - 节点的 important 值

示例代码:

+ 启动一个Activity,
  并通过 [AccessibilityNode.important()](/API/Accessibility/AccessibilityNode/README.md?id=important)
  方法获取节点的 important 值
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilityNode.important() 用于获取节点的 important 值
                            def message = node.important()
                            // SnackBarHostState.showSnackBar() 用于显示 SnackBar
                            snackBarHostState.showSnackBar("important:$message", null, "Short")
                        }
                    }
                }
            }
