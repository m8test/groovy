...
+ 启动一个Activity,
  并通过 [AccessibilityNode.depth()](/API/Accessibility/AccessibilityNode/README.md?id=depth)
  方法获取节点的 depth 值
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilityNode.depth() 用于获取节点的 depth 值
                            def message = node.depth()
                            // SnackBarHostState.showSnackBar() 用于显示 SnackBar
                            snackBarHostState.showSnackBar("depth:$message", null, "Short")
                        }
                    }
                }
            }
