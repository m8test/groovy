...
+ String - 节点的 className 值

示例代码:

+ 启动一个Activity,
  并通过 [AccessibilityNode.className()](/API/Accessibility/AccessibilityNode/README.md?id=className)
  方法获取节点的 className 值
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilityNode.className() 用于获取节点的 className 值
                            def message = node.className()
                            // SnackBarHostState.showSnackBar() 用于显示 SnackBar
                            snackBarHostState.showSnackBar("className:$message", null, "Short")
                        }
                    }
                }
            }
