...
+ boolean - 节点的 checkable 值

示例代码:

+ 启动一个Activity,
  并通过 [AccessibilityNode.checkable()](/API/Accessibility/AccessibilityNode/README.md?id=checkable)
  方法获取节点的 checkable 值
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilityNode.checkable() 用于获取节点的 checkable 值
                            def message = node.checkable()
                            // SnackBarHostState.showSnackBar() 用于显示 SnackBar
                            snackBarHostState.showSnackBar("checkable:$message", null, "Short")
                        }
                    }
                }
            }
