...
+ [AccessibilityNode](/API/Accessibility/AccessibilityNode/README.md) parent()
...
+ [AccessibilityNode](/API/Accessibility/AccessibilityNode/README.md) - 父节点,如果当前节点是根节点则返回null

示例代码:

+ 启动一个Activity,
  并通过 [AccessibilityNode.parent()](/API/Accessibility/AccessibilityNode/README.md?id=parent)
  方法获取父节点
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilityNode.parent() 用于获取父节点
                            ...
                            snackBarHostState.showSnackBar(parentNode.toString(), null, "Short")
                        }
                    }
                }
            }
