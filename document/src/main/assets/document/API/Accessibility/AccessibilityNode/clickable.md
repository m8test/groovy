...
+ boolean - 节点的 clickable 值

示例代码:

+ 启动一个Activity,
  并通过 [AccessibilityNode.clickable()](/API/Accessibility/AccessibilityNode/README.md?id=clickable)
  方法获取节点的 clickable 值
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilityNode.clickable() 用于获取节点的 clickable 值
                            def message = node.clickable()
                            // SnackBarHostState.showSnackBar() 用于显示 SnackBar
                            snackBarHostState.showSnackBar("clickable:$message", null, "Short")
                        }
                    }
                }
            }
