...
+ 启动一个Activity,
  并通过 [AccessibilityNode.scrollDown()](/API/Accessibility/AccessibilityNode/README.md?id=scrollDown)
  方法向下滚动节点内容
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilityNode.scrollDown() 用于向下滚动节点内容
                            $console.log(node.scrollDown())
                        }
                    }
                }
            }
