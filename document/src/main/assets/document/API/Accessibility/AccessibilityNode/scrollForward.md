...
+ 启动一个Activity,
  并通过 [AccessibilityNode.scrollForward()](/API/Accessibility/AccessibilityNode/README.md?id=scrollForward)
  方法向前滚动节点内容
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilityNode.scrollForward() 用于向前滚动节点内容
                            $console.log(node.scrollForward())
                        }
                    }
                }
            }
