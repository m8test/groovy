...
+ 启动一个Activity,
  并通过 [AccessibilityNode.index()](/API/Accessibility/AccessibilityNode/README.md?id=index)
  方法获取节点的 index 值
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilityNode.index() 用于获取节点的 index 值
                            def message = node.index()
                            // SnackBarHostState.showSnackBar() 用于显示 SnackBar
                            snackBarHostState.showSnackBar("index:$message", null, "Short")
                        }
                    }
                }
            }
