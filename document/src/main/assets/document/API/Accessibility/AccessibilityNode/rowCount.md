...
+ 启动一个Activity,
  并通过 [AccessibilityNode.rowCount()](/API/Accessibility/AccessibilityNode/README.md?id=rowCount)
  方法获取节点的 rowCount 值
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilityNode.rowCount() 用于获取节点的 rowCount 值
                            def message = node.rowCount()
                            // SnackBarHostState.showSnackBar() 用于显示 SnackBar
                            snackBarHostState.showSnackBar("rowCount:$message", null, "Short")
                        }
                    }
                }
            }
