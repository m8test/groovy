...
+ boolean - 节点的 focusable 值

示例代码:

+ 启动一个Activity,
  并通过 [AccessibilityNode.focusable()](/API/Accessibility/AccessibilityNode/README.md?id=focusable)
  方法获取节点的 focusable 值
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilityNode.focusable() 用于获取节点的 focusable 值
                            def message = node.focusable()
                            // SnackBarHostState.showSnackBar() 用于显示 SnackBar
                            snackBarHostState.showSnackBar("focusable:$message", null, "Short")
                        }
                    }
                }
            }
