...
+ int - 节点的 columnIndex 值

示例代码:

+ 启动一个Activity,
  并通过 [AccessibilityNode.columnIndex()](/API/Accessibility/AccessibilityNode/README.md?id=columnIndex)
  方法获取节点的 columnIndex 值
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilityNode.columnIndex() 用于获取节点的 columnIndex 值
                            def message = node.columnIndex()
                            // SnackBarHostState.showSnackBar() 用于显示 SnackBar
                            snackBarHostState.showSnackBar("columnIndex:$message", null, "Short")
                        }
                    }
                }
            }
