...
+ boolean - 节点的 selected 值

示例代码:

+ 启动一个Activity,
  并通过 [AccessibilityNode.selected()](/API/Accessibility/AccessibilityNode/README.md?id=selected)
  方法获取节点的 selected 值
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilityNode.selected() 用于获取节点的 selected 值
                            def message = node.selected()
                            // SnackBarHostState.showSnackBar() 用于显示 SnackBar
                            snackBarHostState.showSnackBar("selected:$message", null, "Short")
                        }
                    }
                }
            }
