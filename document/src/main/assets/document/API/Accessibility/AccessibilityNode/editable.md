...
+ boolean - 节点的 editable 值

示例代码:

+ 启动一个Activity,
  并通过 [AccessibilityNode.editable()](/API/Accessibility/AccessibilityNode/README.md?id=editable)
  方法获取节点的 editable 值
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilityNode.editable() 用于获取节点的 editable 值
                            def message = node.editable()
                            // SnackBarHostState.showSnackBar() 用于显示 SnackBar
                            snackBarHostState.showSnackBar("editable:$message", null, "Short")
                        }
                    }
                }
            }
