...
+ boolean - 节点的 multiLine 值

示例代码:

+ 启动一个Activity,
  并通过 [AccessibilityNode.multiLine()](/API/Accessibility/AccessibilityNode/README.md?id=multiLine)
  方法获取节点的 multiLine 值
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilityNode.multiLine() 用于获取节点的 multiLine 值
                            def message = node.multiLine()
                            // SnackBarHostState.showSnackBar() 用于显示 SnackBar
                            snackBarHostState.showSnackBar("multiLine:$message", null, "Short")
                        }
                    }
                }
            }
