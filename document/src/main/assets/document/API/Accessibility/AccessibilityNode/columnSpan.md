...
+ int - 节点的 columnSpan 值

示例代码:

+ 启动一个Activity,
  并通过 [AccessibilityNode.columnSpan()](/API/Accessibility/AccessibilityNode/README.md?id=columnSpan)
  方法获取节点的 columnSpan 值
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilityNode.columnSpan() 用于获取节点的 columnSpan 值
                            def message = node.columnSpan()
                            // SnackBarHostState.showSnackBar() 用于显示 SnackBar
                            snackBarHostState.showSnackBar("columnSpan:$message", null, "Short")
                        }
                    }
                }
            }
