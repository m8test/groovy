...
+ 启动一个Activity,
  并通过 [AccessibilityNode.rowIndex()](/API/Accessibility/AccessibilityNode/README.md?id=rowIndex)
  方法获取节点的 rowIndex 值
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilityNode.rowIndex() 用于获取节点的 rowIndex 值
                            def message = node.rowIndex()
                            // SnackBarHostState.showSnackBar() 用于显示 SnackBar
                            snackBarHostState.showSnackBar("rowIndex:$message", null, "Short")
                        }
                    }
                }
            }
