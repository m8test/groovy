...
+ boolean - 节点的 visible 值

示例代码:

+ 启动一个Activity,
  并通过 [AccessibilityNode.visible()](/API/Accessibility/AccessibilityNode/README.md?id=visible)
  方法获取节点的 visible 值
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilityNode.visible() 用于获取节点的 visible 值
                            def message = node.visible()
                            // SnackBarHostState.showSnackBar() 用于显示 SnackBar
                            snackBarHostState.showSnackBar("visible:$message", null, "Short")
                        }
                    }
                }
            }
