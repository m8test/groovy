...
+ 启动一个Activity, 并通过 [AccessibilityNode.id()](/API/Accessibility/AccessibilityNode/README.md?id=id)
  方法获取节点的 id 值
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilityNode.id() 用于获取节点的 id 值
                            def message = node.id()
                            // SnackBarHostState.showSnackBar() 用于显示 SnackBar
                            snackBarHostState.showSnackBar("id:$message", null, "Short")
                        }
                    }
                }
            }
