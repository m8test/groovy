...
+ boolean - 节点的 dismissable 值

示例代码:

+ 启动一个Activity,
  并通过 [AccessibilityNode.dismissable()](/API/Accessibility/AccessibilityNode/README.md?id=dismissable)
  方法获取节点的 dismissable 值
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilityNode.dismissable() 用于获取节点的 dismissable 值
                            def message = node.dismissable()
                            // SnackBarHostState.showSnackBar() 用于显示 SnackBar
                            snackBarHostState.showSnackBar("dismissable:$message", null, "Short")
                        }
                    }
                }
            }
