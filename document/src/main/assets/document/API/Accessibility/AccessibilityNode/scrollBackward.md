...
+ 启动一个Activity,
  并通过 [AccessibilityNode.scrollBackward()](/API/Accessibility/AccessibilityNode/README.md?id=scrollBackward)
  方法向后滚动节点内容
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilityNode.scrollBackward() 用于向后滚动节点内容
                            $console.log(node.scrollBackward())
                        }
                    }
                }
            }
