...
+ 启动一个Activity,
  并通过 [AccessibilityNode.text()](/API/Accessibility/AccessibilityNode/README.md?id=text)
  方法获取节点的 text 值
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilityNode.text() 用于获取节点的 text 值
                            def message = node.text()
                            // SnackBarHostState.showSnackBar() 用于显示 SnackBar
                            snackBarHostState.showSnackBar("text:$message", null, "Short")
                        }
                    }
                }
            }
