...
+ int - 节点的 childCount 值

示例代码:

+ 启动一个Activity,
  并通过 [AccessibilityNode.childCount()](/API/Accessibility/AccessibilityNode/README.md?id=childCount)
  方法获取节点的 childCount 值
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilityNode.childCount() 用于获取节点的 childCount 值
                            def message = node.childCount()
                            // SnackBarHostState.showSnackBar() 用于显示 SnackBar
                            snackBarHostState.showSnackBar("childCount:$message", null, "Short")
                        }
                    }
                }
            }
