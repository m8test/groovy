...
+ [AccessibilityNodes](/API/Accessibility/AccessibilityNodes/README.md) children()
...
+ [AccessibilityNodes](/API/Accessibility/AccessibilityNodes/README.md) - 节点下所有子节点

示例代码:

+ 启动一个Activity,
  并通过 [AccessibilityNode.children()](/API/Accessibility/AccessibilityNode/README.md?id=children)
  方法获取节点下所有子节点
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilityNode.children() 用于获取节点下所有子节点
                            def node = activeWindow.children()
