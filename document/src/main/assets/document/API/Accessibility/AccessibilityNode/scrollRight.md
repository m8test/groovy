...
+ 启动一个Activity,
  并通过 [AccessibilityNode.scrollRight()](/API/Accessibility/AccessibilityNode/README.md?id=scrollRight)
  方法向右滑动节点内容
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilityNode.scrollRight() 用于向右滑动节点内容
                            $console.log(node.scrollRight())
                        }
                    }
                }
            }
