...
+ int - 节点的 columnCount 值

示例代码:

+ 启动一个Activity,
  并通过 [AccessibilityNode.columnCount()](/API/Accessibility/AccessibilityNode/README.md?id=columnCount)
  方法获取节点的 columnCount 值
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilityNode.columnCount() 用于获取节点的 columnCount 值
                            def message = node.columnCount()
                            // SnackBarHostState.showSnackBar() 用于显示 SnackBar
                            snackBarHostState.showSnackBar("columnCount:$message", null, "Short")
                        }
                    }
                }
            }
