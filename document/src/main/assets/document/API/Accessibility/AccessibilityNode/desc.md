...
+ 启动一个Activity,
  并通过 [AccessibilityNode.desc()](/API/Accessibility/AccessibilityNode/README.md?id=desc)
  方法获取节点的 desc 值
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilityNode.desc() 用于获取节点的 desc 值
                            def message = node.desc()
                            // SnackBarHostState.showSnackBar() 用于显示 SnackBar
                            snackBarHostState.showSnackBar("desc:$message", null, "Short")
                        }
                    }
                }
            }
