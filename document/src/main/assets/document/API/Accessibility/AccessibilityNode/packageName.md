...
+ String - 节点的 packageName 值

示例代码:

+ 启动一个Activity,
  并通过 [AccessibilityNode.packageName()](/API/Accessibility/AccessibilityNode/README.md?id=packageName)
  方法获取节点的 packageName 值
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilityNode.packageName() 用于获取节点的 packageName 值
                            def message = node.packageName()
                            // SnackBarHostState.showSnackBar() 用于显示 SnackBar
                            snackBarHostState.showSnackBar("packageName:$message", null, "Short")
                        }
                    }
                }
            }
