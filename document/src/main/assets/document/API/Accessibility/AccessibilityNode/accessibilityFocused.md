...
+ boolean - 节点的 accessibilityFocused 值

示例代码:

+ 启动一个Activity,
  并通过 [AccessibilityNode.accessibilityFocused()](/API/Accessibility/AccessibilityNode/README.md?id=accessibilityFocused)
  方法获取节点的 accessibilityFocused 值
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilityNode.accessibilityFocused() 用于获取节点的 accessibilityFocused 值
                            def message = node.accessibilityFocused()
                            // SnackBarHostState.showSnackBar() 用于显示 SnackBar
                            snackBarHostState.showSnackBar("accessibilityFocused:$message", null, "Short")
                        }
                    }
                }
            }
