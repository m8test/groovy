...
+ boolean - 节点的 checked 值

示例代码:

+ 启动一个Activity,
  并通过 [AccessibilityNode.checked()](/API/Accessibility/AccessibilityNode/README.md?id=checked)
  方法获取节点的 checked 值
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilityNode.checked() 用于获取节点的 checked 值
                            def message = node.checked()
                            // SnackBarHostState.showSnackBar() 用于显示 SnackBar
                            snackBarHostState.showSnackBar("checked:$message", null, "Short")
                        }
                    }
                }
            }
