...
+ boolean - 节点的 focused 值

示例代码:

+ 启动一个Activity,
  并通过 [AccessibilityNode.focused()](/API/Accessibility/AccessibilityNode/README.md?id=focused)
  方法获取节点的 focused 值
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilityNode.focused() 用于获取节点的 focused 值
                            def message = node.focused()
                            // SnackBarHostState.showSnackBar() 用于显示 SnackBar
                            snackBarHostState.showSnackBar("focused:$message", null, "Short")
                        }
                    }
                }
            }
