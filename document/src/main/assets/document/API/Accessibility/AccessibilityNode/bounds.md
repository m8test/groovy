...
+ [Rect](/API/UI/Graphics/Rect/README.md) bounds()
...
+ [Rect](/API/UI/Graphics/Rect/README.md) - 节点的 bounds 值

示例代码:

+ 启动一个Activity,
  并通过 [AccessibilityNode.bounds()](/API/Accessibility/AccessibilityNode/README.md?id=bounds)
  方法获取节点的 bounds 值
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            snackBarHostState.showSnackBar("bounds:$message", null, "Short")
                        }
                    }
                }
            }
