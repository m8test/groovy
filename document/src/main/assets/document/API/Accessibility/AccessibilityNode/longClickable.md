...
+ boolean - 节点的 longClickable 值

示例代码:

+ 启动一个Activity,
  并通过 [AccessibilityNode.longClickable()](/API/Accessibility/AccessibilityNode/README.md?id=longClickable)
  方法获取节点的 longClickable 值
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilityNode.longClickable() 用于获取节点的 longClickable 值
                            def message = node.longClickable()
                            // SnackBarHostState.showSnackBar() 用于显示 SnackBar
                            snackBarHostState.showSnackBar("longClickable:$message", null, "Short")
                        }
                    }
                }
            }
