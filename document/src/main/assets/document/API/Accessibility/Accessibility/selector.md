...
+ [AccessibilitySelector](/API/Accessibility/AccessibilitySelector/README.md) selector()
...
+ [AccessibilitySelector](/API/Accessibility/AccessibilitySelector/README.md) - 新创建的无障碍节点选择器

示例代码:

+ 启动一个Activity,
  并通过 [Accessibility.selector()](/API/Accessibility/Accessibility/README.md?id=selector)
  方法创建无障碍节点选择器
