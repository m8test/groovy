...
+ boolean removeOnToastListener(int listenerId)
...
+ 启动一个Activity,
  并通过 [Accessibility.removeOnToastListener()](/API/Accessibility/Accessibility/README.md?id=removeOnToastListener)
  方法移除吐司监听器
    ...
    Scaffold {
        ...
        content {
            ...
            Button {
                ...
                onClick {
                    // Accessibility.removeOnToastListener() 用于移除吐司监听器
                    $console.log($accessibility.removeOnToastListener(result))
                }
            }
        }
    }
