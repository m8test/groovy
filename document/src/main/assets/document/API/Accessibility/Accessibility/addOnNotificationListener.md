...
+ boolean addOnNotificationListener(Closure closure)

参数:

+ Closure closure - 设置通知事件监听器的闭包,闭包将会在脚本主线程执行
    + 参数
        + [android.app.Notification](https://developer.android.google.cn/reference/android/app/Notification)
          notification - 安卓通知对象
    + delegate - 无
...
+ 启动一个Activity,
  并通过 [Accessibility.addOnNotificationListener()](/API/Accessibility/Accessibility/README.md?id=addOnNotificationListener)
  方法添加通知监听器
            ...
            TopAppBar {
                ...
                title {
                    ...
                    Text {
                        ...
                        text("addOnNotificationListener")
                    }
                }
