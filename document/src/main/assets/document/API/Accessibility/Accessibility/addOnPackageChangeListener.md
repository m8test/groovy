...
+ boolean addOnPackageChangeListener(Closure closure)

参数:

+ Closure closure - 设置监听器的闭包,闭包将会在脚本主线程执行
    + 参数
        + String packageName - 安卓应用包名
    + delegate - 无
...
+ 启动一个Activity,
  并通过 [Accessibility.addOnPackageChangeListener()](/API/Accessibility/Accessibility/README.md?id=addOnPackageChangeListener)
  方法添加应用包名改变监听器
            ...
            TopAppBar {
                ...
                title {
                    ...
                    Text {
                        ...
                        text("addOnPackageChangeListener")
                    }
                }
