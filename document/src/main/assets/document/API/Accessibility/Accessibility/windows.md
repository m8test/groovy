...
+ [AccessibilityNodes](/API/Accessibility/AccessibilityNodes/README.md) windows()
...
+ [AccessibilityNodes](/API/Accessibility/AccessibilityNodes/README.md) - 所有窗口

示例代码:

+ 启动一个Activity, 并通过 [Accessibility.windows()](/API/Accessibility/Accessibility/README.md?id=windows)
  方法获取所有窗口
