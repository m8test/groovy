...
+ [AccessibilityNode](/API/Accessibility/AccessibilityNode/README.md) activeWindow()
...
+ [AccessibilityNode](/API/Accessibility/AccessibilityNode/README.md) - 当前活动窗口

示例代码:

+ 启动一个Activity,
  并通过 [Accessibility.activeWindow()](/API/Accessibility/Accessibility/README.md?id=activeWindow)
  方法获取当前活动窗口
