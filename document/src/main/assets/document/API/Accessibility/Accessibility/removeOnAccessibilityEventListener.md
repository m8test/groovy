...
+ boolean removeOnAccessibilityEventListener(int listenerId)
...
+ 启动一个Activity,
  并通过 [Accessibility.removeOnAccessibilityEventListener()](/API/Accessibility/Accessibility/README.md?id=removeOnAccessibilityEventListener)
  方法移除无障碍事件监听器
    ...
    Scaffold {
            ...
            TopAppBar {
                ...
                title {
                    ...
                    Text {
                        ...
                        text("removeOnAccessibilityEventListener")
                    }
                }
        ...
        content {
            ...
            Button {
                ...
                onClick {
                    // Accessibility.removeOnAccessibilityEventListener() 用于移除无障碍事件监听器
                    $console.log($accessibility.removeOnAccessibilityEventListener(result))
                }
            }
        }
    }
