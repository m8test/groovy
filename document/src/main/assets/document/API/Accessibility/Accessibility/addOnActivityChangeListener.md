...
+ boolean addOnActivityChangeListener(Closure closure)

参数:

+ Closure closure - 设置监听器的闭包,闭包将会在脚本主线程执行
    + 参数
        + String activityName - 安卓Activity名
    + delegate - 无
...
+ 启动一个Activity,
  并通过 [Accessibility.addOnActivityChangeListener()](/API/Accessibility/Accessibility/README.md?id=addOnActivityChangeListener)
  方法添加Activity改变监听器
            ...
            TopAppBar {
                ...
                title {
                    ...
                    Text {
                        ...
                        text("addOnActivityChangeListener")
                    }
                }
