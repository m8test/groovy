...
+ [AccessibilitySelector](/API/Accessibility/AccessibilitySelector/README.md) checked(Closure
  closure)
...
+ 启动一个Activity,
  并通过 [AccessibilitySelector.checked()](/API/Accessibility/AccessibilitySelector/README.md?id=checked)
  方法设置节点 checked 过滤器
