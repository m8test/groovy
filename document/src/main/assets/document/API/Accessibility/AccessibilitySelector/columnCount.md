...
+ 设置节点 columnCount 过滤器

定义:

+ [AccessibilitySelector](/API/Accessibility/AccessibilitySelector/README.md) columnCount(Closure
  closure)
...
+ Closure closure - 设置过滤器的闭包
    + 参数
        + int columnCount - 节点 columnCount 值
    + delegate - 无
    + 返回值
...
+ 启动一个Activity,
  并通过 [AccessibilitySelector.columnCount()](/API/Accessibility/AccessibilitySelector/README.md?id=columnCount)
  方法设置节点 columnCount 过滤器
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilitySelector.columnCount() 用于设置节点 columnCount 过滤器
                            accessibilitySelector.columnCount { it == -1 }
