...
+ [AccessibilitySelector](/API/Accessibility/AccessibilitySelector/README.md) focused(Closure
  closure)
...
+ 启动一个Activity,
  并通过 [AccessibilitySelector.focused()](/API/Accessibility/AccessibilitySelector/README.md?id=focused)
  方法设置节点 focused 过滤器
