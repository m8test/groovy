...
+ [AccessibilitySelector](/API/Accessibility/AccessibilitySelector/README.md) text(Closure closure)

参数:

+ Closure closure - 设置过滤器的闭包
    + 参数
        + String text - 节点 text 值
    + delegate - 无
    + 返回值
...
+ 启动一个Activity,
  并通过 [AccessibilitySelector.text()](/API/Accessibility/AccessibilitySelector/README.md?id=text)
  方法设置节点文本过滤器
