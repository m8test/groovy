...
+ 设置节点 longClickable 过滤器

定义:

+ [AccessibilitySelector](/API/Accessibility/AccessibilitySelector/README.md) longClickable(Closure
  closure)
...
+ Closure closure - 设置过滤器的闭包
    + 参数
        + boolean longClickable - 节点 longClickable 值
    + delegate - 无
    + 返回值
...
+ 启动一个Activity,
  并通过 [AccessibilitySelector.longClickable()](/API/Accessibility/AccessibilitySelector/README.md?id=longClickable)
  方法设置节点 longClickable 过滤器
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilitySelector.longClickable() 用于设置节点 longClickable 过滤器
                            accessibilitySelector.longClickable { it }
