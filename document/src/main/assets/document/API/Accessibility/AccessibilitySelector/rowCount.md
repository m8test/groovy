...
+ [AccessibilitySelector](/API/Accessibility/AccessibilitySelector/README.md) rowCount(Closure
  closure)
...
+ 启动一个Activity,
  并通过 [AccessibilitySelector.rowCount()](/API/Accessibility/AccessibilitySelector/README.md?id=rowCount)
  方法设置节点 rowCount 过滤器
