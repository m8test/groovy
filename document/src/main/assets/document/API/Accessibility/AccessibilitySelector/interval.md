...
+ 设置节点查找间隔时间,也就是在查找节点的超时时间内如果找不到满足条件的节点需要等待多久后再次查找

定义:

+ [AccessibilitySelector](/API/Accessibility/AccessibilitySelector/README.md) interval(long millis)

参数:

+ long millis - 间隔时间,单位毫秒,默认50
...
+ 启动一个Activity,
  并通过 [AccessibilitySelector.interval()](/API/Accessibility/AccessibilitySelector/README.md?id=interval)
  方法设置节点查找间隔时间
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilitySelector.interval() 用于设置节点查找间隔时间
                            accessibilitySelector.interval(100)
