...
+ [AccessibilitySelector](/API/Accessibility/AccessibilitySelector/README.md) rowSpan(Closure
  closure)
...
+ 启动一个Activity,
  并通过 [AccessibilitySelector.rowSpan()](/API/Accessibility/AccessibilitySelector/README.md?id=rowSpan)
  方法设置节点 rowSpan 过滤器
