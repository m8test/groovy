...
+ [AccessibilitySelector](/API/Accessibility/AccessibilitySelector/README.md) id(Closure closure)
...
+ 启动一个Activity,
  并通过 [AccessibilitySelector.id()](/API/Accessibility/AccessibilitySelector/README.md?id=id)
  方法设置节点 id 过滤器
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilitySelector.id() 用于设置节点 id 过滤器
                            accessibilitySelector.id { it == null }
