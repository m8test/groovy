...
+ [AccessibilitySelector](/API/Accessibility/AccessibilitySelector/README.md) columnSpan(Closure
  closure)
...
+ Closure closure - 设置过滤器的闭包
    + 参数
        + int columnSpan - 节点 columnSpan 值
    + delegate - 无
    + 返回值
...
+ 启动一个Activity,
  并通过 [AccessibilitySelector.columnSpan()](/API/Accessibility/AccessibilitySelector/README.md?id=columnSpan)
  方法设置节点 columnSpan 过滤器
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilitySelector.columnSpan() 用于设置节点 columnSpan 过滤器
                            accessibilitySelector.columnSpan { it == -1 }
