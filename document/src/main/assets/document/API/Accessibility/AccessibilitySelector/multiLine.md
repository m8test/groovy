...
+ [AccessibilitySelector](/API/Accessibility/AccessibilitySelector/README.md) multiLine(Closure
  closure)
...
+ Closure closure - 设置过滤器的闭包
    + 参数
        + boolean multiLine - 节点 multiLine 值
    + delegate - 无
    + 返回值
...
+ 启动一个Activity,
  并通过 [AccessibilitySelector.multiLine()](/API/Accessibility/AccessibilitySelector/README.md?id=multiLine)
  方法设置节点 multiLine 过滤器
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilitySelector.multiLine() 用于设置节点 multiLine 过滤器
                            accessibilitySelector.multiLine { !it }
