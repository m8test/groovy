...
+ [AccessibilitySelector](/API/Accessibility/AccessibilitySelector/README.md) bounds(Closure
  closure)
...
+ Closure closure - 设置过滤器的闭包
    + 参数
        + [Rect](/API/UI/Graphics/Rect/README.md) bounds - 节点 bounds 值
    + delegate - 无
    + 返回值
...
+ 启动一个Activity,
  并通过 [AccessibilitySelector.bounds()](/API/Accessibility/AccessibilitySelector/README.md?id=bounds)
  方法设置节点 bounds 过滤器
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilitySelector.bounds() 用于设置节点 bounds 过滤器
                            accessibilitySelector.bounds {
                                // it -> Rect
                                it.left() == 0 && it.right() == 90 && it.top() == 250 && it.bottom() == 309
                            }
