...
+ [AccessibilitySelector](/API/Accessibility/AccessibilitySelector/README.md) childCount(Closure
  closure)
...
+ Closure closure - 设置过滤器的闭包
    + 参数
        + int childCount - 节点 childCount 值
    + delegate - 无
    + 返回值
...
+ 启动一个Activity,
  并通过 [AccessibilitySelector.childCount()](/API/Accessibility/AccessibilitySelector/README.md?id=childCount)
  方法设置节点 childCount 过滤器
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilitySelector.childCount() 用于设置节点 childCount 过滤器
                            accessibilitySelector.childCount { it == 0 }
