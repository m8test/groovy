...
+ 设置节点 dismissable 过滤器

定义:

+ [AccessibilitySelector](/API/Accessibility/AccessibilitySelector/README.md) dismissable(Closure
  closure)
...
+ Closure closure - 设置过滤器的闭包
    + 参数
        + boolean dismissable - 节点 dismissable 值
    + delegate - 无
    + 返回值
...
+ 启动一个Activity,
  并通过 [AccessibilitySelector.dismissable()](/API/Accessibility/AccessibilitySelector/README.md?id=dismissable)
  方法设置节点 dismissable 过滤器
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilitySelector.dismissable() 用于设置节点 dismissable 过滤器
                            accessibilitySelector.dismissable { !it }
