...
+ 设置节点 accessibilityFocused 过滤器

定义:

+ [AccessibilitySelector](/API/Accessibility/AccessibilitySelector/README.md) accessibilityFocused(
  Closure closure)
...
+ Closure closure - 设置过滤器的闭包
    + 参数
        + boolean accessibilityFocused - 节点 accessibilityFocused 值
    + delegate - 无
    + 返回值
...
+ 启动一个Activity,
  并通过 [AccessibilitySelector.accessibilityFocused()](/API/Accessibility/AccessibilitySelector/README.md?id=accessibilityFocused)
  方法设置节点 accessibilityFocused 过滤器
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilitySelector.accessibilityFocused() 用于设置节点 accessibilityFocused 过滤器
                            accessibilitySelector.accessibilityFocused { !it }
