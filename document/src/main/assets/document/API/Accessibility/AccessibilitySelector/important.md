...
+ [AccessibilitySelector](/API/Accessibility/AccessibilitySelector/README.md) important(Closure
  closure)
...
+ Closure closure - 设置过滤器的闭包
    + 参数
        + boolean important - 节点 important 值
    + delegate - 无
    + 返回值
...
+ 启动一个Activity,
  并通过 [AccessibilitySelector.important()](/API/Accessibility/AccessibilitySelector/README.md?id=important)
  方法设置节点 important 过滤器
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilitySelector.important() 用于设置节点 important 过滤器
                            accessibilitySelector.important { it }
