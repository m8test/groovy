...
+ [AccessibilitySelector](/API/Accessibility/AccessibilitySelector/README.md) enabled(Closure
  closure)
...
+ 启动一个Activity,
  并通过 [AccessibilitySelector.enabled()](/API/Accessibility/AccessibilitySelector/README.md?id=enabled)
  方法设置节点 enabled 过滤器
