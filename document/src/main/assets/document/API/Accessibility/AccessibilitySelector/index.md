...
+ [AccessibilitySelector](/API/Accessibility/AccessibilitySelector/README.md) index(Closure closure)

参数:

+ Closure closure - 设置过滤器的闭包
    + 参数
        + int index - 节点 index 值
    + delegate - 无
    + 返回值
...
+ 启动一个Activity,
  并通过 [AccessibilitySelector.index()](/API/Accessibility/AccessibilitySelector/README.md?id=index)
  方法设置节点 index 过滤器
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilitySelector.index() 用于设置节点 index 过滤器
                            accessibilitySelector.index { it == 1 }
