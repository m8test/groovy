...
+ [AccessibilitySelector](/API/Accessibility/AccessibilitySelector/README.md) editable(Closure
  closure)
...
+ 启动一个Activity,
  并通过 [AccessibilitySelector.editable()](/API/Accessibility/AccessibilitySelector/README.md?id=editable)
  方法设置节点 editable 过滤器
