...
+ [AccessibilitySelector](/API/Accessibility/AccessibilitySelector/README.md) depth(Closure closure)

参数:

+ Closure closure - 设置过滤器的闭包
    + 参数
        + int depth - 节点 depth 值
    + delegate - 无
    + 返回值
...
+ 启动一个Activity,
  并通过 [AccessibilitySelector.depth()](/API/Accessibility/AccessibilitySelector/README.md?id=depth)
  方法设置节点 depth 过滤器
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilitySelector.depth() 用于设置节点 depth 过滤器
                            accessibilitySelector.depth { it == 7 }
