...
+ [AccessibilitySelector](/API/Accessibility/AccessibilitySelector/README.md) visible(Closure
  closure)
...
+ 启动一个Activity,
  并通过 [AccessibilitySelector.visible()](/API/Accessibility/AccessibilitySelector/README.md?id=visible)
  方法设置节点 visible 过滤器
