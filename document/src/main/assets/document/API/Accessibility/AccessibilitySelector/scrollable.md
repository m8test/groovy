...
+ [AccessibilitySelector](/API/Accessibility/AccessibilitySelector/README.md) scrollable(Closure
  closure)
...
+ Closure closure - 设置过滤器的闭包
    + 参数
        + boolean scrollable - 节点 scrollable 值
    + delegate - 无
    + 返回值
...
+ 启动一个Activity,
  并通过 [AccessibilitySelector.scrollable()](/API/Accessibility/AccessibilitySelector/README.md?id=scrollable)
  方法设置节点 scrollable 过滤器
