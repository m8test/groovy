...
+ [AccessibilitySelector](/API/Accessibility/AccessibilitySelector/README.md) checkable(Closure
  closure)
...
+ Closure closure - 设置过滤器的闭包
    + 参数
        + boolean checkable - 节点 checkable 值
    + delegate - 无
    + 返回值
...
+ 启动一个Activity,
  并通过 [AccessibilitySelector.checkable()](/API/Accessibility/AccessibilitySelector/README.md?id=checkable)
  方法设置节点 checkable 过滤器
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilitySelector.checkable() 用于设置节点 checkable 过滤器
                            accessibilitySelector.checkable { it }
