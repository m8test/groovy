...
+ [AccessibilitySelector](/API/Accessibility/AccessibilitySelector/README.md) rowIndex(Closure
  closure)
...
+ 启动一个Activity,
  并通过 [AccessibilitySelector.rowIndex()](/API/Accessibility/AccessibilitySelector/README.md?id=rowIndex)
  方法设置节点 rowIndex 过滤器
