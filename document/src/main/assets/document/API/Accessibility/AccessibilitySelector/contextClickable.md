...
+ 设置节点 contextClickable 过滤器

定义:

+ [AccessibilitySelector](/API/Accessibility/AccessibilitySelector/README.md) contextClickable(
  Closure closure)
...
+ Closure closure - 设置过滤器的闭包
    + 参数
        + boolean contextClickable - 节点 contextClickable 值
    + delegate - 无
    + 返回值
...
+ 启动一个Activity,
  并通过 [AccessibilitySelector.contextClickable()](/API/Accessibility/AccessibilitySelector/README.md?id=contextClickable)
  方法设置节点 contextClickable 过滤器
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilitySelector.contextClickable() 用于设置节点 contextClickable 过滤器
                            accessibilitySelector.contextClickable { !it }
