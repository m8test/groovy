...
+ [AccessibilitySelector](/API/Accessibility/AccessibilitySelector/README.md) className(Closure
  closure)
...
+ Closure closure - 设置过滤器的闭包
    + 参数
        + String className - 节点 className 值
    + delegate - 无
    + 返回值
...
+ 启动一个Activity,
  并通过 [AccessibilitySelector.className()](/API/Accessibility/AccessibilitySelector/README.md?id=className)
  方法设置节点 className 过滤器
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilitySelector.className() 用于设置节点 className 过滤器
                            accessibilitySelector.className { it == "android.widget.TextView" }
