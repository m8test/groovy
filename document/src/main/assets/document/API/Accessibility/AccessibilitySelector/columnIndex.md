...
+ 设置节点 columnIndex 过滤器

定义:

+ [AccessibilitySelector](/API/Accessibility/AccessibilitySelector/README.md) columnIndex(Closure
  closure)
...
+ Closure closure - 设置过滤器的闭包
    + 参数
        + int columnIndex - 节点 columnIndex 值
    + delegate - 无
    + 返回值
...
+ 启动一个Activity,
  并通过 [AccessibilitySelector.columnIndex()](/API/Accessibility/AccessibilitySelector/README.md?id=columnIndex)
  方法设置节点 columnIndex 过滤器
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilitySelector.columnIndex() 用于设置节点 columnIndex 过滤器
                            accessibilitySelector.columnIndex { it == -1 }
