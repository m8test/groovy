...
+ [AccessibilitySelector](/API/Accessibility/AccessibilitySelector/README.md) clickable(Closure
  closure)
...
+ Closure closure - 设置过滤器的闭包
    + 参数
        + boolean clickable - 节点 clickable 值
    + delegate - 无
    + 返回值
...
+ 启动一个Activity,
  并通过 [AccessibilitySelector.clickable()](/API/Accessibility/AccessibilitySelector/README.md?id=clickable)
  方法设置节点 clickable 过滤器
