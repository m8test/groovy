...
+ 设置节点 packageName 过滤器

定义:

+ [AccessibilitySelector](/API/Accessibility/AccessibilitySelector/README.md) packageName(Closure
  closure)
...
+ Closure closure - 设置过滤器的闭包
    + 参数
        + String packageName - 节点 packageName 值
    + delegate - 无
    + 返回值
...
+ 启动一个Activity,
  并通过 [AccessibilitySelector.packageName()](/API/Accessibility/AccessibilitySelector/README.md?id=packageName)
  方法设置节点 packageName 过滤器
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilitySelector.packageName() 用于设置节点 packageName 过滤器
                            accessibilitySelector.packageName { it == "com.m8test.main" }
