...
+ [AccessibilitySelector](/API/Accessibility/AccessibilitySelector/README.md) focusable(Closure
  closure)
...
+ Closure closure - 设置过滤器的闭包
    + 参数
        + boolean focusable - 节点 focusable 值
    + delegate - 无
    + 返回值
...
+ 启动一个Activity,
  并通过 [AccessibilitySelector.focusable()](/API/Accessibility/AccessibilitySelector/README.md?id=focusable)
  方法设置节点 focusable 过滤器
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilitySelector.focusable() 用于设置节点 focusable 过滤器
                            accessibilitySelector.focusable { it }
                            // AccessibilitySelector.find() 用于查找所有满足无障碍节点选择器的节点
                            def nodes = accessibilitySelector.find(-1, 1000, activeWindow)
