...
+ 设置节点 drawingOrder 过滤器

定义:

+ [AccessibilitySelector](/API/Accessibility/AccessibilitySelector/README.md) drawingOrder(Closure
  closure)
...
+ Closure closure - 设置过滤器的闭包
    + 参数
        + int drawingOrder - 节点 drawingOrder 值
    + delegate - 无
    + 返回值
...
+ 启动一个Activity,
  并通过 [AccessibilitySelector.drawingOrder()](/API/Accessibility/AccessibilitySelector/README.md?id=drawingOrder)
  方法设置节点 drawingOrder 过滤器
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            // AccessibilitySelector.drawingOrder() 用于设置节点 drawingOrder 过滤器
                            accessibilitySelector.drawingOrder { it == 0 }
