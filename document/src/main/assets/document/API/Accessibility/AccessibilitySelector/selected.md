...
+ [AccessibilitySelector](/API/Accessibility/AccessibilitySelector/README.md) selected(Closure
  closure)
...
+ 启动一个Activity,
  并通过 [AccessibilitySelector.selected()](/API/Accessibility/AccessibilitySelector/README.md?id=selected)
  方法设置节点 selected 过滤器
