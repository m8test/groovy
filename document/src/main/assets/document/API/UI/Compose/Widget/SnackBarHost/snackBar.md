...
+ 设置 [SnackBar](/API/UI/Compose/Widget/SnackBar/README.md) 可组合项

定义:

+ [SnackBarHost](/API/UI/Compose/Widget/SnackBarHost/README.md) snackBar(Closure closure)

参数:

+ Closure closure - 设置 [SnackBar](/API/UI/Compose/Widget/SnackBar/README.md) 的闭包
    + 参数 - [SnackBarData](/API/UI/Compose/State/SnackBarHostState/SnackBarData/README.md)
    + delegate -
...
+ 启动一个Activity, 并通过 [SnackBarHost.snackBar()](/API/UI/Compose/Widget/SnackBarHost/README.md?id=snackBar)
  方法设置 [SnackBar](/API/UI/Compose/Widget/SnackBar/README.md) 可组合项
