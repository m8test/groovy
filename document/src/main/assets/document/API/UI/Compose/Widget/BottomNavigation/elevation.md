...
+ 设置 [BottomNavigation](/API/UI/Compose/Widget/BottomNavigation/README.md) 海拔

定义:

+ [BottomNavigation](/API/UI/Compose/Widget/BottomNavigation/README.md) elevation(Number value)
...
+ 启动一个Activity,
  并通过 [BottomNavigation.elevation()](/API/UI/Compose/Widget/BottomNavigation/README.md?id=elevation)
  方法设置 [BottomNavigation](/API/UI/Compose/Widget/BottomNavigation/README.md) 海拔
...
$composeActivity.createView {
    ...
    BottomNavigation {
        ...
        // BottomNavigation.elevation() 用于设置 BottomNavigation 海拔
        elevation(20)
