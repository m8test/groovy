...
+ 设置 [Slider](/API/UI/Compose/Widget/Slider/README.md) 活动部分中轨道的颜色，即拇指左边的颜色

定义:

+ [SliderColors](/API/UI/Compose/Theme/Color/SliderColors/README.md) activeTrackColor(Closure closure)
...
+ 启动一个Activity,
  并通过 [SliderColors.activeTrackColor()](/API/UI/Compose/Theme/Color/SliderColors/README.md?id=activeTrackColor)
  方法设置 [Slider](/API/UI/Compose/Widget/Slider/README.md) 活动部分中轨道的颜色
...
$composeActivity.createView {
    ...
    Slider {
        ...
        colors {
            ...
            // SliderColors.activeTrackColor() 用于设置 Slider 活动部分中轨道的颜色
            activeTrackColor {
                // delegate -> Color
                // Color.red() 用于配置红色通道
                red(255)
