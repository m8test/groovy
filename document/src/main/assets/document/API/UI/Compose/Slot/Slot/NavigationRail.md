...
+ 创建 [NavigationRail](/API/UI/Compose/Widget/NavigationRail/README.md) 可组合项

定义:

+ [Slot](/API/UI/Compose/Slot/Slot/README.md) NavigationRail(Closure closure)

参数:

+ Closure closure - 设置 [NavigationRail](/API/UI/Compose/Widget/NavigationRail/README.md) 的闭包
    + 参数 - 无
    + delegate - [NavigationRail](/API/UI/Compose/Widget/NavigationRail/README.md)
...
+ 启动一个Activity, 并通过 [Slot.NavigationRail()](/API/UI/Compose/Slot/Slot/README.md?id=NavigationRail)
  方法创建 [NavigationRail](/API/UI/Compose/Widget/NavigationRail/README.md) 可组合项
