...
+ Number - 矩形的右边缘相对于 x 轴的偏移量

示例代码:

+ 启动一个Activity, 并通过 [Rect.right()](/API/UI/Compose/Graphics/Rect/README.md?id=right) 方法获取矩形的右边缘相对于 x 轴的偏移量
    ...
    Popup {
        ...
        popupPositionProvider {
            ...
            x { anchorBounds, windowSize, layoutDirection, popupContentSize ->
                ...
                // Rect.right() 用于获取矩形的右边缘相对于 x 轴的偏移量。
                $console.log(anchorBounds.right())
