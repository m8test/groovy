...
+ [TabRow](/API/UI/Compose/Widget/TabRow/README.md) backgroundColor(Closure closure)
...
+ 启动一个Activity, 并通过 [TabRow.backgroundColor()](/API/UI/Compose/Widget/TabRow/README.md?id=backgroundColor)
  方法设置选项卡背景颜色
