...
+ [Modifier](/API/UI/Compose/Modifier/Modifier/README.md) width(Number width)
...
+ 启动一个Activity, 并通过 [Modifier.width()](/API/UI/Compose/Modifier/Modifier/README.md?id=width) 方法设置宽度
