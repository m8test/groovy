...
+ 设置 [SnackBar](/API/UI/Compose/Widget/SnackBar/README.md) 动作按钮颜色,
  可配合 [snackBarData()](/API/UI/Compose/Widget/SnackBar/README.md?id=snackBarData) 使用

定义:

+ [SnackBar](/API/UI/Compose/Widget/SnackBar/README.md) actionColor(Closure closure)
...
+ 启动一个Activity, 并通过 [SnackBar.actionColor()](/API/UI/Compose/Widget/SnackBar/README.md?id=actionColor)
  方法设置 [SnackBar](/API/UI/Compose/Widget/SnackBar/README.md) 动作按钮颜色
...
$composeActivity.createView {
    ...
    TextButton {
        ...
        onClick {
            ...
            snackBarHostState.showSnackBar("测试SnackBar", "红色按钮", "Short")
        }
    }
    // delegate -> Slot
    ...
    SnackBarHost {
        ...
        snackBar { data ->
            ...
            SnackBar {
                ...
                snackBarData(data)
                // SnackBar.actionColor() 用于设置 SnackBar 动作按钮颜色
                actionColor {
                    // delegate -> Color
                    // Color.red() 用于配置红色通道
                    red(255)
