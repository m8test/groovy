...
+ 设置 [Tab](/API/UI/Compose/Widget/Tab/README.md) 文本.

定义:

+ [Tab](/API/UI/Compose/Widget/Tab/README.md) text(Closure closure)
...
+ 启动一个Activity, 并通过 [Tab.text()](/API/UI/Compose/Widget/Tab/README.md?id=text)
  方法设置 [Tab](/API/UI/Compose/Widget/Tab/README.md) 文本.
