...
+ [ListItem](/API/UI/Compose/Widget/ListItem/README.md) text(Closure closure)
...
+ 启动一个Activity, 并通过 [ListItem.text()](/API/UI/Compose/Widget/ListItem/README.md?id=text) 方法设置列表项的主要文本
