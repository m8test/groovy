...
+ [Modifier](/API/UI/Compose/Modifier/Modifier/README.md) height(Number height)
...
+ 启动一个Activity, 并通过 [Modifier.height()](/API/UI/Compose/Modifier/Modifier/README.md?id=height) 方法设置高度
