...
+ [SideEffect](/API/UI/Compose/Effects/SideEffect/README.md) effect(Closure closure)
...
+ [SideEffect](/API/UI/Compose/Effects/SideEffect/README.md) - 返回对象本身方便链式调用

示例代码:

+ 启动一个Activity, 并通过 [SideEffect.effect()](/API/UI/Compose/Effects/SideEffect/README.md?id=effect) 方法设置效应
