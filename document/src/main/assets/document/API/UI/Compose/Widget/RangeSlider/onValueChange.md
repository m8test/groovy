...
+ 设置 [RangeSlider](/API/UI/Compose/Widget/RangeSlider/README.md) 值改变时的监听事件

定义:

+ [RangeSlider](/API/UI/Compose/Widget/RangeSlider/README.md) onValueChange(Closure closure)

参数:

+ Closure closure - 设置监听事件的闭包
    + 参数
        + [ClosedRange](/API/Ranges/ClosedRange/README.md) value - 改变后的值
    + delegate - 无
...
+ 启动一个Activity,
  并通过 [RangeSlider.onValueChange()](/API/UI/Compose/Widget/RangeSlider/README.md?id=onValueChange)
  方法设置 [RangeSlider](/API/UI/Compose/Widget/RangeSlider/README.md) 值改变时的监听事件
