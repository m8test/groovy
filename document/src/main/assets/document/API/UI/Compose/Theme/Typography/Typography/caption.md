...
+ [Typography](/API/UI/Compose/Theme/Typography/Typography/README.md) caption(Closure closure)
...
+ [TextStyle](/API/UI/Compose/Theme/Typography/TextStyle/README.md) caption()
...
+ [TextStyle](/API/UI/Compose/Theme/Typography/TextStyle/README.md) - caption 文字样式对象

示例代码:

+ 启动一个Activity, 并通过 [Typography.caption()](/API/UI/Compose/Theme/Typography/Typography/README.md?id=caption)
  方法设置/获取主题 caption 文字样式
...
$composeActivity.createView {
    ...
    MaterialTheme {
        ...
        typography {
            // delegate -> Typography
            // Typography.caption() 用于设置主题 caption 文字样式
            caption {
                // delegate -> TextStyle
            ...
            Button {
                ...
                content {
                    ...
                    Text {
                        ...
                        // Typography.caption() 用于获取主题 caption 文字样式
                        def captionTextStyle = currentTypography.caption()
                        // Text.style() 用于设置文字样式
                        style {
                            // delegate -> TextStyle
                            // TextStyle.from() 用于从指定 TextStyle 对象复制属性
                            from(captionTextStyle)
                        }
