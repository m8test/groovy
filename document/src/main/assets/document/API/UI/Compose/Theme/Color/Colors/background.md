...
+ [Colors](/API/UI/Compose/Theme/Color/Colors/README.md) background(Closure closure)
...
+ [Color](/API/UI/Compose/Theme/Color/Color/README.md) background()
...
+ [Color](/API/UI/Compose/Theme/Color/Color/README.md) - background 颜色对象

示例代码:

+ 启动一个Activity, 并通过 [Colors.background()](/API/UI/Compose/Theme/Color/Colors/README.md?id=background) 方法设置/获取
  background 颜色.
