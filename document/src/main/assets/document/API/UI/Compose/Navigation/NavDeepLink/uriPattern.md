...
+ [NavDeepLink](/API/UI/Compose/Navigation/NavDeepLink/README.md) uriPattern(String uriPattern)

参数:

+ String uriPattern - 需要设置的uri模式
...
+ 启动一个Activity,
  并通过 [NavDeepLink.uriPattern()](/API/UI/Compose/Navigation/NavDeepLink/README.md?id=uriPattern)
  方法设置深层链接的uri模式
