...
+ [Typography](/API/UI/Compose/Theme/Typography/Typography/README.md) copy()
...
+ [Typography](/API/UI/Compose/Theme/Typography/Typography/README.md) -
  新复制的 [Typography](/API/UI/Compose/Theme/Typography/Typography/README.md) 对象

示例代码:

+ 启动一个Activity, 并通过 [Typography.copy()](/API/UI/Compose/Theme/Typography/Typography/README.md?id=copy)
  方法复制排版.
