...
+ [ExposedDropdownMenuBox](/API/UI/Compose/Widget/ExposedDropdownMenuBox/README.md) expanded(boolean value)

参数:

+ boolean value - true表示展开盒子,false表示收起盒子
...
+ 启动一个Activity,
  并通过 [ExposedDropdownMenuBox.expanded()](/API/UI/Compose/Widget/ExposedDropdownMenuBox/README.md?id=expanded)
  方法设置下拉菜单盒子是否展开
