...
+ [DropdownMenu](/API/UI/Compose/Widget/DropdownMenu/README.md) onDismissRequest(Closure closure)
...
+ 启动一个Activity,
  并通过 [DropdownMenu.onDismissRequest()](/API/UI/Compose/Widget/DropdownMenu/README.md?id=onDismissRequest)
  方法设置下拉菜单取消时监听事件.
