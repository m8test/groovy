...
+ [Colors](/API/UI/Compose/Theme/Color/Colors/README.md) onError(Closure closure)
...
+ [Color](/API/UI/Compose/Theme/Color/Color/README.md) onError()
...
+ [Color](/API/UI/Compose/Theme/Color/Color/README.md) - onError 颜色对象

示例代码:

+ 启动一个Activity, 并通过 [Colors.onError()](/API/UI/Compose/Theme/Color/Colors/README.md?id=onError) 方法设置/获取 onError
  颜色.
...
$composeActivity.createView {
    ...
    MaterialTheme {
        ...
        colors {
            // delegate -> Colors
            // Colors.onError() 用于设置 onError 颜色
            onError {
                // delegate -> Color
                // Color.red() 用于配置红色通道
                red(255)
        ...
        content {
            ...
            Text {
                ...
                // Colors.onError() 用于获取 onError 颜色
                def onErrorColor = currentColors.onError()
                // Text.style() 用于配置文本样式
                style {
                    // delegate -> TextStyle
