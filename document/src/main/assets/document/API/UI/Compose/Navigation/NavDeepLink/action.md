...
+ [NavDeepLink](/API/UI/Compose/Navigation/NavDeepLink/README.md) action(String action)
...
+ 启动一个Activity, 并通过 [NavDeepLink.action()](/API/UI/Compose/Navigation/NavDeepLink/README.md?id=action)
  方法设置深层链接的动作
