...
+ [SnackBarData](/API/UI/Compose/State/SnackBarHostState/SnackBarData/README.md) dismiss()
...
+ 启动一个Activity,
  并通过 [SnackBarData.dismiss()](/API/UI/Compose/State/SnackBarHostState/SnackBarData/README.md?id=dismiss)
