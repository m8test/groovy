...
+ [NavGraph](/API/UI/Compose/Navigation/NavGraph/README.md) route(String route)
...
+ 启动一个Activity, 并通过 [NavGraph.route()](/API/UI/Compose/Navigation/NavGraph/README.md?id=route) 方法设置导航路线
