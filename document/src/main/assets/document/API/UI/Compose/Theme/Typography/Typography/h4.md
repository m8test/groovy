...
+ [Typography](/API/UI/Compose/Theme/Typography/Typography/README.md) h4(Closure closure)
...
+ [TextStyle](/API/UI/Compose/Theme/Typography/TextStyle/README.md) h4()
...
+ [TextStyle](/API/UI/Compose/Theme/Typography/TextStyle/README.md) - h4 文字样式对象

示例代码:

+ 启动一个Activity, 并通过 [Typography.h4()](/API/UI/Compose/Theme/Typography/Typography/README.md?id=h4) 方法设置/获取主题
  h4 文字样式
