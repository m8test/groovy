...
+ 创建 [LaunchedEffect](/API/UI/Compose/Effects/LaunchedEffect/README.md)

定义:

+ [Slot](/API/UI/Compose/Slot/Slot/README.md) LaunchedEffect(Closure closure)

参数:

+ Closure closure - 设置 [LaunchedEffect](/API/UI/Compose/Effects/LaunchedEffect/README.md) 的闭包
    + 参数 - 无
    + delegate - [LaunchedEffect](/API/UI/Compose/Effects/LaunchedEffect/README.md)
...
+ 启动一个Activity, 并通过 [Slot.LaunchedEffect()](/API/UI/Compose/Slot/Slot/README.md?id=LaunchedEffect)
  方法创建 [LaunchedEffect](/API/UI/Compose/Effects/LaunchedEffect/README.md)
