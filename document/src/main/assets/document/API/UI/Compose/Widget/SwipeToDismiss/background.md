...
+ 设置 [SwipeToDismiss](/API/UI/Compose/Widget/SwipeToDismiss/README.md) 背景.

定义:

+ [SwipeToDismiss](/API/UI/Compose/Widget/SwipeToDismiss/README.md) background(Closure closure)

参数:

+ Closure closure - 设置背景的闭包
    + 参数 - 无
    + delegate -
...
+ 启动一个Activity,
  并通过 [SwipeToDismiss.background()](/API/UI/Compose/Widget/SwipeToDismiss/README.md?id=background)
  方法设置 [SwipeToDismiss](/API/UI/Compose/Widget/SwipeToDismiss/README.md) 背景.
