...
+ [PopUpTo](/API/UI/Compose/Navigation/PopUpTo/README.md) inclusive(boolean inclusive)

参数:

+ boolean inclusive - true表示目的地从返回栈弹出,false表示目的地不会从返回栈弹出

返回值:

+ [PopUpTo](/API/UI/Compose/Navigation/PopUpTo/README.md) - 返回对象本身方便链式调用

示例代码:

+ 启动一个Activity, 并通过 [PopUpTo.inclusive()](/API/UI/Compose/Navigation/PopUpTo/README.md?id=inclusive)
  方法设置目的地是否应该从返回堆栈中弹出
