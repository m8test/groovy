...
+ boolean - true表示抽屉为打开状态,false表示抽屉为非打开状态

示例代码:

+ 启动一个Activity,
  并通过 [BottomDrawerState.isOpen()](/API/UI/Compose/State/BottomDrawerState/README.md?id=isOpen)
  方法判断抽屉是否打开
    ...
    BottomDrawer {
        ...
        drawerContent {
            ...
            TextButton {
                ...
                onClick {
                    // BottomDrawerState.isOpen() 用于判断抽屉是否打开
                    $assert.assertTrue(state.isOpen(), "抽屉为打开状态")
