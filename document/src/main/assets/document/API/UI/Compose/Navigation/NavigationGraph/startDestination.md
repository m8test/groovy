...
+ [NavigationGraph](/API/UI/Compose/Navigation/NavigationGraph/README.md) startDestination(String
  destination)
...
+ [NavigationGraph](/API/UI/Compose/Navigation/NavigationGraph/README.md) - 返回对象本身方便链式调用

示例代码:

+ 启动一个Activity,
  并通过 [NavigationGraph.startDestination()](/API/UI/Compose/Navigation/NavigationGraph/README.md?id=startDestination)
  方法设置起始目的地的路线
