...
+ [Colors](/API/UI/Compose/Theme/Color/Colors/README.md) isLight(boolean isLight)

参数:

+ boolean isLight - true表示为亮色,false表示为暗色
...
+ 启动一个Activity, 并通过 [Colors.isLight()](/API/UI/Compose/Theme/Color/Colors/README.md?id=isLight) 方法设置颜色是否为亮色.
