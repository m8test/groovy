...
+ 设置 [Slider](/API/UI/Compose/Widget/Slider/README.md) 值改变时的监听事件

定义:

+ [Slider](/API/UI/Compose/Widget/Slider/README.md) onValueChange(Closure closure)
...
+ 启动一个Activity, 并通过 [Slider.onValueChange()](/API/UI/Compose/Widget/Slider/README.md?id=onValueChange)
  方法设置 [Slider](/API/UI/Compose/Widget/Slider/README.md) 值改变时的监听事件
