...
+ [BackdropScaffoldState](/API/UI/Compose/State/BackdropScaffoldState/README.md) snackBarHostState(
...
+ [BackdropScaffoldState](/API/UI/Compose/State/BackdropScaffoldState/README.md) - 返回对象本身方便链式调用
...
+ 启动一个Activity,
  并通过 [BackdropScaffoldState.snackBarHostState()](/API/UI/Compose/State/BackdropScaffoldState/README.md?id=snackBarHostState)
