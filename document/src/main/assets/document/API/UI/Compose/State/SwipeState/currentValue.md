...
+ String -
  当前状态值,参考 [MaterialState.initialValue()](/API/UI/Compose/State/MaterialState/README.md?id=initialValue)

示例代码:

+ 启动一个Activity, 并通过 [SwipeState.currentValue()](/API/UI/Compose/State/SwipeState/README.md?id=currentValue)
  方法获取状态的当前值
  ...
  TextButton {
    ...
    content {
      ...
      Text {
        ...
        style {
          // delegate -> TextStyle
          // BackdropScaffoldState.currentValue() 用于获取状态的当前值
          if (state.currentValue() == "Concealed") {
