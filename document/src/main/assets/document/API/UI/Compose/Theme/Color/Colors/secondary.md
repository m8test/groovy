...
+ [Colors](/API/UI/Compose/Theme/Color/Colors/README.md) secondary(Closure closure)
...
+ [Color](/API/UI/Compose/Theme/Color/Color/README.md) secondary()
...
+ [Color](/API/UI/Compose/Theme/Color/Color/README.md) - secondary 颜色对象

示例代码:

+ 启动一个Activity, 并通过 [Colors.secondary()](/API/UI/Compose/Theme/Color/Colors/README.md?id=secondary) 方法设置/获取
  secondary 颜色.
...
$composeActivity.createView {
    ...
    MaterialTheme {
        ...
        colors {
            // delegate -> Colors
            // Colors.secondary() 用于设置 secondary 颜色
            secondary {
                // delegate -> Color
                // Color.red() 用于配置红色通道
                red(255)
        ...
        content {
            ...
            Text {
                ...
                // Colors.secondary() 用于获取 secondary 颜色
                def secondaryColor = currentColors.secondary()
                // Text.style() 用于配置文本样式
                style {
                    // delegate -> TextStyle
