...
+ [ExposedDropdownMenuBox](/API/UI/Compose/Widget/ExposedDropdownMenuBox/README.md) onExpandedChange(Closure
  closure)
...
+ 启动一个Activity,
  并通过 [ExposedDropdownMenuBox.onExpandedChange()](/API/UI/Compose/Widget/ExposedDropdownMenuBox/README.md?id=onExpandedChange)
  方法设置下拉菜单盒子展开状态改变监听器.
