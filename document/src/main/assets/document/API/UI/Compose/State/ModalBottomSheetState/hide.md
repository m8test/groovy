...
+ 隐藏 [ModalBottomSheetLayout](/API/UI/Compose/Widget/ModalBottomSheetLayout/README.md) 底页

定义:

+ [Job](/API/Coroutines/Job/README.md) hide()
...
+ 启动一个Activity,
  并通过 [ModalBottomSheetState.hide()](/API/UI/Compose/State/ModalBottomSheetState/README.md?id=hide)
  方法隐藏 [ModalBottomSheetLayout](/API/UI/Compose/Widget/ModalBottomSheetLayout/README.md) 底页
