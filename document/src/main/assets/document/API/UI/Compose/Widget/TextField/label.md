...
+ [TextField](/API/UI/Compose/Widget/TextField/README.md) label(Closure closure)
...
+ 启动一个Activity, 并通过 [TextField.label()](/API/UI/Compose/Widget/TextField/README.md?id=label) 方法设置输入框标签.
