...
+ [AlertDialog](/API/UI/Compose/Widget/AlertDialog/README.md) onDismissRequest(Closure closure)
...
+ 启动一个Activity显示警告对话框,
  并通过 [AlertDialog.onDismissRequest()](/API/UI/Compose/Widget/AlertDialog/README.md?id=onDismissRequest)
  方法监听警告对话框取消.
