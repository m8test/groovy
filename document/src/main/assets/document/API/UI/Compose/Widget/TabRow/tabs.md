...
+ [TabRow](/API/UI/Compose/Widget/TabRow/README.md) tabs(Closure closure)
...
+ 启动一个Activity, 并通过 [TabRow.tabs()](/API/UI/Compose/Widget/TabRow/README.md?id=tabs) 方法设置选项卡内容
