...
+ [Modifier](/API/UI/Compose/Modifier/Modifier/README.md) alpha(float alpha)

参数:

+ float alpha - 需要设置的透明度,取值范围[0.0,1.0]
...
+ 启动一个Activity, 并通过 [Modifier.alpha()](/API/UI/Compose/Modifier/Modifier/README.md?id=alpha) 方法设置透明度
