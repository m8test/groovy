...
+ 设置 [Tab](/API/UI/Compose/Widget/Tab/README.md) 点击事件

定义:

+ [Tab](/API/UI/Compose/Widget/Tab/README.md) onClick(Closure closure)
...
+ 启动一个Activity, 并通过 [Tab.onClick()](/API/UI/Compose/Widget/Tab/README.md?id=onClick)
  方法设置 [Tab](/API/UI/Compose/Widget/Tab/README.md) 点击事件
