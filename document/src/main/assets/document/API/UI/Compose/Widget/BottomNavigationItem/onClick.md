...
+ 设置 [BottomNavigationItem](/API/UI/Compose/Widget/BottomNavigationItem/README.md) 点击事件

定义:

+ [BottomNavigationItem](/API/UI/Compose/Widget/BottomNavigationItem/README.md) onClick(Closure closure)

参数:

+ Closure closure - 设置 [BottomNavigationItem](/API/UI/Compose/Widget/BottomNavigationItem/README.md) 点击事件的闭包
    + 参数 - 无
    + delegate - 无
...
+ 启动一个Activity,
  并通过 [BottomNavigationItem.onClick()](/API/UI/Compose/Widget/BottomNavigationItem/README.md?id=onClick)
  方法设置 [BottomNavigationItem](/API/UI/Compose/Widget/BottomNavigationItem/README.md) 点击事件
