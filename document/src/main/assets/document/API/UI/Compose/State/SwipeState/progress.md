...
+ [SwipeProgress](/API/UI/Compose/State/SwipeState/SwipeProgress/README.md) progress()
...
+ 启动一个Activity,
  并通过 [SwipeState.progress()](/API/UI/Compose/State/SwipeState/README.md?id=progress)
  方法获取有关正在进行的滑动或动画的信息(如果有)
