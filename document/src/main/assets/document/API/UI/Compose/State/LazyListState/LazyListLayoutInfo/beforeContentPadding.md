...
+ 获取在滚动方向的第一项之前应用的以像素为单位的内容填充。例如，它是 [LazyColumn](/API/UI/Compose/Widget/LazyColumn/README.md)
  的顶部内容填充，[LazyList.reverseLayout()](/API/UI/Compose/Widget/LazyList/README.md?id=reverseLayout) 设置为 false。
...
+ 启动一个Activity,
  并通过 [LazyListLayoutInfo.beforeContentPadding()](/API/UI/Compose/State/LazyListState/LazyListLayoutInfo/README.md?id=beforeContentPadding)
  方法获取在滚动方向的第一项之前应用的以像素为单位的内容填充
            ...
            Button {
                ...
                content {
                    ...
                    Text {
                        ...
                        text("beforeContentPadding:" + mutableState.value())
                    }
                }
                ...
                onClick {
                    ...
                    // LazyListLayoutInfo.beforeContentPadding() 用于获取在滚动方向的第一项之前应用的以像素为单位的内容填充
                    def count = layoutInfo.beforeContentPadding()
