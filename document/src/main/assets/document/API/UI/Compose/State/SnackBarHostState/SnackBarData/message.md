...
+ String - 当前显示在 [SnackBar](/API/UI/Compose/Widget/SnackBar/README.md) 上的消息

示例代码:

+ 启动一个Activity,
  并通过 [SnackBarData.message()](/API/UI/Compose/State/SnackBarHostState/SnackBarData/README.md?id=message)
  方法获取 [SnackBar](/API/UI/Compose/Widget/SnackBar/README.md) 消息
