...
+ Number - 矩形的中心相对于 y 轴的偏移量

示例代码:

+ 启动一个Activity, 并通过 [Rect.centerY()](/API/UI/Compose/Graphics/Rect/README.md?id=centerY) 方法获取矩形的中心相对于 y
  轴的偏移量
    ...
    Popup {
        ...
        popupPositionProvider {
            ...
            x { anchorBounds, windowSize, layoutDirection, popupContentSize ->
                ...
                // Rect.centerY() 用于获取矩形的中心相对于 y 轴的偏移量。
                $console.log(anchorBounds.centerY())
