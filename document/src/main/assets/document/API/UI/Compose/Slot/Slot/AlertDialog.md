...
+ [Slot](/API/UI/Compose/Slot/Slot/README.md) AlertDialog(Closure closure)

参数:

+ Closure closure - 设置警告对话框的闭包
    + 参数 - 无
    + delegate - [AlertDialog](/API/UI/Compose/Widget/AlertDialog/README.md)
...
+ 启动一个Activity显示警告对话框, 并通过 [Slot.AlertDialog()](/API/UI/Compose/Slot/Slot/README.md?id=AlertDialog)
  方法设置警告对话框
