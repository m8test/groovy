...
+ [Typography](/API/UI/Compose/Theme/Typography/Typography/README.md) h1(Closure closure)
...
+ [TextStyle](/API/UI/Compose/Theme/Typography/TextStyle/README.md) h1()
...
+ [TextStyle](/API/UI/Compose/Theme/Typography/TextStyle/README.md) - h1 文字样式对象

示例代码:

+ 启动一个Activity, 并通过 [Typography.h1()](/API/UI/Compose/Theme/Typography/Typography/README.md?id=h1) 方法设置/获取主题
  h1 文字样式
