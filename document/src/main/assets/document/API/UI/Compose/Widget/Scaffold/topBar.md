...
+ [Scaffold](/API/UI/Compose/Widget/Scaffold/README.md) topBar(Closure closure)
...
+ 启动一个Activity, 并通过 [Scaffold.topBar()](/API/UI/Compose/Widget/Scaffold/README.md?id=topBar) 方法设置顶部应用程序栏
