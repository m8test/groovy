...
+ [DropdownMenu](/API/UI/Compose/Widget/DropdownMenu/README.md) expanded(boolean expanded)

参数:

+ boolean expanded - true表示展开下拉菜单,false表示收起下拉菜单
...
+ 启动一个Activity, 并通过 [DropdownMenu.expanded()](/API/UI/Compose/Widget/DropdownMenu/README.md?id=expanded)
  方法设置下拉菜单是否展开.
