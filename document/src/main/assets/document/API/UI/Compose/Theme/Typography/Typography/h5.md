...
+ [Typography](/API/UI/Compose/Theme/Typography/Typography/README.md) h5(Closure closure)
...
+ [TextStyle](/API/UI/Compose/Theme/Typography/TextStyle/README.md) h5()
...
+ [TextStyle](/API/UI/Compose/Theme/Typography/TextStyle/README.md) - h5 文字样式对象

示例代码:

+ 启动一个Activity, 并通过 [Typography.h5()](/API/UI/Compose/Theme/Typography/Typography/README.md?id=h5) 方法设置/获取主题
  h5 文字样式
