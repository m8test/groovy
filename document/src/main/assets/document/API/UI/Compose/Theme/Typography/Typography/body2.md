...
+ [Typography](/API/UI/Compose/Theme/Typography/Typography/README.md) body2(Closure closure)
...
+ [TextStyle](/API/UI/Compose/Theme/Typography/TextStyle/README.md) body2()
...
+ [TextStyle](/API/UI/Compose/Theme/Typography/TextStyle/README.md) - body2 文字样式对象

示例代码:

+ 启动一个Activity, 并通过 [Typography.body2()](/API/UI/Compose/Theme/Typography/Typography/README.md?id=body2)
  方法设置/获取主题 body2 文字样式
...
$composeActivity.createView {
    ...
    MaterialTheme {
        ...
        typography {
            // delegate -> Typography
            // Typography.body2() 用于设置主题 body2 文字样式
            body2 {
                // delegate -> TextStyle
            ...
            Button {
                ...
                content {
                    ...
                    Text {
                        ...
                        // Typography.body2() 用于获取主题 body2 文字样式
                        def body2TextStyle = currentTypography.body2()
                        // Text.style() 用于设置文字样式
                        style {
                            // delegate -> TextStyle
