...
+ [NavGraph](/API/UI/Compose/Navigation/NavGraph/README.md) deepLinks(Closure... closures)

参数:

+ Closure... closures - 构建深层链接的0个或者多个闭包
    + 参数 - 无
    + delegate - [NavDeepLink](/API/UI/Compose/Navigation/NavDeepLink/README.md)
...
+ 启动一个Activity, 并通过 [NavGraph.deepLinks()](/API/UI/Compose/Navigation/NavGraph/README.md?id=deepLinks)
  方法设置深层链接
