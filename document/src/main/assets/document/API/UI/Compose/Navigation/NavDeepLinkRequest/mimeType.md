...
+ [NavDeepLinkRequest](/API/UI/Compose/Navigation/NavDeepLinkRequest/README.md) mimeType(String mimeType)
...
+ 启动一个Activity,
  并通过 [NavDeepLinkRequest.mimeType()](/API/UI/Compose/Navigation/NavDeepLinkRequest/README.md?id=mimeType)
  方法深层链接请求 MimeType
