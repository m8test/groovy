...
+ Number - 矩形的左边缘相对于 x 轴的偏移量

示例代码:

+ 启动一个Activity, 并通过 [Rect.left()](/API/UI/Compose/Graphics/Rect/README.md?id=left) 方法获取矩形的左边缘相对于 x 轴的偏移量
    ...
    Popup {
        ...
        popupPositionProvider {
            ...
            x { anchorBounds, windowSize, layoutDirection, popupContentSize ->
                ...
                // Rect.left() 用于获取矩形的左边缘相对于 x 轴的偏移量。
                $console.log(anchorBounds.left())
