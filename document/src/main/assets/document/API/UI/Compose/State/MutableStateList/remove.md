...
+ 删除 [MutableStateList](/API/UI/Compose/State/MutableStateList/README.md) 中指定的项目
...
+ 启动一个Activity, 并通过 [MutableStateList.remove()](/API/UI/Compose/State/MutableStateList/README.md?id=remove)
  方法删除 [MutableStateList](/API/UI/Compose/State/MutableStateList/README.md) 中指定的项目
