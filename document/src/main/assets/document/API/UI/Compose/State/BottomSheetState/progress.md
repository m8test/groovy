...
+ 启动一个Activity,
  并通过 [BottomSheetState.progress()](/API/UI/Compose/State/BottomSheetState/README.md?id=progress)
  方法获取当前进度
            ...
            TextButton {
                ...
                content {
                    ...
                    Text {
                        ...
                        withAggregatedStates((bState): ["progress"])
                        // Text.style() 用于配置文本样式
                        style {
                            // delegate -> TextStyle
                            // BottomSheetState.progress() 用于获取当前进度
                            if (bState.progress() >= 0.5f) {
