...
+ 设置 [Badge](/API/UI/Compose/Widget/Badge/README.md) .

定义:

+ [BadgedBox](/API/UI/Compose/Widget/BadgedBox/README.md) badge(Closure closure)
...
+ 启动一个Activity, 并通过 [BadgedBox.badge()](/API/UI/Compose/Widget/BadgedBox/README.md?id=badge) 方法设置 [Badge](/API/UI/Compose/Widget/Badge/README.md) .
