...
+ 设置 [BottomNavigation](/API/UI/Compose/Widget/BottomNavigation/README.md) 背景颜色

定义:

+ [BottomNavigation](/API/UI/Compose/Widget/BottomNavigation/README.md) backgroundColor(Closure closure)

参数:

+ Closure closure - 设置 [BottomNavigation](/API/UI/Compose/Widget/BottomNavigation/README.md) 背景颜色的闭包
    + 参数 - 无
...
+ 启动一个Activity,
  并通过 [BottomNavigation.backgroundColor()](/API/UI/Compose/Widget/BottomNavigation/README.md?id=backgroundColor)
  方法设置 [BottomNavigation](/API/UI/Compose/Widget/BottomNavigation/README.md) 背景颜色
...
$composeActivity.createView {
    ...
    BottomNavigation {
        ...
        // BottomNavigation.backgroundColor() 用于设置 BottomNavigation 背景颜色
        backgroundColor {
            // delegate -> Color
            // Color.blue() 用于配置蓝色通道
            blue(255)
