...
+ 设置 [Switch](/API/UI/Compose/Widget/Switch/README.md) 选中时拇指的颜色.

定义:

+ [SwitchColors](/API/UI/Compose/Theme/Color/SwitchColors/README.md) checkedThumbColor(Closure closure)
...
+ 启动一个Activity,
  并通过 [SwitchColors.checkedThumbColor()](/API/UI/Compose/Theme/Color/SwitchColors/README.md?id=checkedThumbColor)
  方法设置 [Switch](/API/UI/Compose/Widget/Switch/README.md) 选中时拇指的颜色.
