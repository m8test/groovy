...
+ Number - 矩形的上边缘相对于 y 轴的偏移量

示例代码:

+ 启动一个Activity, 并通过 [Rect.bottom()](/API/UI/Compose/Graphics/Rect/README.md?id=bottom) 方法获取矩形的上边缘相对于 y 轴的偏移量
    ...
    Popup {
        ...
        popupPositionProvider {
            ...
            x { anchorBounds, windowSize, layoutDirection, popupContentSize ->
                ...
                // Rect.bottom() 用于获取矩形的上边缘相对于 y 轴的偏移量。
                $console.log(anchorBounds.bottom())
