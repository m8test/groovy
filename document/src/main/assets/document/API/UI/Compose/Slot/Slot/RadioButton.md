...
+ 创建 [RadioButton](/API/UI/Compose/Widget/RadioButton/README.md) 可组合项

定义:

+ [Slot](/API/UI/Compose/Slot/Slot/README.md) RadioButton(Closure closure)

参数:

+ Closure closure - 设置 [RadioButton](/API/UI/Compose/Widget/RadioButton/README.md) 的闭包
    + 参数 - 无
    + delegate - [RadioButton](/API/UI/Compose/Widget/RadioButton/README.md)
...
+ 启动一个Activity, 并通过 [Slot.RadioButton()](/API/UI/Compose/Slot/Slot/README.md?id=RadioButton)
  方法创建 [RadioButton](/API/UI/Compose/Widget/RadioButton/README.md) 可组合项
