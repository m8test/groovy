...
+ [NavController](/API/UI/Compose/Navigation/NavController/README.md) navigate(String route, Closure
  closure)

参数1:

+ String route - 目标路线
+ Closure closure - 构建导航操作的特殊选项的闭包
    + 参数 - 无
    + delegate - [NavOptions](/API/UI/Compose/Navigation/NavOptions/README.md)

返回值1:

+ [NavController](/API/UI/Compose/Navigation/NavController/README.md) - 返回对象本身方便链式调用

定义2:

+ [NavController](/API/UI/Compose/Navigation/NavController/README.md) navigate(Closure navDeepLinkRequest,
  Closure navOptions)

参数2:

+ Closure navDeepLinkRequest - 构建深层链接请求的闭包
    + 参数 - 无
    + delegate - [NavDeepLinkRequest](/API/UI/Compose/Navigation/NavDeepLinkRequest/README.md)
+ Closure navOptions - 构建导航操作的特殊选项的闭包
    + 参数 - 无
    + delegate - [NavOptions](/API/UI/Compose/Navigation/NavOptions/README.md)
...
+ 启动一个Activity,
  并通过 [NavController.navigate()](/API/UI/Compose/Navigation/NavController/README.md?id=navigate)
  方法导航到指定的路线
