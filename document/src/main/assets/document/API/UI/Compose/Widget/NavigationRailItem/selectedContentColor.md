...
+ 设置 [NavigationRailItem](/API/UI/Compose/Widget/NavigationRailItem/README.md) 被选中时的颜色.

定义:

+ [NavigationRailItem](/API/UI/Compose/Widget/NavigationRailItem/README.md) selectedContentColor(Closure
  closure)
...
+ 启动一个Activity,
  并通过 [NavigationRailItem.selectedContentColor()](/API/UI/Compose/Widget/NavigationRailItem/README.md?id=selectedContentColor)
