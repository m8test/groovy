...
+ 取消 [SwipeToDismiss](/API/UI/Compose/Widget/SwipeToDismiss/README.md)

定义:

+ [Job](/API/Coroutines/Job/README.md) dismiss(String direction)
...
+ 启动一个Activity, 并通过 [DismissState.dismiss()](/API/UI/Compose/State/DismissState/README.md?id=dismiss)
  方法取消 [SwipeToDismiss](/API/UI/Compose/Widget/SwipeToDismiss/README.md)
