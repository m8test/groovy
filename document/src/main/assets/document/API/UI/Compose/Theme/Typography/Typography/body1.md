...
+ [Typography](/API/UI/Compose/Theme/Typography/Typography/README.md) body1(Closure closure)
...
+ [TextStyle](/API/UI/Compose/Theme/Typography/TextStyle/README.md) body1()
...
+ [TextStyle](/API/UI/Compose/Theme/Typography/TextStyle/README.md) - body1 文字样式对象

示例代码:

+ 启动一个Activity, 并通过 [Typography.body1()](/API/UI/Compose/Theme/Typography/Typography/README.md?id=body1)
  方法设置/获取主题 body1 文字样式
...
$composeActivity.createView {
    ...
    MaterialTheme {
        ...
        typography {
            // delegate -> Typography
            // Typography.body1() 用于设置主题 body1 文字样式
            body1 {
                // delegate -> TextStyle
            ...
            Button {
                ...
                content {
                    ...
                    Text {
                        ...
                        // Typography.body1() 用于获取主题 body1 文字样式
