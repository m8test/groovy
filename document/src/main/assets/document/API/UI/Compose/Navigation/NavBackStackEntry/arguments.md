...
+ [Bundle](https://developer.android.google.cn/reference/android/os/Bundle) arguments()
...
+ [Bundle](https://developer.android.google.cn/reference/android/os/Bundle) -
  安卓 [Bundle](https://developer.android.google.cn/reference/android/os/Bundle) 对象

示例代码:

+ 启动一个Activity,
  并通过 [NavBackStackEntry.arguments()](/API/UI/Compose/Navigation/NavBackStackEntry/README.md?id=arguments)
  方法获取导航参数
