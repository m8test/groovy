...
+ [Colors](/API/UI/Compose/Theme/Color/Colors/README.md) error(Closure closure)
...
+ [Color](/API/UI/Compose/Theme/Color/Color/README.md) error()
...
+ [Color](/API/UI/Compose/Theme/Color/Color/README.md) - error 颜色对象

示例代码:

+ 启动一个Activity, 并通过 [Colors.error()](/API/UI/Compose/Theme/Color/Colors/README.md?id=error) 方法设置/获取 error 颜色.
    ...
    MaterialTheme {
        ...
        content {
            ...
            Text {
                ...
                // Colors.error() 用于获取 error 颜色
                def errorColor = currentColors.error()
                // Text.style() 用于配置文本样式
                style {
                    // delegate -> TextStyle
