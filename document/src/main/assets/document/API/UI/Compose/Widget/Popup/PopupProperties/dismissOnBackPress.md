...
+ 设置下拉菜单是否允许按下返回键触发 onDismissRequest.

定义:

+ [PopupProperties](/API/UI/Compose/Widget/Popup/PopupProperties/README.md) dismissOnBackPress(
  boolean value)
...
+ 启动一个Activity,
  并通过 [PopupProperties.dismissOnBackPress()](/API/UI/Compose/Widget/Popup/PopupProperties/README.md?id=dismissOnBackPress)
  方法设置下拉菜单是否允许按下返回键触发 onDismissRequest.
...
$composeActivity.createView {
    ...
    DropdownMenu {
        ...
        popupProperties {
            ...
            // PopupProperties.dismissOnBackPress() 用于设置下拉菜单是否允许按下返回键触发 onDismissRequest
