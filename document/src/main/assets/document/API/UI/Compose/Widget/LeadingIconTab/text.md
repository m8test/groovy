...
+ 设置 [LeadingIconTab](/API/UI/Compose/Widget/LeadingIconTab/README.md) 文本.

定义:

+ [LeadingIconTab](/API/UI/Compose/Widget/LeadingIconTab/README.md) text(Closure closure)
...
+ 启动一个Activity, 并通过 [LeadingIconTab.text()](/API/UI/Compose/Widget/LeadingIconTab/README.md?id=text)
  方法设置 [LeadingIconTab](/API/UI/Compose/Widget/LeadingIconTab/README.md) 文本.
