...
+ [TopAppBar](/API/UI/Compose/Widget/TopAppBar/README.md) title(Closure closure)
...
+ 启动一个Activity, 并通过 [TopAppBar.title()](/API/UI/Compose/Widget/TopAppBar/README.md?id=title) 方法设置应用程序栏标题
