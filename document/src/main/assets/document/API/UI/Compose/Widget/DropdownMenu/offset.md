...
+ [DropdownMenu](/API/UI/Compose/Widget/DropdownMenu/README.md) offset(Closure closure)
...
+ 启动一个Activity, 并通过 [DropdownMenu.offset()](/API/UI/Compose/Widget/DropdownMenu/README.md?id=offset)
  方法设置下拉菜单偏移量.
...
$composeActivity.createView {
    ...
    DropdownMenu {
        ...
        // DropdownMenu.offset() 用于设置下拉菜单偏移量
        offset {
            // delegate -> Offset
            // Offset.x() 用于设置横坐标偏移量
            x(20)
