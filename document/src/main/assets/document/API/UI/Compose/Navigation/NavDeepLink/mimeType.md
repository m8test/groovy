...
+ [NavDeepLink](/API/UI/Compose/Navigation/NavDeepLink/README.md) mimeType(String mimeType)

参数:

+ String mimeType - 需要设置的 MimeType

返回值:

+ [NavDeepLink](/API/UI/Compose/Navigation/NavDeepLink/README.md) - 返回对象本身方便链式调用

示例代码:

+ 启动一个Activity, 并通过 [NavDeepLink.mimeType()](/API/UI/Compose/Navigation/NavDeepLink/README.md?id=mimeType)
  方法设置深层链接的 MimeType
...
def MyDetailComposable = { navHostController ->
    ...
    composable {
        ...
        deepLinks({
            ...
            // NavDeepLink.mimeType() 用于设置深层链接的 MimeType
                    ...
                    Button {
                        ...
                        onClick {
                            ...
                            navHostController.navigate({
                                ...
                                // NavDeepLinkRequest.mimeType() 用于设置深层链接请求 MimeType
                                mimeType(allMimeType)
                            }) {
                                // delegate -> NavOptions
                            }
