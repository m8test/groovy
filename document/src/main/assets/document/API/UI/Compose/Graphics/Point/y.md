...
+ [Point](/API/UI/Compose/Graphics/Point/README.md) y(int y)
...
+ [Point](/API/UI/Compose/Graphics/Point/README.md) - 返回对象本身方便链式调用
...
+ 启动一个Activity, 并通过 [Point.y()](/API/UI/Compose/Graphics/Point/README.md?id=y) 方法设置/获取纵坐标
