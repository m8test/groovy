...
+ [ExposedDropdownMenu](/API/UI/Compose/Widget/ExposedDropdownMenu/README.md) onDismissRequest(Closure
  closure)
...
+ 启动一个Activity,
  并通过 [ExposedDropdownMenu.onDismissRequest()](/API/UI/Compose/Widget/ExposedDropdownMenu/README.md?id=onDismissRequest)
  方法设置下拉菜单取消时监听事件.
