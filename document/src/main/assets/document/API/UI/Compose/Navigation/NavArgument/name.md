...
+ [NavArgument](/API/UI/Compose/Navigation/NavArgument/README.md) name(String name)
...
+ 启动一个Activity, 并通过 [NavArgument.name()](/API/UI/Compose/Navigation/NavArgument/README.md?id=name) 方法设置参数名
