...
+ [DialogGraph](/API/UI/Compose/Navigation/DialogGraph/README.md) dialogProperties(Closure closure)
...
+ [DialogGraph](/API/UI/Compose/Navigation/DialogGraph/README.md) - 返回对象本身方便链式调用

示例代码:

+ 启动一个Activity,
  并通过 [DialogGraph.dialogProperties()](/API/UI/Compose/Navigation/DialogGraph/README.md?id=dialogProperties)
  方法设置对话框属性
