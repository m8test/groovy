...
+ [NavigationGraph](/API/UI/Compose/Navigation/NavigationGraph/README.md) builder(Closure closure)
...
+ 启动一个Activity,
  并通过 [NavigationGraph.builder()](/API/UI/Compose/Navigation/NavigationGraph/README.md?id=builder)
  方法构建导航图
