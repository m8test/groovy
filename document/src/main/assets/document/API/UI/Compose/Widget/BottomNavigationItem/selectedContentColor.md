...
+ 设置 [BottomNavigationItem](/API/UI/Compose/Widget/BottomNavigationItem/README.md) 被选中时的颜色

定义:

+ [BottomNavigationItem](/API/UI/Compose/Widget/BottomNavigationItem/README.md) selectedContentColor(Closure
  closure)
...
+ 启动一个Activity,
  并通过 [BottomNavigationItem.selectedContentColor()](/API/UI/Compose/Widget/BottomNavigationItem/README.md?id=selectedContentColor)
  方法设置 [BottomNavigationItem](/API/UI/Compose/Widget/BottomNavigationItem/README.md) 被选中时的颜色
