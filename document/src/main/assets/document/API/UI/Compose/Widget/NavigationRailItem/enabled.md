...
+ 设置 [NavigationRailItem](/API/UI/Compose/Widget/NavigationRailItem/README.md) 是否启用.

定义:

+ [NavigationRailItem](/API/UI/Compose/Widget/NavigationRailItem/README.md) enabled(boolean value)
...
+ 启动一个Activity,
  并通过 [NavigationRailItem.enabled()](/API/UI/Compose/Widget/NavigationRailItem/README.md?id=enabled)
  方法设置 [NavigationRailItem](/API/UI/Compose/Widget/NavigationRailItem/README.md) 是否启用.

```groovy
def MyNavigationRailItem = { state, index, iconName, labelName, isEnabled ->
    // delegate -> Slot
    ...
    NavigationRailItem {
        ...
        // NavigationRailItem.enabled() 用于设置 NavigationRailItem 是否启用
        enabled(isEnabled)
...
$composeActivity.createView {
    ...
    NavigationRail {
        ...
        content {
            ...
            MyNavigationRailItem(state, 0, "Home", "主页", true)
            MyNavigationRailItem(state, 1, "Settings", "设置", true)
            MyNavigationRailItem(state, 2, "Favorite", "喜欢", false)
        }
    }
}
