...
+ 获取从 [TabRow](/API/UI/Compose/Widget/TabRow/README.md) 开始的左边缘的 x 位置
...
+ int - 从 [TabRow](/API/UI/Compose/Widget/TabRow/README.md) 开始的左边缘的 x 位置

示例代码:

+ 启动一个Activity, 并通过 [TabPosition.left()](/API/UI/Compose/Widget/TabRow/TabPosition/README.md?id=left)
  方法获取从 [TabRow](/API/UI/Compose/Widget/TabRow/README.md) 开始的左边缘的 x 位置
        ...
        indicator { tabPositions ->
            ...
            Divider {
                ...
                modifier {
                    ...
                    // TabPosition.left() 用于获取从 TabRow 开始的左边缘的 x 位置
                    $console.log("左:" + tabPosition.left())
