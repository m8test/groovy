...
+ 创建 [BottomNavigation](/API/UI/Compose/Widget/BottomNavigation/README.md) 可组合项

定义:

+ [Slot](/API/UI/Compose/Slot/Slot/README.md) BottomNavigation(Closure closure)

参数:

+ Closure closure - 设置 [BottomNavigation](/API/UI/Compose/Widget/BottomNavigation/README.md) 的闭包
    + 参数 - 无
    + delegate - [BottomNavigation](/API/UI/Compose/Widget/BottomNavigation/README.md)
...
+ 启动一个Activity, 并通过 [Slot.BottomNavigation()](/API/UI/Compose/Slot/Slot/README.md?id=BottomNavigation)
  方法创建 [BottomNavigation](/API/UI/Compose/Widget/BottomNavigation/README.md) 可组合项
