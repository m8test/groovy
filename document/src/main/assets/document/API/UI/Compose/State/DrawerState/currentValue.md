...
+ 启动一个Activity,
  并通过 [DrawerState.currentValue()](/API/UI/Compose/State/DrawerState/README.md?id=currentValue) 方法获取状态的当前值
...
$composeActivity.createView {
    ...
    ModalDrawer {
        ...
        scrimColor {
            // delegate -> Color
            // DrawerState.currentValue() 用于获取状态的当前值
            def currentDrawerValue = state.currentValue()
            if (currentDrawerValue == "Closed") {
