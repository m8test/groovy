...
+ [Colors](/API/UI/Compose/Theme/Color/Colors/README.md) copy()
...
+ [Colors](/API/UI/Compose/Theme/Color/Colors/README.md) -
  新复制的 [Colors](/API/UI/Compose/Theme/Color/Colors/README.md) 对象

示例代码:

+ 启动一个Activity, 并通过 [Colors.copy()](/API/UI/Compose/Theme/Color/Colors/README.md?id=copy) 方法复制颜色.
