...
+ [Modifier](/API/UI/Compose/Modifier/Modifier/README.md) background(Closure color, Closure shape)
...
+ 启动一个Activity, 并通过 [Modifier.background()](/API/UI/Compose/Modifier/Modifier/README.md?id=background)
  方法设置背景颜色
