...
+ [ModalBottomSheetLayout](/API/UI/Compose/Widget/ModalBottomSheetLayout/README.md) scrimColor(Closure
  closure)
...
+ 启动一个Activity,
  并通过 [ModalBottomSheetLayout.scrimColor()](/API/UI/Compose/Widget/ModalBottomSheetLayout/README.md?id=scrimColor)
  方法设置底页显示时非底页部分颜色
...
$composeActivity.createView {
    ...
    ModalBottomSheetLayout {
        ...
        // ModalBottomSheetLayout.scrimColor() 用于设置底页显示时非底页部分颜色
        scrimColor {
            // delegate -> Color
            // Color.red() 用于配置红色通道
            red(255)
