...
+ [BackdropScaffold](/API/UI/Compose/Widget/BackdropScaffold/README.md) persistentAppBar(boolean value)
...
+ 启动一个Activity,
  并通过 [BackdropScaffold.persistentAppBar()](/API/UI/Compose/Widget/BackdropScaffold/README.md?id=persistentAppBar)
  方法设置当显示底层时是否应显示应用程序栏.
