...
+ [Modifier](/API/UI/Compose/Modifier/Modifier/README.md)
  tabIndicatorOffset([TabPosition](/API/UI/Compose/Widget/TabRow/TabPosition/README.md) tabPosition)

参数:

+ [TabPosition](/API/UI/Compose/Widget/TabRow/TabPosition/README.md) tabPosition - 选项卡位置
...
+ 启动一个Activity,
  并通过 [Modifier.tabIndicatorOffset()](/API/UI/Compose/Modifier/Modifier/README.md?id=tabIndicatorOffset)
  方法设置选显卡偏移量
