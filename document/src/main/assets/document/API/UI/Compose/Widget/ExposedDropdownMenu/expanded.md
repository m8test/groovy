...
+ [ExposedDropdownMenu](/API/UI/Compose/Widget/ExposedDropdownMenu/README.md) expanded(boolean value)

参数:

+ boolean value - true表示展开,false表示收起

返回值:

+ [ExposedDropdownMenu](/API/UI/Compose/Widget/ExposedDropdownMenu/README.md) - 返回对象本身方便链式调用

示例代码:

+ 启动一个Activity,
  并通过 [ExposedDropdownMenu.expanded()](/API/UI/Compose/Widget/ExposedDropdownMenu/README.md?id=expanded)
  方法设置下拉菜单是否展开
