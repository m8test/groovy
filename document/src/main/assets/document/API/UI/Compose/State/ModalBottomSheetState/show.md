...
+ 显示 [ModalBottomSheetState](/API/UI/Compose/State/ModalBottomSheetState/README.md) 底页

定义:

+ [Job](/API/Coroutines/Job/README.md) show()
...
+ 启动一个Activity,
  并通过 [ModalBottomSheetState.show()](/API/UI/Compose/State/ModalBottomSheetState/README.md?id=show)
  方法显示 [ModalBottomSheetState](/API/UI/Compose/State/ModalBottomSheetState/README.md) 底页
