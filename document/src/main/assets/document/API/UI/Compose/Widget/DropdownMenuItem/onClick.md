...
+ [DropdownMenuItem](/API/UI/Compose/Widget/DropdownMenuItem/README.md) onClick(Closure closure)
...
+ 启动一个Activity,
  并通过 [DropdownMenuItem.onClick()](/API/UI/Compose/Widget/DropdownMenuItem/README.md?id=onClick)
  方法设置下拉菜单项点击事件.
