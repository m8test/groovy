...
+ 启动一个Activity,
  并通过 [BottomDrawerState.offset()](/API/UI/Compose/State/BottomDrawerState/README.md?id=offset)
  方法获取抽屉偏移量
                ...
                content {
                    ...
                    Text {
                        ...
                        style {
                            ...
                            // BottomDrawerState.offset() 用于获取抽屉偏移量
                            def offsetValue = state.offset()
                            if (offsetValue >= currentHeight - 100) {
