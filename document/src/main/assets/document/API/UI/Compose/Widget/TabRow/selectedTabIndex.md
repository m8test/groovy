...
+ [TabRow](/API/UI/Compose/Widget/TabRow/README.md) selectedTabIndex(int index)
...
+ 启动一个Activity, 并通过 [TabRow.selectedTabIndex()](/API/UI/Compose/Widget/TabRow/README.md?id=selectedTabIndex)
  方法设置当前被选择的选项卡索引
