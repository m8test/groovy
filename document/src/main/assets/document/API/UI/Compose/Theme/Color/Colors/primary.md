...
+ [Colors](/API/UI/Compose/Theme/Color/Colors/README.md) primary(Closure closure)
...
+ [Color](/API/UI/Compose/Theme/Color/Color/README.md) primary()
...
+ [Color](/API/UI/Compose/Theme/Color/Color/README.md) - primary 颜色对象

示例代码:

+ 启动一个Activity, 并通过 [Colors.primary()](/API/UI/Compose/Theme/Color/Colors/README.md?id=primary) 方法设置/获取 primary
  颜色.
