...
+ Object -
  [ProvidableCompositionLocal.provides()](/API/UI/Compose/CompositionLocal/ProvidableCompositionLocal/README.md?id=provides)
...
+ 启动一个Activity,
  并通过 [ProvidedValue.value()](/API/UI/Compose/CompositionLocal/ProvidedValue/README.md?id=value)
  方法获取提供的值
