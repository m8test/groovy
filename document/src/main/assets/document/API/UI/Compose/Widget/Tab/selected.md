...
+ 设置 [Tab](/API/UI/Compose/Widget/Tab/README.md) 是否选中.

定义:

+ [Tab](/API/UI/Compose/Widget/Tab/README.md) selected(boolean value)
...
+ 启动一个Activity, 并通过 [Tab.selected()](/API/UI/Compose/Widget/Tab/README.md?id=selected)
  方法设置 [Tab](/API/UI/Compose/Widget/Tab/README.md) 是否选中.
