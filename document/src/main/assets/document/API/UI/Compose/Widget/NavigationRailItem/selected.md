...
+ 设置 [NavigationRailItem](/API/UI/Compose/Widget/NavigationRailItem/README.md) 是否被选中.

定义:

+ [NavigationRailItem](/API/UI/Compose/Widget/NavigationRailItem/README.md) selected(boolean value)
...
+ 启动一个Activity,
  并通过 [NavigationRailItem.selected()](/API/UI/Compose/Widget/NavigationRailItem/README.md?id=selected)
  方法设置 [NavigationRailItem](/API/UI/Compose/Widget/NavigationRailItem/README.md) 是否被选中.
