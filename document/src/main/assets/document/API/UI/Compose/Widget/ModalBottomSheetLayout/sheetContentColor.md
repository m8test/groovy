...
+ [ModalBottomSheetLayout](/API/UI/Compose/Widget/ModalBottomSheetLayout/README.md) sheetContentColor(
  Closure closure)
...
+ 启动一个Activity,
  并通过 [ModalBottomSheetLayout.sheetContentColor()](/API/UI/Compose/Widget/ModalBottomSheetLayout/README.md?id=sheetContentColor)
  方法设置底页内容颜色
...
$composeActivity.createView {
    ...
    ModalBottomSheetLayout {
        ...
        // ModalBottomSheetLayout.sheetContentColor() 用于设置底页内容颜色
        sheetContentColor {
            // delegate -> Color
            // Color.red() 用于配置红色通道
            red(255)
