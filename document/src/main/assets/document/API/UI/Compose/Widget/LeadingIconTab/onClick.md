...
+ 设置 [LeadingIconTab](/API/UI/Compose/Widget/LeadingIconTab/README.md) 点击事件

定义:

+ [LeadingIconTab](/API/UI/Compose/Widget/LeadingIconTab/README.md) onClick(Closure closure)
...
+ 启动一个Activity, 并通过 [LeadingIconTab.onClick()](/API/UI/Compose/Widget/LeadingIconTab/README.md?id=onClick)
  方法设置 [LeadingIconTab](/API/UI/Compose/Widget/LeadingIconTab/README.md) 点击事件
