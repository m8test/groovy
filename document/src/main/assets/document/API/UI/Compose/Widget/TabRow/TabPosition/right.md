...
+ 获取从 [TabRow](/API/UI/Compose/Widget/TabRow/README.md) 开始的右边缘的 x 位置
...
+ int - 从 [TabRow](/API/UI/Compose/Widget/TabRow/README.md) 开始的右边缘的 x 位置

示例代码:

+ 启动一个Activity, 并通过 [TabPosition.right()](/API/UI/Compose/Widget/TabRow/TabPosition/README.md?id=right)
  方法获取从 [TabRow](/API/UI/Compose/Widget/TabRow/README.md) 开始的右边缘的 x 位置
        ...
        indicator { tabPositions ->
            ...
            Divider {
                ...
                modifier {
                    ...
                    // TabPosition.right() 用于获取从 TabRow 开始的右边缘的 x 位置
                    $console.log("右:" + tabPosition.right())
