...
+ [AlertDialog](/API/UI/Compose/Widget/AlertDialog/README.md) contentColor(Closure closure)
...
+ 启动一个Activity显示警告对话框,
  并通过 [AlertDialog.contentColor()](/API/UI/Compose/Widget/AlertDialog/README.md?id=contentColor)
  方法设置警告对话框内容颜色.
...
def MyAlertDialog = { state ->
    ...
    AlertDialog {
        ...
        show(state.value())
        // AlertDialog.contentColor() 用于设置警告对话框内容颜色
        contentColor {
            // delegate -> Color
            // Color.red() 用于配置红色通道
            red(255)
