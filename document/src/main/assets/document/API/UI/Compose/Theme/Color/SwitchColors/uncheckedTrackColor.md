...
+ 设置 [Switch](/API/UI/Compose/Widget/Switch/README.md) 未选中时轨道的颜色.

定义:

+ [SwitchColors](/API/UI/Compose/Theme/Color/SwitchColors/README.md) uncheckedTrackColor(Closure closure)
...
+ 启动一个Activity,
  并通过 [SwitchColors.uncheckedTrackColor()](/API/UI/Compose/Theme/Color/SwitchColors/README.md?id=uncheckedTrackColor)
  方法设置 [Switch](/API/UI/Compose/Widget/Switch/README.md) 未选中时轨道的颜色.
