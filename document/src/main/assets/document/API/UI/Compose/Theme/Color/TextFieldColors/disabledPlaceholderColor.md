...
+ [TextFieldColors](/API/UI/Compose/Theme/Color/TextFieldColors/README.md) disabledPlaceholderColor(Closure
  closure)
...
+ 启动一个Activity,
  并通过 [TextFieldColors.disabledPlaceholderColor()](/API/UI/Compose/Theme/Color/TextFieldColors/README.md?id=disabledPlaceholderColor)
  方法设置输入框禁用时占位符颜色.
