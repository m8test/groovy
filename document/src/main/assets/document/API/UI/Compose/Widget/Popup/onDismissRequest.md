...
+ [Popup](/API/UI/Compose/Widget/Popup/README.md) onDismissRequest(Closure closure)
...
+ 启动一个Activity, 并通过 [Popup.onDismissRequest()](/API/UI/Compose/Widget/Popup/README.md?id=onDismissRequest)
  方法设置弹出窗口取消时监听事件.
