...
+ Number - 矩形的底边距 y 轴的偏移量

示例代码:

+ 启动一个Activity, 并通过 [Rect.top()](/API/UI/Compose/Graphics/Rect/README.md?id=top) 方法获取矩形的底边距 y 轴的偏移量
    ...
    Popup {
        ...
        popupPositionProvider {
            ...
            x { anchorBounds, windowSize, layoutDirection, popupContentSize ->
                ...
                // Rect.top() 用于获取矩形的底边距 y 轴的偏移量。
                $console.log(anchorBounds.top())
