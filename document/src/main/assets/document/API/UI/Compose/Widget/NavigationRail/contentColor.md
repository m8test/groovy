...
+ 设置 [NavigationRail](/API/UI/Compose/Widget/NavigationRail/README.md) 内容颜色

定义:

+ [NavigationRail](/API/UI/Compose/Widget/NavigationRail/README.md) contentColor(Closure closure)
...
+ 启动一个Activity,
  并通过 [NavigationRail.contentColor()](/API/UI/Compose/Widget/NavigationRail/README.md?id=contentColor)
  方法设置 [NavigationRail](/API/UI/Compose/Widget/NavigationRail/README.md) 内容颜色
...
$composeActivity.createView {
    ...
    NavigationRail {
        ...
        // NavigationRail. contentColor() 用于设置 NavigationRail 内容颜色
        contentColor {
            // delegate -> Color
            // Color.blue() 用于配置蓝色通道
            blue(255)
