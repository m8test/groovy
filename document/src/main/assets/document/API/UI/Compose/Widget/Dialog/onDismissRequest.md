...
+ [Dialog](/API/UI/Compose/Widget/Dialog/README.md) onDismissRequest(Closure closure)
...
+ 启动一个Activity显示对话框,
  并通过 [Dialog.onDismissRequest()](/API/UI/Compose/Widget/Dialog/README.md?id=onDismissRequest) 方法监听对话框取消.
