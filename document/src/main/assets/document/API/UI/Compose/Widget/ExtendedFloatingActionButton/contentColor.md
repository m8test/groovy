...
+ 启动一个Activity,
  并通过 [ExtendedFloatingActionButton.contentColor()](/API/UI/Compose/Widget/ExtendedFloatingActionButton/README.md?id=contentColor)
  方法设置扩展悬浮按钮内容颜色.
