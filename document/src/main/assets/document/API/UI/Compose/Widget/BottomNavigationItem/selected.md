...
+ 设置 [BottomNavigationItem](/API/UI/Compose/Widget/BottomNavigationItem/README.md) 是否被选中

定义:

+ [BottomNavigationItem](/API/UI/Compose/Widget/BottomNavigationItem/README.md) selected(Closure closure)
...
+ 启动一个Activity,
  并通过 [BottomNavigationItem.selected()](/API/UI/Compose/Widget/BottomNavigationItem/README.md?id=selected)
  方法设置 [BottomNavigationItem](/API/UI/Compose/Widget/BottomNavigationItem/README.md) 是否被选中
