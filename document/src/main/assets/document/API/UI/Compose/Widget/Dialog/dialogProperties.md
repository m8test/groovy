...
+ [Dialog](/API/UI/Compose/Widget/Dialog/README.md) dialogProperties(Closure closure)
...
+ 启动一个Activity显示对话框,
  并通过 [Dialog.dialogProperties()](/API/UI/Compose/Widget/Dialog/README.md?id=dialogProperties) 方法设置对话框属性.
