...
+ 创建 [Tab](/API/UI/Compose/Widget/Tab/README.md) 可组合项

定义:

+ [Slot](/API/UI/Compose/Slot/Slot/README.md) Tab(Closure closure)

参数:

+ Closure closure - 设置 [Tab](/API/UI/Compose/Widget/Tab/README.md) 的闭包
    + 参数 - 无
    + delegate - [Tab](/API/UI/Compose/Widget/Tab/README.md)
...
+ 启动一个Activity, 并通过 [Slot.Tab()](/API/UI/Compose/Slot/Slot/README.md?id=Tab)
  方法创建 [Tab](/API/UI/Compose/Widget/Tab/README.md) 可组合项
