...
+ 设置 [NavigationRail](/API/UI/Compose/Widget/NavigationRail/README.md) 内容.

定义:

+ [NavigationRail](/API/UI/Compose/Widget/NavigationRail/README.md) content(Closure closure)
...
+ 启动一个Activity, 并通过 [NavigationRail.content()](/API/UI/Compose/Widget/NavigationRail/README.md?id=content)
  方法设置 [NavigationRail](/API/UI/Compose/Widget/NavigationRail/README.md) 内容.
