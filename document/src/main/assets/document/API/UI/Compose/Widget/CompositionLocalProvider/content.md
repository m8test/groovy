...
+ 设置 [CompositionLocalProvider](/API/UI/Compose/Widget/CompositionLocalProvider/README.md) 内容.

定义:

+ [CompositionLocalProvider](/API/UI/Compose/Widget/CompositionLocalProvider/README.md) content(Closure
  closure)
...
+ 启动一个Activity,
  并通过 [CompositionLocalProvider.content()](/API/UI/Compose/Widget/CompositionLocalProvider/README.md?id=content)
  方法设置 [CompositionLocalProvider](/API/UI/Compose/Widget/CompositionLocalProvider/README.md) 内容.
