...
+ 设置 [SwipeToDismiss](/API/UI/Compose/Widget/SwipeToDismiss/README.md) 可取消内容.

定义:

+ [SwipeToDismiss](/API/UI/Compose/Widget/SwipeToDismiss/README.md) dismissContent(Closure closure)
...
+ 启动一个Activity,
  并通过 [SwipeToDismiss.dismissContent()](/API/UI/Compose/Widget/SwipeToDismiss/README.md?id=dismissContent)
  方法设置 [SwipeToDismiss](/API/UI/Compose/Widget/SwipeToDismiss/README.md) 可取消内容.
