...
+ [TextStyle](/API/UI/Compose/Theme/Typography/TextStyle/README.md) copy()
...
+ [TextStyle](/API/UI/Compose/Theme/Typography/TextStyle/README.md) -
  新复制的 [TextStyle](/API/UI/Compose/Theme/Typography/TextStyle/README.md) 对象

示例代码:

+ 启动一个Activity, 并通过 [TextStyle.copy()](/API/UI/Compose/Theme/Typography/TextStyle/README.md?id=copy)
  方法复制字体样式
