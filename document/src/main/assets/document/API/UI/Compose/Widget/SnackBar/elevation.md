...
+ 设置 [SnackBar](/API/UI/Compose/Widget/SnackBar/README.md) 的海拔(z坐标)
  。这将控制 [SnackBar](/API/UI/Compose/Widget/SnackBar/README.md) 下方阴影的大小

定义:

+ [SnackBar](/API/UI/Compose/Widget/SnackBar/README.md) elevation(Number value)

参数:

+ Number value - [SnackBar](/API/UI/Compose/Widget/SnackBar/README.md) 海拔高度,单位dp
...
+ 启动一个Activity, 并通过 [SnackBar](/API/UI/Compose/Widget/SnackBar/README.md)
  方法设置 [SnackBar.elevation()](/API/UI/Compose/Widget/SnackBar/README.md?id=elevation) 的海拔
    ...
    SnackBarHost {
        ...
        snackBar { data ->
            ...
            SnackBar {
                ...
                snackBarData(data)
                // SnackBar.elevation() 用于设置 SnackBar 的海拔
                elevation(20)
            }
        }
    }
