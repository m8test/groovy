...
+ 设置 [LeadingIconTab](/API/UI/Compose/Widget/LeadingIconTab/README.md) 图标.

定义:

+ [LeadingIconTab](/API/UI/Compose/Widget/LeadingIconTab/README.md) icon(Closure closure)
...
+ 启动一个Activity, 并通过 [LeadingIconTab.icon()](/API/UI/Compose/Widget/LeadingIconTab/README.md?id=icon)
  方法设置 [LeadingIconTab](/API/UI/Compose/Widget/LeadingIconTab/README.md) 图标.
