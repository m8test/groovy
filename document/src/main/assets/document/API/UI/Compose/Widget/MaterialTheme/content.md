...
+ [MaterialTheme](/API/UI/Compose/Widget/MaterialTheme/README.md) content(Closure closure)
...
+ 启动一个Activity, 并通过 [MaterialTheme.content()](/API/UI/Compose/Widget/MaterialTheme/README.md?id=content)
  方法设置主题内容.
