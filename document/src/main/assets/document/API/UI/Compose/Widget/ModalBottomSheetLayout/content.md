...
+ 设置 [ModalBottomSheetLayout](/API/UI/Compose/Widget/ModalBottomSheetLayout/README.md) 内容

定义:

+ [ModalBottomSheetLayout](/API/UI/Compose/Widget/ModalBottomSheetLayout/README.md) content(Closure closure)
...
+ 启动一个Activity,
  并通过 [ModalBottomSheetLayout.content()](/API/UI/Compose/Widget/ModalBottomSheetLayout/README.md?id=content)
  方法设置 [ModalBottomSheetLayout](/API/UI/Compose/Widget/ModalBottomSheetLayout/README.md) 内容
