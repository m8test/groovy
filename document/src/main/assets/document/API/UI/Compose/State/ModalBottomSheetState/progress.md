...
+ 启动一个Activity,
  并通过 [ModalBottomSheetState.progress()](/API/UI/Compose/State/ModalBottomSheetState/README.md?id=progress)
  方法获取当前进度
            ...
            Column {
                ...
                content {
                    ...
                    Text {
                        ...
                        // ModalBottomSheetState.progress() 用于获取当前进度
                        def progress = state.progress()
                        // Text.text() 用于设置文本可组合项内容
