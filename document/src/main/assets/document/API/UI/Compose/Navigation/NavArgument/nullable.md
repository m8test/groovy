...
+ [NavArgument](/API/UI/Compose/Navigation/NavArgument/README.md) nullable(boolean nullable)

参数:

+ boolean nullable - true表示参数可为null,false表示参数不可为null

返回值:

+ [NavArgument](/API/UI/Compose/Navigation/NavArgument/README.md) - 返回对象本身方便链式调用

示例代码:

+ 启动一个Activity, 并通过 [NavArgument.nullable()](/API/UI/Compose/Navigation/NavArgument/README.md?id=nullable)
  方法设置参数是否可空
