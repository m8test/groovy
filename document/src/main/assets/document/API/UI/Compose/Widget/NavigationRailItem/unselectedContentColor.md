...
+ 设置 [NavigationRailItem](/API/UI/Compose/Widget/NavigationRailItem/README.md) 未被选中时的颜色.

定义:

+ [NavigationRailItem](/API/UI/Compose/Widget/NavigationRailItem/README.md) unselectedContentColor(Closure
  closure)
...
+ 启动一个Activity,
  并通过 [NavigationRailItem.unselectedContentColor()](/API/UI/Compose/Widget/NavigationRailItem/README.md?id=unselectedContentColor)
  方法设置 [NavigationRailItem](/API/UI/Compose/Widget/NavigationRailItem/README.md) 未被选中时的颜色.
