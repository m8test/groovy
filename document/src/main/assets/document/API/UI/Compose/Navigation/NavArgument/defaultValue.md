...
+ [NavArgument](/API/UI/Compose/Navigation/NavArgument/README.md) defaultValue(Object defaultValue)

参数:

+ Object defaultValue - 参数默认值
...
+ 启动一个Activity,
  并通过 [NavArgument.defaultValue()](/API/UI/Compose/Navigation/NavArgument/README.md?id=defaultValue)
  方法设置参数默认值
