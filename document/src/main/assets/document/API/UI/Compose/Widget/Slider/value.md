...
+ 设置 [Slider](/API/UI/Compose/Widget/Slider/README.md) 值

定义:

+ [Slider](/API/UI/Compose/Widget/Slider/README.md) value(float value)
...
+ 启动一个Activity, 并通过 [Slider.value()](/API/UI/Compose/Widget/Slider/README.md?id=value)
  方法设置 [Slider](/API/UI/Compose/Widget/Slider/README.md) 值
