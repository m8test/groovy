...
+ [ModalBottomSheetLayout](/API/UI/Compose/Widget/ModalBottomSheetLayout/README.md) sheetShape(Closure
  closure)
...
+ 启动一个Activity,
  并通过 [ModalBottomSheetLayout.sheetShape()](/API/UI/Compose/Widget/ModalBottomSheetLayout/README.md?id=sheetShape)
  方法设置底页形状
