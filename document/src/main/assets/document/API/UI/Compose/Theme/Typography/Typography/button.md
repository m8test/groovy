...
+ [Typography](/API/UI/Compose/Theme/Typography/Typography/README.md) button(Closure closure)
...
+ [TextStyle](/API/UI/Compose/Theme/Typography/TextStyle/README.md) button()
...
+ [TextStyle](/API/UI/Compose/Theme/Typography/TextStyle/README.md) - button 文字样式对象

示例代码:

+ 启动一个Activity, 并通过 [Typography.button()](/API/UI/Compose/Theme/Typography/Typography/README.md?id=button)
  方法设置/获取主题 button 文字样式
...
$composeActivity.createView {
    ...
    MaterialTheme {
        ...
        typography {
            // delegate -> Typography
            // Typography.button() 用于设置主题 button 文字样式
            button {
                // delegate -> TextStyle
            ...
            Button {
                ...
                content {
                    ...
                    Text {
                        ...
                        def buttonTextStyle = currentTypography.button()
                        // Text.style() 用于设置文字样式
                        style {
                            // delegate -> TextStyle
                            // TextStyle.from() 用于从指定 TextStyle 对象复制属性
                            from(buttonTextStyle)
                        }
