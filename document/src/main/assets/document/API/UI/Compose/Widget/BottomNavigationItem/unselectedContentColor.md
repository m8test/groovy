...
+ 设置 [BottomNavigationItem](/API/UI/Compose/Widget/BottomNavigationItem/README.md) 未选中时的颜色

定义:

+ [BottomNavigationItem](/API/UI/Compose/Widget/BottomNavigationItem/README.md) unselectedContentColor(
  Closure closure)
...
+ 启动一个Activity,
  并通过 [BottomNavigationItem.unselectedContentColor()](/API/UI/Compose/Widget/BottomNavigationItem/README.md?id=unselectedContentColor)
  方法设置 [BottomNavigationItem](/API/UI/Compose/Widget/BottomNavigationItem/README.md) 未选中时的颜色
