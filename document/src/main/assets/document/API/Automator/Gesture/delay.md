...
+ [Gesture](/API/Automator/Gesture/README.md) delay(long delay)

参数:

+ long delay - 手势延时执行时间,单位毫秒
...
+ 启动一个Activity, 并通过 [Gesture.delay()](/API/Automator/Gesture/README.md?id=delay) 方法设置手势延时时间
