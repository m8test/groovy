...
+ [Gesture](/API/Automator/Gesture/README.md) duration(long duration)

参数:

+ long duration - 手势持续时间,单位毫秒
...
+ 启动一个Activity, 并通过 [Gesture.duration()](/API/Automator/Gesture/README.md?id=duration) 方法设置手势持续时间
