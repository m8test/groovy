...
+ [Gesture](/API/Automator/Gesture/README.md) points(List\<Closure\> points)

参数:

+ List\<Closure\> points - 设置手势经过所有点的闭包
    + 参数 - 无
    + delegate - [Point](/API/UI/Graphics/Point/README.md)

返回值:

+ [Gesture](/API/Automator/Gesture/README.md) - 返回对象本身方便链式调用

示例代码:

+ 启动一个Activity, 并通过 [Gesture.points()](/API/Automator/Gesture/README.md?id=points) 方法设置手势经过的所有点
