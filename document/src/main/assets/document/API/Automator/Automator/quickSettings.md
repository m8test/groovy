...
+ 启动一个Activity, 并通过 [Automator.quickSettings()](/API/Automator/Automator/README.md?id=quickSettings)
  方法打开快速设置
            ...
            TopAppBar {
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            // Automator.quickSettings() 用于打开快速设置
                            $console.log($automator.quickSettings())
                        }
                    }
                }
            }
