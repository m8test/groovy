...
+ 启动一个Activity, 并通过 [Automator.powerDialog()](/API/Automator/Automator/README.md?id=powerDialog)
  方法打开电源长按对话框
            ...
            TopAppBar {
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            // Automator.powerDialog() 用于打开电源长按对话框
                            $console.log($automator.powerDialog())
                        }
                    }
                }
            }
