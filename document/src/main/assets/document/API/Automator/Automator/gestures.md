...
+ 执行多个手势操作,需要无障碍权限(安卓7.0以上)

定义:

+ boolean gestures(List\<Closure\> closures)
...
+ 启动一个Activity, 并通过 [Automator.gestures()](/API/Automator/Automator/README.md?id=gestures)
  方法执行多个手势操作
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            coroutineScope.launch({
                                ...
                                // Automator.gestures() 用于执行多个手势操作
                                $automator.gestures(myGestures)
                            }
                        }
                    }
                }
