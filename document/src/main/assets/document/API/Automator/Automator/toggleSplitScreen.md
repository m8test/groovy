...
+ 切换显示最近应用程序的概览。 将在不显示最近应用程序的平台上失败,需要无障碍权限(安卓7.0以上)
...
+ 启动一个Activity,
  并通过 [Automator.toggleSplitScreen()](/API/Automator/Automator/README.md?id=toggleSplitScreen)
  方法切换显示最近应用程序的概览
            ...
            TopAppBar {
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            // Automator.toggleSplitScreen() 用于切换显示最近应用程序的概览
                            $console.log($automator.toggleSplitScreen())
                        }
                    }
                }
            }
