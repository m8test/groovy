...
+ 切换显示最近应用程序的概览。 将在不显示最近应用程序的平台上失败,需要无障碍权限
...
+ 启动一个Activity, 并通过 [Automator.recents()](/API/Automator/Automator/README.md?id=recents)
  方法切换显示最近应用程序的概览
            ...
            TopAppBar {
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            // Automator.recents() 用于切换显示最近应用程序的概览
                            $console.log($automator.recents())
                        }
                    }
                }
            }
