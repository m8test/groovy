...
+ 按压指定坐标特定时间,需要无障碍权限(安卓7.0以上)或者ADB自动化

定义:

+ boolean press(int x, int y, long duration)
...
+ 启动一个Activity, 并通过 [Automator.press()](/API/Automator/Automator/README.md?id=press) 方法按压指定坐标特定时间
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            coroutineScope.launch({
                                ...
                                // Automator.press() 用于按压指定坐标特定时间
                                $automator.press(bounds.centerX(), bounds.centerY(), 2000)
                            }
                        }
                    }
                }
