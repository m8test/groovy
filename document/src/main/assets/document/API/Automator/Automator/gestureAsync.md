...
+ 异步执行手势操作,需要无障碍权限(安卓7.0以上)

定义:

+ boolean gestureAsync(Closure closure)
...
+ 启动一个Activity, 并通过 [Automator.gestureAsync()](/API/Automator/Automator/README.md?id=gestureAsync)
  方法异步执行手势操作
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            coroutineScope.launch({
                                ...
                                // Automator.gestureAsync() 用于异步执行手势操作
                                $automator.gestureAsync {
                                    // delegate -> Gesture
