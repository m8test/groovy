...
+ int action -
  需要执行的全局操作,参考 [https://developer.android.google.cn/reference/kotlin/android/accessibilityservice/AccessibilityService?hl=en#GLOBAL_ACTION_ACCESSIBILITY_ALL_APPS:kotlin.Int](https://developer.android.google.cn/reference/kotlin/android/accessibilityservice/AccessibilityService?hl=en#GLOBAL_ACTION_ACCESSIBILITY_ALL_APPS:kotlin.Int)
...
+ 启动一个Activity,
  并通过 [Automator.performGlobalAction()](/API/Automator/Automator/README.md?id=performGlobalAction)
  方法执行全局操作
            ...
            TopAppBar {
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            // Automator.performGlobalAction() 用于执行全局操作
                            $console.log($automator.performGlobalAction(1))
                        }
                    }
                }
            }
