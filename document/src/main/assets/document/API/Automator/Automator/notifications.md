...
+ 启动一个Activity, 并通过 [Automator.notifications()](/API/Automator/Automator/README.md?id=notifications)
  方法打开通知栏
            ...
            TopAppBar {
                ...
                actions {
                    ...
                    IconButton {
                        ...
                        onClick {
                            // Automator.notifications() 用于打开通知栏
                            $console.log($automator.notifications())
                        }
                    }
                }
            }
