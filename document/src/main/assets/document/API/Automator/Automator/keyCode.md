...
+ boolean keyCode(int keyCode)

参数:

+ int keyCode -
  需要输入的键码,参考 [https://developer.android.google.cn/reference/android/view/KeyEvent#KEYCODE_0](https://developer.android.google.cn/reference/android/view/KeyEvent#KEYCODE_0)
...
+ 启动一个Activity, 并通过 [Automator.keyCode()](/API/Automator/Automator/README.md?id=keyCode) 方法输入键码
                    ...
                    IconButton {
                        ...
                        onClick {
                            ...
                            coroutineScope.launch({
                                ...
                                // Automator.keyCode() 用于输入键码
                                $console.log($automator.keyCode(4))
                            }
                        }
                    }
                }
