...
+ [ClosedRange](/API/Ranges/ClosedRange/README.md) start(Object value)

参数:

+ Object value - 起始值,一般为数值
...
+ 启动一个Activity, 并通过 [ClosedRange.start()](/API/Ranges/ClosedRange/README.md?id=start) 方法设置起始值
